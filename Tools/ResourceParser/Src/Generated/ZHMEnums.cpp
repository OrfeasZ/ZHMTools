...
nlohmann::json EnumToJson(void* p_Object)
{
	nlohmann::json s_Json;

	s_Json["$enumVal"] = static_cast<int>(*reinterpret_cast<int32_t*>(p_Object));
	s_Json["$enumValName"] = ZHMEnums::GetEnumValueName(TEnumType.Name, *reinterpret_cast<int32_t*>(p_Object));

	return s_Json;
}

template<EnumTypeLiteral TEnumType>
nlohmann::json EnumToJsonSimple(void* p_Object)
{
	nlohmann::json s_Json = ZHMEnums::GetEnumValueName(TEnumType.Name, *reinterpret_cast<int32_t*>(p_Object));
	return s_Json;
}
...
static ZHMTypeInfo EItemMeleeDamageBehavior_TypeInfo = ZHMTypeInfo("EItemMeleeDamageBehavior", EnumToJson<"EItemMeleeDamageBehavior">, EnumToJsonSimple<"EItemMeleeDamageBehavior">);
static ZHMTypeInfo ZStateControllerEntity_WrapMode_TypeInfo = ZHMTypeInfo("ZStateControllerEntity.WrapMode", EnumToJson<"ZStateControllerEntity.WrapMode">, EnumToJsonSimple<"ZStateControllerEntity.WrapMode">);
static ZHMTypeInfo ZFriskSuspectGroup_EAssistantState_TypeInfo = ZHMTypeInfo("ZFriskSuspectGroup.EAssistantState", EnumToJson<"ZFriskSuspectGroup.EAssistantState">, EnumToJsonSimple<"ZFriskSuspectGroup.EAssistantState">);
static ZHMTypeInfo ZRenderPostfilterParametersEntity_EHDRGlareType_TypeInfo = ZHMTypeInfo("ZRenderPostfilterParametersEntity.EHDRGlareType", EnumToJson<"ZRenderPostfilterParametersEntity.EHDRGlareType">, EnumToJsonSimple<"ZRenderPostfilterParametersEntity.EHDRGlareType">);
static ZHMTypeInfo ZOperatorBool_EEvaluationType_TypeInfo = ZHMTypeInfo("ZOperatorBool.EEvaluationType", EnumToJson<"ZOperatorBool.EEvaluationType">, EnumToJsonSimple<"ZOperatorBool.EEvaluationType">);
static ZHMTypeInfo EGSEvent_TypeInfo = ZHMTypeInfo("EGSEvent", EnumToJson<"EGSEvent">, EnumToJsonSimple<"EGSEvent">);
static ZHMTypeInfo ZCautiousInvestigateGroup_EApproachOrderState_TypeInfo = ZHMTypeInfo("ZCautiousInvestigateGroup.EApproachOrderState", EnumToJson<"ZCautiousInvestigateGroup.EApproachOrderState">, EnumToJsonSimple<"ZCautiousInvestigateGroup.EApproachOrderState">);
static ZHMTypeInfo EGSKillSituation_TypeInfo = ZHMTypeInfo("EGSKillSituation", EnumToJson<"EGSKillSituation">, EnumToJsonSimple<"EGSKillSituation">);
static ZHMTypeInfo ZHUDCamera3DControllerEntity_ESpace_TypeInfo = ZHMTypeInfo("ZHUDCamera3DControllerEntity.ESpace", EnumToJson<"ZHUDCamera3DControllerEntity.ESpace">, EnumToJsonSimple<"ZHUDCamera3DControllerEntity.ESpace">);
static ZHMTypeInfo ETessellationMode_TypeInfo = ZHMTypeInfo("ETessellationMode", EnumToJson<"ETessellationMode">, EnumToJsonSimple<"ETessellationMode">);
static ZHMTypeInfo EBystanderPointType_TypeInfo = ZHMTypeInfo("EBystanderPointType", EnumToJson<"EBystanderPointType">, EnumToJsonSimple<"EBystanderPointType">);
static ZHMTypeInfo _EUIOptionKey_TypeInfo = ZHMTypeInfo("_EUIOptionKey", EnumToJson<"_EUIOptionKey">, EnumToJsonSimple<"_EUIOptionKey">);
static ZHMTypeInfo EVRConfigCameraRotationAllowed_TypeInfo = ZHMTypeInfo("EVRConfigCameraRotationAllowed", EnumToJson<"EVRConfigCameraRotationAllowed">, EnumToJsonSimple<"EVRConfigCameraRotationAllowed">);
static ZHMTypeInfo ZInteractionGuideData_EDirection_TypeInfo = ZHMTypeInfo("ZInteractionGuideData.EDirection", EnumToJson<"ZInteractionGuideData.EDirection">, EnumToJsonSimple<"ZInteractionGuideData.EDirection">);
static ZHMTypeInfo ZInteractionData_EFilterResult_TypeInfo = ZHMTypeInfo("ZInteractionData.EFilterResult", EnumToJson<"ZInteractionData.EFilterResult">, EnumToJsonSimple<"ZInteractionData.EFilterResult">);
static ZHMTypeInfo ZHeroEscortSituation2Entity_ETargetState_TypeInfo = ZHMTypeInfo("ZHeroEscortSituation2Entity.ETargetState", EnumToJson<"ZHeroEscortSituation2Entity.ETargetState">, EnumToJsonSimple<"ZHeroEscortSituation2Entity.ETargetState">);
static ZHMTypeInfo EOutfitAICategory_TypeInfo = ZHMTypeInfo("EOutfitAICategory", EnumToJson<"EOutfitAICategory">, EnumToJsonSimple<"EOutfitAICategory">);
static ZHMTypeInfo ESoundChannelGroup_TypeInfo = ZHMTypeInfo("ESoundChannelGroup", EnumToJson<"ESoundChannelGroup">, EnumToJsonSimple<"ESoundChannelGroup">);
static ZHMTypeInfo ZActorKeywordCondition_EEvaluationType_TypeInfo = ZHMTypeInfo("ZActorKeywordCondition.EEvaluationType", EnumToJson<"ZActorKeywordCondition.EEvaluationType">, EnumToJsonSimple<"ZActorKeywordCondition.EEvaluationType">);
static ZHMTypeInfo EGSExplodingPropType_TypeInfo = ZHMTypeInfo("EGSExplodingPropType", EnumToJson<"EGSExplodingPropType">, EnumToJsonSimple<"EGSExplodingPropType">);
static ZHMTypeInfo ZCrowdActorEntity_ECharacterSoundType_TypeInfo = ZHMTypeInfo("ZCrowdActorEntity.ECharacterSoundType", EnumToJson<"ZCrowdActorEntity.ECharacterSoundType">, EnumToJsonSimple<"ZCrowdActorEntity.ECharacterSoundType">);
static ZHMTypeInfo eItemType_TypeInfo = ZHMTypeInfo("eItemType", EnumToJson<"eItemType">, EnumToJsonSimple<"eItemType">);
static ZHMTypeInfo EDebugExclusionLayerState_TypeInfo = ZHMTypeInfo("EDebugExclusionLayerState", EnumToJson<"EDebugExclusionLayerState">, EnumToJsonSimple<"EDebugExclusionLayerState">);
static ZHMTypeInfo ILightEntity_ELightType_TypeInfo = ZHMTypeInfo("ILightEntity.ELightType", EnumToJson<"ILightEntity.ELightType">, EnumToJsonSimple<"ILightEntity.ELightType">);
static ZHMTypeInfo ZPhotoModeMenuDataProvider_EMenuEntryType_TypeInfo = ZHMTypeInfo("ZPhotoModeMenuDataProvider.EMenuEntryType", EnumToJson<"ZPhotoModeMenuDataProvider.EMenuEntryType">, EnumToJsonSimple<"ZPhotoModeMenuDataProvider.EMenuEntryType">);
static ZHMTypeInfo EOnlinTest_TypeInfo = ZHMTypeInfo("EOnlinTest", EnumToJson<"EOnlinTest">, EnumToJsonSimple<"EOnlinTest">);
static ZHMTypeInfo eContractSessionStartError_TypeInfo = ZHMTypeInfo("eContractSessionStartError", EnumToJson<"eContractSessionStartError">, EnumToJsonSimple<"eContractSessionStartError">);
static ZHMTypeInfo EParticleColorUsage_TypeInfo = ZHMTypeInfo("EParticleColorUsage", EnumToJson<"EParticleColorUsage">, EnumToJsonSimple<"EParticleColorUsage">);
static ZHMTypeInfo EGameModeId_TypeInfo = ZHMTypeInfo("EGameModeId", EnumToJson<"EGameModeId">, EnumToJsonSimple<"EGameModeId">);
static ZHMTypeInfo ZActBehaviorEntity_EApproachAlignment_TypeInfo = ZHMTypeInfo("ZActBehaviorEntity.EApproachAlignment", EnumToJson<"ZActBehaviorEntity.EApproachAlignment">, EnumToJsonSimple<"ZActBehaviorEntity.EApproachAlignment">);
static ZHMTypeInfo ILightEntity_EFrameIndexStrategy_TypeInfo = ZHMTypeInfo("ILightEntity.EFrameIndexStrategy", EnumToJson<"ILightEntity.EFrameIndexStrategy">, EnumToJsonSimple<"ILightEntity.EFrameIndexStrategy">);
static ZHMTypeInfo EViewportLock_TypeInfo = ZHMTypeInfo("EViewportLock", EnumToJson<"EViewportLock">, EnumToJsonSimple<"EViewportLock">);
static ZHMTypeInfo ZInputListenerDpadEntity_eInputListenerDpad_TypeInfo = ZHMTypeInfo("ZInputListenerDpadEntity.eInputListenerDpad", EnumToJson<"ZInputListenerDpadEntity.eInputListenerDpad">, EnumToJsonSimple<"ZInputListenerDpadEntity.eInputListenerDpad">);
static ZHMTypeInfo ZEscortSituation2Entity_ETargetState_TypeInfo = ZHMTypeInfo("ZEscortSituation2Entity.ETargetState", EnumToJson<"ZEscortSituation2Entity.ETargetState">, EnumToJsonSimple<"ZEscortSituation2Entity.ETargetState">);
static ZHMTypeInfo ZTrespassingSituation_ESituationState_TypeInfo = ZHMTypeInfo("ZTrespassingSituation.ESituationState", EnumToJson<"ZTrespassingSituation.ESituationState">, EnumToJsonSimple<"ZTrespassingSituation.ESituationState">);
static ZHMTypeInfo EAIFormationMemberSpeed_TypeInfo = ZHMTypeInfo("EAIFormationMemberSpeed", EnumToJson<"EAIFormationMemberSpeed">, EnumToJsonSimple<"EAIFormationMemberSpeed">);
static ZHMTypeInfo ERenderGlowTypes_TypeInfo = ZHMTypeInfo("ERenderGlowTypes", EnumToJson<"ERenderGlowTypes">, EnumToJsonSimple<"ERenderGlowTypes">);
static ZHMTypeInfo EFocusBarState_TypeInfo = ZHMTypeInfo("EFocusBarState", EnumToJson<"EFocusBarState">, EnumToJsonSimple<"EFocusBarState">);
static ZHMTypeInfo ESoundCollisionObjectType_TypeInfo = ZHMTypeInfo("ESoundCollisionObjectType", EnumToJson<"ESoundCollisionObjectType">, EnumToJsonSimple<"ESoundCollisionObjectType">);
static ZHMTypeInfo ZDistanceCondition_ECompareMethod_TypeInfo = ZHMTypeInfo("ZDistanceCondition.ECompareMethod", EnumToJson<"ZDistanceCondition.ECompareMethod">, EnumToJsonSimple<"ZDistanceCondition.ECompareMethod">);
static ZHMTypeInfo TeleportActionType_TypeInfo = ZHMTypeInfo("TeleportActionType", EnumToJson<"TeleportActionType">, EnumToJsonSimple<"TeleportActionType">);
static ZHMTypeInfo EActorAIState_TypeInfo = ZHMTypeInfo("EActorAIState", EnumToJson<"EActorAIState">, EnumToJsonSimple<"EActorAIState">);
static ZHMTypeInfo EMorphemeEventId_TypeInfo = ZHMTypeInfo("EMorphemeEventId", EnumToJson<"EMorphemeEventId">, EnumToJsonSimple<"EMorphemeEventId">);
static ZHMTypeInfo EAccidentScaleContext_TypeInfo = ZHMTypeInfo("EAccidentScaleContext", EnumToJson<"EAccidentScaleContext">, EnumToJsonSimple<"EAccidentScaleContext">);
static ZHMTypeInfo EEngineModeId_TypeInfo = ZHMTypeInfo("EEngineModeId", EnumToJson<"EEngineModeId">, EnumToJsonSimple<"EEngineModeId">);
static ZHMTypeInfo ZActBehaviorEntity_EState_TypeInfo = ZHMTypeInfo("ZActBehaviorEntity.EState", EnumToJson<"ZActBehaviorEntity.EState">, EnumToJsonSimple<"ZActBehaviorEntity.EState">);
static ZHMTypeInfo ZSoundAmbienceGroup_ESoundCollisionType_TypeInfo = ZHMTypeInfo("ZSoundAmbienceGroup.ESoundCollisionType", EnumToJson<"ZSoundAmbienceGroup.ESoundCollisionType">, EnumToJsonSimple<"ZSoundAmbienceGroup.ESoundCollisionType">);
static ZHMTypeInfo EDamageEvent_TypeInfo = ZHMTypeInfo("EDamageEvent", EnumToJson<"EDamageEvent">, EnumToJsonSimple<"EDamageEvent">);
static ZHMTypeInfo ZDebugGizmoEntity_EDrawLayer_TypeInfo = ZHMTypeInfo("ZDebugGizmoEntity.EDrawLayer", EnumToJson<"ZDebugGizmoEntity.EDrawLayer">, EnumToJsonSimple<"ZDebugGizmoEntity.EDrawLayer">);
static ZHMTypeInfo ZCoverPlane_ECoverSize_TypeInfo = ZHMTypeInfo("ZCoverPlane.ECoverSize", EnumToJson<"ZCoverPlane.ECoverSize">, EnumToJsonSimple<"ZCoverPlane.ECoverSize">);
static ZHMTypeInfo EAnimSetType_TypeInfo = ZHMTypeInfo("EAnimSetType", EnumToJson<"EAnimSetType">, EnumToJsonSimple<"EAnimSetType">);
static ZHMTypeInfo ZContextKillGuide_EEvaluationType_TypeInfo = ZHMTypeInfo("ZContextKillGuide.EEvaluationType", EnumToJson<"ZContextKillGuide.EEvaluationType">, EnumToJsonSimple<"ZContextKillGuide.EEvaluationType">);
static ZHMTypeInfo EMassImpulseType_TypeInfo = ZHMTypeInfo("EMassImpulseType", EnumToJson<"EMassImpulseType">, EnumToJsonSimple<"EMassImpulseType">);
static ZHMTypeInfo ReverbFidelity_TypeInfo = ZHMTypeInfo("ReverbFidelity", EnumToJson<"ReverbFidelity">, EnumToJsonSimple<"ReverbFidelity">);
static ZHMTypeInfo EDifficultyLevel_TypeInfo = ZHMTypeInfo("EDifficultyLevel", EnumToJson<"EDifficultyLevel">, EnumToJsonSimple<"EDifficultyLevel">);
static ZHMTypeInfo ECharacterCollidableLayer_TypeInfo = ZHMTypeInfo("ECharacterCollidableLayer", EnumToJson<"ECharacterCollidableLayer">, EnumToJsonSimple<"ECharacterCollidableLayer">);
static ZHMTypeInfo ZHUDOutfitWidgetControllerEntity_EVisibilityPolicy_TypeInfo = ZHMTypeInfo("ZHUDOutfitWidgetControllerEntity.EVisibilityPolicy", EnumToJson<"ZHUDOutfitWidgetControllerEntity.EVisibilityPolicy">, EnumToJsonSimple<"ZHUDOutfitWidgetControllerEntity.EVisibilityPolicy">);
static ZHMTypeInfo ESmartWaitCondition_TypeInfo = ZHMTypeInfo("ESmartWaitCondition", EnumToJson<"ESmartWaitCondition">, EnumToJsonSimple<"ESmartWaitCondition">);
static ZHMTypeInfo ZActorPickerEffectTrack_EEffectPhaseAction_TypeInfo = ZHMTypeInfo("ZActorPickerEffectTrack.EEffectPhaseAction", EnumToJson<"ZActorPickerEffectTrack.EEffectPhaseAction">, EnumToJsonSimple<"ZActorPickerEffectTrack.EEffectPhaseAction">);
static ZHMTypeInfo ERegionId_TypeInfo = ZHMTypeInfo("ERegionId", EnumToJson<"ERegionId">, EnumToJsonSimple<"ERegionId">);
static ZHMTypeInfo ZTestGroupPath_EModifierType_TypeInfo = ZHMTypeInfo("ZTestGroupPath.EModifierType", EnumToJson<"ZTestGroupPath.EModifierType">, EnumToJsonSimple<"ZTestGroupPath.EModifierType">);
static ZHMTypeInfo ZCautiousSearchGroup_EAssistantState_TypeInfo = ZHMTypeInfo("ZCautiousSearchGroup.EAssistantState", EnumToJson<"ZCautiousSearchGroup.EAssistantState">, EnumToJsonSimple<"ZCautiousSearchGroup.EAssistantState">);
static ZHMTypeInfo EAnimationPose_TypeInfo = ZHMTypeInfo("EAnimationPose", EnumToJson<"EAnimationPose">, EnumToJsonSimple<"EAnimationPose">);
static ZHMTypeInfo EActorLookAtStopReason_TypeInfo = ZHMTypeInfo("EActorLookAtStopReason", EnumToJson<"EActorLookAtStopReason">, EnumToJsonSimple<"EActorLookAtStopReason">);
static ZHMTypeInfo ZHM5Item_EUseTypes_TypeInfo = ZHMTypeInfo("ZHM5Item.EUseTypes", EnumToJson<"ZHM5Item.EUseTypes">, EnumToJsonSimple<"ZHM5Item.EUseTypes">);
static ZHMTypeInfo EHM5SoundFootwearType_TypeInfo = ZHMTypeInfo("EHM5SoundFootwearType", EnumToJson<"EHM5SoundFootwearType">, EnumToJsonSimple<"EHM5SoundFootwearType">);
static ZHMTypeInfo ECharacterIdleHandlerFullbodyType_TypeInfo = ZHMTypeInfo("ECharacterIdleHandlerFullbodyType", EnumToJson<"ECharacterIdleHandlerFullbodyType">, EnumToJsonSimple<"ECharacterIdleHandlerFullbodyType">);
static ZHMTypeInfo ZValueBool_Operation_Signal_EEvaluationType_TypeInfo = ZHMTypeInfo("ZValueBool_Operation_Signal.EEvaluationType", EnumToJson<"ZValueBool_Operation_Signal.EEvaluationType">, EnumToJsonSimple<"ZValueBool_Operation_Signal.EEvaluationType">);
static ZHMTypeInfo ZCautiousInvestigateGroup_EInvestigateGroupState_TypeInfo = ZHMTypeInfo("ZCautiousInvestigateGroup.EInvestigateGroupState", EnumToJson<"ZCautiousInvestigateGroup.EInvestigateGroupState">, EnumToJsonSimple<"ZCautiousInvestigateGroup.EInvestigateGroupState">);
static ZHMTypeInfo IHM5Door_eCloseMode_TypeInfo = ZHMTypeInfo("IHM5Door.eCloseMode", EnumToJson<"IHM5Door.eCloseMode">, EnumToJsonSimple<"IHM5Door.eCloseMode">);
static ZHMTypeInfo EParticleSpritePivotLocation_TypeInfo = ZHMTypeInfo("EParticleSpritePivotLocation", EnumToJson<"EParticleSpritePivotLocation">, EnumToJsonSimple<"EParticleSpritePivotLocation">);
static ZHMTypeInfo WebSocketUtils_EOpCode_TypeInfo = ZHMTypeInfo("WebSocketUtils.EOpCode", EnumToJson<"WebSocketUtils.EOpCode">, EnumToJsonSimple<"WebSocketUtils.EOpCode">);
static ZHMTypeInfo EVRConfigAnimationMode_TypeInfo = ZHMTypeInfo("EVRConfigAnimationMode", EnumToJson<"EVRConfigAnimationMode">, EnumToJsonSimple<"EVRConfigAnimationMode">);
static ZHMTypeInfo EAnimSetState_TypeInfo = ZHMTypeInfo("EAnimSetState", EnumToJson<"EAnimSetState">, EnumToJsonSimple<"EAnimSetState">);
static ZHMTypeInfo ZRenderPostfilterParametersEntity_EHDRToneMapType_TypeInfo = ZHMTypeInfo("ZRenderPostfilterParametersEntity.EHDRToneMapType", EnumToJson<"ZRenderPostfilterParametersEntity.EHDRToneMapType">, EnumToJsonSimple<"ZRenderPostfilterParametersEntity.EHDRToneMapType">);
static ZHMTypeInfo SFootIKEventData_EFoot_TypeInfo = ZHMTypeInfo("SFootIKEventData.EFoot", EnumToJson<"SFootIKEventData.EFoot">, EnumToJsonSimple<"SFootIKEventData.EFoot">);
static ZHMTypeInfo EHM5GameInputFlag_TypeInfo = ZHMTypeInfo("EHM5GameInputFlag", EnumToJson<"EHM5GameInputFlag">, EnumToJsonSimple<"EHM5GameInputFlag">);
static ZHMTypeInfo EDramaStateFlag_TypeInfo = ZHMTypeInfo("EDramaStateFlag", EnumToJson<"EDramaStateFlag">, EnumToJsonSimple<"EDramaStateFlag">);
static ZHMTypeInfo ZHeroEscortSituation2Entity_EEscortState_TypeInfo = ZHMTypeInfo("ZHeroEscortSituation2Entity.EEscortState", EnumToJson<"ZHeroEscortSituation2Entity.EEscortState">, EnumToJsonSimple<"ZHeroEscortSituation2Entity.EEscortState">);
static ZHMTypeInfo EActorState_TypeInfo = ZHMTypeInfo("EActorState", EnumToJson<"EActorState">, EnumToJsonSimple<"EActorState">);
static ZHMTypeInfo SActorSoundDefs_EDefinition_TypeInfo = ZHMTypeInfo("SActorSoundDefs.EDefinition", EnumToJson<"SActorSoundDefs.EDefinition">, EnumToJsonSimple<"SActorSoundDefs.EDefinition">);
static ZHMTypeInfo ZKeywordCondition_EEvaluationType_TypeInfo = ZHMTypeInfo("ZKeywordCondition.EEvaluationType", EnumToJson<"ZKeywordCondition.EEvaluationType">, EnumToJsonSimple<"ZKeywordCondition.EEvaluationType">);
static ZHMTypeInfo EBehaviorTreeVariableType_TypeInfo = ZHMTypeInfo("EBehaviorTreeVariableType", EnumToJson<"EBehaviorTreeVariableType">, EnumToJsonSimple<"EBehaviorTreeVariableType">);
static ZHMTypeInfo EActorPerceptionSensitivity_TypeInfo = ZHMTypeInfo("EActorPerceptionSensitivity", EnumToJson<"EActorPerceptionSensitivity">, EnumToJsonSimple<"EActorPerceptionSensitivity">);
static ZHMTypeInfo ECharacterStateTransitionAttempt_TypeInfo = ZHMTypeInfo("ECharacterStateTransitionAttempt", EnumToJson<"ECharacterStateTransitionAttempt">, EnumToJsonSimple<"ECharacterStateTransitionAttempt">);
static ZHMTypeInfo ETakeDownState_TypeInfo = ZHMTypeInfo("ETakeDownState", EnumToJson<"ETakeDownState">, EnumToJsonSimple<"ETakeDownState">);
static ZHMTypeInfo ESequencePreviewState_TypeInfo = ZHMTypeInfo("ESequencePreviewState", EnumToJson<"ESequencePreviewState">, EnumToJsonSimple<"ESequencePreviewState">);
static ZHMTypeInfo ECameraState_TypeInfo = ZHMTypeInfo("ECameraState", EnumToJson<"ECameraState">, EnumToJsonSimple<"ECameraState">);
static ZHMTypeInfo IContractObjective_ObjectiveType_TypeInfo = ZHMTypeInfo("IContractObjective.ObjectiveType", EnumToJson<"IContractObjective.ObjectiveType">, EnumToJsonSimple<"IContractObjective.ObjectiveType">);
static ZHMTypeInfo ZAISoundEvent_ELoudness_TypeInfo = ZHMTypeInfo("ZAISoundEvent.ELoudness", EnumToJson<"ZAISoundEvent.ELoudness">, EnumToJsonSimple<"ZAISoundEvent.ELoudness">);
static ZHMTypeInfo ZStandOffSituation_ESituationState_TypeInfo = ZHMTypeInfo("ZStandOffSituation.ESituationState", EnumToJson<"ZStandOffSituation.ESituationState">, EnumToJsonSimple<"ZStandOffSituation.ESituationState">);
static ZHMTypeInfo ECppTypeFlags_TypeInfo = ZHMTypeInfo("ECppTypeFlags", EnumToJson<"ECppTypeFlags">, EnumToJsonSimple<"ECppTypeFlags">);
static ZHMTypeInfo ESynchronisedActionState_TypeInfo = ZHMTypeInfo("ESynchronisedActionState", EnumToJson<"ESynchronisedActionState">, EnumToJsonSimple<"ESynchronisedActionState">);
static ZHMTypeInfo EInventoryConfigItemHandling_TypeInfo = ZHMTypeInfo("EInventoryConfigItemHandling", EnumToJson<"EInventoryConfigItemHandling">, EnumToJsonSimple<"EInventoryConfigItemHandling">);
static ZHMTypeInfo ZUISubtitleDataProvider_EAlignment_TypeInfo = ZHMTypeInfo("ZUISubtitleDataProvider.EAlignment", EnumToJson<"ZUISubtitleDataProvider.EAlignment">, EnumToJsonSimple<"ZUISubtitleDataProvider.EAlignment">);
static ZHMTypeInfo ECollidableLayer_TypeInfo = ZHMTypeInfo("ECollidableLayer", EnumToJson<"ECollidableLayer">, EnumToJsonSimple<"ECollidableLayer">);
static ZHMTypeInfo EGSKillVictim_TypeInfo = ZHMTypeInfo("EGSKillVictim", EnumToJson<"EGSKillVictim">, EnumToJsonSimple<"EGSKillVictim">);
static ZHMTypeInfo IContractEvaluationContextListener_EListenerType_TypeInfo = ZHMTypeInfo("IContractEvaluationContextListener.EListenerType", EnumToJson<"IContractEvaluationContextListener.EListenerType">, EnumToJsonSimple<"IContractEvaluationContextListener.EListenerType">);
static ZHMTypeInfo IRenderCompositorEntity_EMode_TypeInfo = ZHMTypeInfo("IRenderCompositorEntity.EMode", EnumToJson<"IRenderCompositorEntity.EMode">, EnumToJsonSimple<"IRenderCompositorEntity.EMode">);
static ZHMTypeInfo ZActorKnowledgeCondition_EEvaluationType_TypeInfo = ZHMTypeInfo("ZActorKnowledgeCondition.EEvaluationType", EnumToJson<"ZActorKnowledgeCondition.EEvaluationType">, EnumToJsonSimple<"ZActorKnowledgeCondition.EEvaluationType">);
static ZHMTypeInfo IHM5Door_EOpenMode_TypeInfo = ZHMTypeInfo("IHM5Door.EOpenMode", EnumToJson<"IHM5Door.EOpenMode">, EnumToJsonSimple<"IHM5Door.EOpenMode">);
static ZHMTypeInfo EHeroGameState_TypeInfo = ZHMTypeInfo("EHeroGameState", EnumToJson<"EHeroGameState">, EnumToJsonSimple<"EHeroGameState">);
static ZHMTypeInfo EMarkerInclusionMode_TypeInfo = ZHMTypeInfo("EMarkerInclusionMode", EnumToJson<"EMarkerInclusionMode">, EnumToJsonSimple<"EMarkerInclusionMode">);
static ZHMTypeInfo ZHM5ItemInteractionEventConsumer_EHM5SoundItemInteractionEvent_TypeInfo = ZHMTypeInfo("ZHM5ItemInteractionEventConsumer.EHM5SoundItemInteractionEvent", EnumToJson<"ZHM5ItemInteractionEventConsumer.EHM5SoundItemInteractionEvent">, EnumToJsonSimple<"ZHM5ItemInteractionEventConsumer.EHM5SoundItemInteractionEvent">);
static ZHMTypeInfo ETargetType_TypeInfo = ZHMTypeInfo("ETargetType", EnumToJson<"ETargetType">, EnumToJsonSimple<"ETargetType">);
static ZHMTypeInfo ETessellationFactorMode_TypeInfo = ZHMTypeInfo("ETessellationFactorMode", EnumToJson<"ETessellationFactorMode">, EnumToJsonSimple<"ETessellationFactorMode">);
static ZHMTypeInfo ZHM5GenericEventConsumer_EEvent_TypeInfo = ZHMTypeInfo("ZHM5GenericEventConsumer.EEvent", EnumToJson<"ZHM5GenericEventConsumer.EEvent">, EnumToJsonSimple<"ZHM5GenericEventConsumer.EEvent">);
static ZHMTypeInfo EActorBumpType_TypeInfo = ZHMTypeInfo("EActorBumpType", EnumToJson<"EActorBumpType">, EnumToJsonSimple<"EActorBumpType">);
static ZHMTypeInfo ETimerEntityCommandType_TypeInfo = ZHMTypeInfo("ETimerEntityCommandType", EnumToJson<"ETimerEntityCommandType">, EnumToJsonSimple<"ETimerEntityCommandType">);
static ZHMTypeInfo ZValueInt_Comparator_Poll_EEvaluationType_TypeInfo = ZHMTypeInfo("ZValueInt_Comparator_Poll.EEvaluationType", EnumToJson<"ZValueInt_Comparator_Poll.EEvaluationType">, EnumToJsonSimple<"ZValueInt_Comparator_Poll.EEvaluationType">);
static ZHMTypeInfo EHM5SoundFootstepStance_TypeInfo = ZHMTypeInfo("EHM5SoundFootstepStance", EnumToJson<"EHM5SoundFootstepStance">, EnumToJsonSimple<"EHM5SoundFootstepStance">);
static ZHMTypeInfo EGestureCategory_TypeInfo = ZHMTypeInfo("EGestureCategory", EnumToJson<"EGestureCategory">, EnumToJsonSimple<"EGestureCategory">);
static ZHMTypeInfo eWeaponOperation_TypeInfo = ZHMTypeInfo("eWeaponOperation", EnumToJson<"eWeaponOperation">, EnumToJsonSimple<"eWeaponOperation">);
static ZHMTypeInfo ERayDetailLevel_TypeInfo = ZHMTypeInfo("ERayDetailLevel", EnumToJson<"ERayDetailLevel">, EnumToJsonSimple<"ERayDetailLevel">);
static ZHMTypeInfo EVictimMovementType_TypeInfo = ZHMTypeInfo("EVictimMovementType", EnumToJson<"EVictimMovementType">, EnumToJsonSimple<"EVictimMovementType">);
static ZHMTypeInfo ZHM5WeaponBasicConfigEntity_EWeaponBasicConfigAudioImpactType_TypeInfo = ZHMTypeInfo("ZHM5WeaponBasicConfigEntity.EWeaponBasicConfigAudioImpactType", EnumToJson<"ZHM5WeaponBasicConfigEntity.EWeaponBasicConfigAudioImpactType">, EnumToJsonSimple<"ZHM5WeaponBasicConfigEntity.EWeaponBasicConfigAudioImpactType">);
static ZHMTypeInfo ECameraShakerChannel_TypeInfo = ZHMTypeInfo("ECameraShakerChannel", EnumToJson<"ECameraShakerChannel">, EnumToJsonSimple<"ECameraShakerChannel">);
static ZHMTypeInfo CrowdUtil_ECrowdActorMood_TypeInfo = ZHMTypeInfo("CrowdUtil.ECrowdActorMood", EnumToJson<"CrowdUtil.ECrowdActorMood">, EnumToJsonSimple<"CrowdUtil.ECrowdActorMood">);
static ZHMTypeInfo EItemLocation_TypeInfo = ZHMTypeInfo("EItemLocation", EnumToJson<"EItemLocation">, EnumToJsonSimple<"EItemLocation">);
static ZHMTypeInfo ESituationType_TypeInfo = ZHMTypeInfo("ESituationType", EnumToJson<"ESituationType">, EnumToJsonSimple<"ESituationType">);
static ZHMTypeInfo ZContextKillGuide_EContextKillType_TypeInfo = ZHMTypeInfo("ZContextKillGuide.EContextKillType", EnumToJson<"ZContextKillGuide.EContextKillType">, EnumToJsonSimple<"ZContextKillGuide.EContextKillType">);
static ZHMTypeInfo MenuWeaponUpgradeData_EUpgradeAction_TypeInfo = ZHMTypeInfo("MenuWeaponUpgradeData.EUpgradeAction", EnumToJson<"MenuWeaponUpgradeData.EUpgradeAction">, EnumToJsonSimple<"MenuWeaponUpgradeData.EUpgradeAction">);
static ZHMTypeInfo ZUIPerformanceTestMetricsCollectorEntity_EVsyncPolicy_TypeInfo = ZHMTypeInfo("ZUIPerformanceTestMetricsCollectorEntity.EVsyncPolicy", EnumToJson<"ZUIPerformanceTestMetricsCollectorEntity.EVsyncPolicy">, EnumToJsonSimple<"ZUIPerformanceTestMetricsCollectorEntity.EVsyncPolicy">);
static ZHMTypeInfo EBoolStateRequirement_TypeInfo = ZHMTypeInfo("EBoolStateRequirement", EnumToJson<"EBoolStateRequirement">, EnumToJsonSimple<"EBoolStateRequirement">);
static ZHMTypeInfo EIntelType_TypeInfo = ZHMTypeInfo("EIntelType", EnumToJson<"EIntelType">, EnumToJsonSimple<"EIntelType">);
static ZHMTypeInfo EMultiplayerLobbyRequestType_TypeInfo = ZHMTypeInfo("EMultiplayerLobbyRequestType", EnumToJson<"EMultiplayerLobbyRequestType">, EnumToJsonSimple<"EMultiplayerLobbyRequestType">);
static ZHMTypeInfo ERayLayer_TypeInfo = ZHMTypeInfo("ERayLayer", EnumToJson<"ERayLayer">, EnumToJsonSimple<"ERayLayer">);
static ZHMTypeInfo EExclusionLayer_TypeInfo = ZHMTypeInfo("EExclusionLayer", EnumToJson<"EExclusionLayer">, EnumToJsonSimple<"EExclusionLayer">);
static ZHMTypeInfo ZHeroEscortSituationEntity_EEscortState_TypeInfo = ZHMTypeInfo("ZHeroEscortSituationEntity.EEscortState", EnumToJson<"ZHeroEscortSituationEntity.EEscortState">, EnumToJsonSimple<"ZHeroEscortSituationEntity.EEscortState">);
static ZHMTypeInfo EConversationRole_TypeInfo = ZHMTypeInfo("EConversationRole", EnumToJson<"EConversationRole">, EnumToJsonSimple<"EConversationRole">);
static ZHMTypeInfo AudioEventCullingBehavior_TypeInfo = ZHMTypeInfo("AudioEventCullingBehavior", EnumToJson<"AudioEventCullingBehavior">, EnumToJsonSimple<"AudioEventCullingBehavior">);
static ZHMTypeInfo Network_PacketPriority_TypeInfo = ZHMTypeInfo("Network.PacketPriority", EnumToJson<"Network.PacketPriority">, EnumToJsonSimple<"Network.PacketPriority">);
static ZHMTypeInfo EReplicaMode_TypeInfo = ZHMTypeInfo("EReplicaMode", EnumToJson<"EReplicaMode">, EnumToJsonSimple<"EReplicaMode">);
static ZHMTypeInfo ZValueInt_Comparator_EEvaluationType_TypeInfo = ZHMTypeInfo("ZValueInt_Comparator.EEvaluationType", EnumToJson<"ZValueInt_Comparator.EEvaluationType">, EnumToJsonSimple<"ZValueInt_Comparator.EEvaluationType">);
static ZHMTypeInfo ZSpatialEntity_ERoomBehaviour_TypeInfo = ZHMTypeInfo("ZSpatialEntity.ERoomBehaviour", EnumToJson<"ZSpatialEntity.ERoomBehaviour">, EnumToJsonSimple<"ZSpatialEntity.ERoomBehaviour">);
static ZHMTypeInfo ZOnlineManager_EError_TypeInfo = ZHMTypeInfo("ZOnlineManager.EError", EnumToJson<"ZOnlineManager.EError">, EnumToJsonSimple<"ZOnlineManager.EError">);
static ZHMTypeInfo EDetachUsage_TypeInfo = ZHMTypeInfo("EDetachUsage", EnumToJson<"EDetachUsage">, EnumToJsonSimple<"EDetachUsage">);
static ZHMTypeInfo ZActorPicker_EKeywordEvaluationType_TypeInfo = ZHMTypeInfo("ZActorPicker.EKeywordEvaluationType", EnumToJson<"ZActorPicker.EKeywordEvaluationType">, EnumToJsonSimple<"ZActorPicker.EKeywordEvaluationType">);
static ZHMTypeInfo EDestructibleInteractionType_TypeInfo = ZHMTypeInfo("EDestructibleInteractionType", EnumToJson<"EDestructibleInteractionType">, EnumToJsonSimple<"EDestructibleInteractionType">);
static ZHMTypeInfo EGameEventType_TypeInfo = ZHMTypeInfo("EGameEventType", EnumToJson<"EGameEventType">, EnumToJsonSimple<"EGameEventType">);
static ZHMTypeInfo EPhysicsObjectType_TypeInfo = ZHMTypeInfo("EPhysicsObjectType", EnumToJson<"EPhysicsObjectType">, EnumToJsonSimple<"EPhysicsObjectType">);
static ZHMTypeInfo eParticleEmitterMeshEntity_SpawnModes_TypeInfo = ZHMTypeInfo("eParticleEmitterMeshEntity_SpawnModes", EnumToJson<"eParticleEmitterMeshEntity_SpawnModes">, EnumToJsonSimple<"eParticleEmitterMeshEntity_SpawnModes">);
static ZHMTypeInfo eWeaponType_TypeInfo = ZHMTypeInfo("eWeaponType", EnumToJson<"eWeaponType">, EnumToJsonSimple<"eWeaponType">);
static ZHMTypeInfo ERatingTitle_TypeInfo = ZHMTypeInfo("ERatingTitle", EnumToJson<"ERatingTitle">, EnumToJsonSimple<"ERatingTitle">);
static ZHMTypeInfo ECameraControls_TypeInfo = ZHMTypeInfo("ECameraControls", EnumToJson<"ECameraControls">, EnumToJsonSimple<"ECameraControls">);
static ZHMTypeInfo ECollidableShape_TypeInfo = ZHMTypeInfo("ECollidableShape", EnumToJson<"ECollidableShape">, EnumToJsonSimple<"ECollidableShape">);
static ZHMTypeInfo EHM5SoundRicochetType_TypeInfo = ZHMTypeInfo("EHM5SoundRicochetType", EnumToJson<"EHM5SoundRicochetType">, EnumToJsonSimple<"EHM5SoundRicochetType">);
static ZHMTypeInfo ZUISplashHintDataProviderEntity_ESplashHintType_TypeInfo = ZHMTypeInfo("ZUISplashHintDataProviderEntity.ESplashHintType", EnumToJson<"ZUISplashHintDataProviderEntity.ESplashHintType">, EnumToJsonSimple<"ZUISplashHintDataProviderEntity.ESplashHintType">);
static ZHMTypeInfo ZHM5GameTimeMultiplierEntity_eTMLDReason_TypeInfo = ZHMTypeInfo("ZHM5GameTimeMultiplierEntity.eTMLDReason", EnumToJson<"ZHM5GameTimeMultiplierEntity.eTMLDReason">, EnumToJsonSimple<"ZHM5GameTimeMultiplierEntity.eTMLDReason">);
static ZHMTypeInfo ZInteractionEventConsumer_EEvent_TypeInfo = ZHMTypeInfo("ZInteractionEventConsumer.EEvent", EnumToJson<"ZInteractionEventConsumer.EEvent">, EnumToJsonSimple<"ZInteractionEventConsumer.EEvent">);
static ZHMTypeInfo ZHM5IndicatorManager_EIndicatorType_TypeInfo = ZHMTypeInfo("ZHM5IndicatorManager.EIndicatorType", EnumToJson<"ZHM5IndicatorManager.EIndicatorType">, EnumToJsonSimple<"ZHM5IndicatorManager.EIndicatorType">);
static ZHMTypeInfo BoneId_Enum_TypeInfo = ZHMTypeInfo("BoneId.Enum", EnumToJson<"BoneId.Enum">, EnumToJsonSimple<"BoneId.Enum">);
static ZHMTypeInfo ZVsTargetPicker_ETargetSelectionType_TypeInfo = ZHMTypeInfo("ZVsTargetPicker.ETargetSelectionType", EnumToJson<"ZVsTargetPicker.ETargetSelectionType">, EnumToJsonSimple<"ZVsTargetPicker.ETargetSelectionType">);
static ZHMTypeInfo ZAvoidDangerousAreaGroup_EAvoidDangerousAreaGroupState_TypeInfo = ZHMTypeInfo("ZAvoidDangerousAreaGroup.EAvoidDangerousAreaGroupState", EnumToJson<"ZAvoidDangerousAreaGroup.EAvoidDangerousAreaGroupState">, EnumToJsonSimple<"ZAvoidDangerousAreaGroup.EAvoidDangerousAreaGroupState">);
static ZHMTypeInfo EActorLookAtTargetType_TypeInfo = ZHMTypeInfo("EActorLookAtTargetType", EnumToJson<"EActorLookAtTargetType">, EnumToJsonSimple<"EActorLookAtTargetType">);
static ZHMTypeInfo ECustomSoundDefType_TypeInfo = ZHMTypeInfo("ECustomSoundDefType", EnumToJson<"ECustomSoundDefType">, EnumToJsonSimple<"ECustomSoundDefType">);
static ZHMTypeInfo EWeaponSpecialSituation_TypeInfo = ZHMTypeInfo("EWeaponSpecialSituation", EnumToJson<"EWeaponSpecialSituation">, EnumToJsonSimple<"EWeaponSpecialSituation">);
static ZHMTypeInfo EAIModifierScope_TypeInfo = ZHMTypeInfo("EAIModifierScope", EnumToJson<"EAIModifierScope">, EnumToJsonSimple<"EAIModifierScope">);
static ZHMTypeInfo ZHM5WeaponEventConsumer_EAnimWeapon_TypeInfo = ZHMTypeInfo("ZHM5WeaponEventConsumer.EAnimWeapon", EnumToJson<"ZHM5WeaponEventConsumer.EAnimWeapon">, EnumToJsonSimple<"ZHM5WeaponEventConsumer.EAnimWeapon">);
static ZHMTypeInfo EStashpointContainedEntityType_TypeInfo = ZHMTypeInfo("EStashpointContainedEntityType", EnumToJson<"EStashpointContainedEntityType">, EnumToJsonSimple<"EStashpointContainedEntityType">);
static ZHMTypeInfo ESoundCollisionType_TypeInfo = ZHMTypeInfo("ESoundCollisionType", EnumToJson<"ESoundCollisionType">, EnumToJsonSimple<"ESoundCollisionType">);
static ZHMTypeInfo ICloset_EClosetType_TypeInfo = ZHMTypeInfo("ICloset.EClosetType", EnumToJson<"ICloset.EClosetType">, EnumToJsonSimple<"ICloset.EClosetType">);
static ZHMTypeInfo EHitmanPermissionFlag_TypeInfo = ZHMTypeInfo("EHitmanPermissionFlag", EnumToJson<"EHitmanPermissionFlag">, EnumToJsonSimple<"EHitmanPermissionFlag">);
static ZHMTypeInfo EActionRadialArcIconType_TypeInfo = ZHMTypeInfo("EActionRadialArcIconType", EnumToJson<"EActionRadialArcIconType">, EnumToJsonSimple<"EActionRadialArcIconType">);
static ZHMTypeInfo EParticleDecalSpawnEntity_Constraints_TypeInfo = ZHMTypeInfo("EParticleDecalSpawnEntity_Constraints", EnumToJson<"EParticleDecalSpawnEntity_Constraints">, EnumToJsonSimple<"EParticleDecalSpawnEntity_Constraints">);
static ZHMTypeInfo ZActBehaviorEntity_ERotationAlignment_TypeInfo = ZHMTypeInfo("ZActBehaviorEntity.ERotationAlignment", EnumToJson<"ZActBehaviorEntity.ERotationAlignment">, EnumToJsonSimple<"ZActBehaviorEntity.ERotationAlignment">);
static ZHMTypeInfo ZPatrolBehaviorEntity_ERotationAlignment_TypeInfo = ZHMTypeInfo("ZPatrolBehaviorEntity.ERotationAlignment", EnumToJson<"ZPatrolBehaviorEntity.ERotationAlignment">, EnumToJsonSimple<"ZPatrolBehaviorEntity.ERotationAlignment">);
static ZHMTypeInfo EAnimBlendMode_TypeInfo = ZHMTypeInfo("EAnimBlendMode", EnumToJson<"EAnimBlendMode">, EnumToJsonSimple<"EAnimBlendMode">);
static ZHMTypeInfo ETeamModeId_TypeInfo = ZHMTypeInfo("ETeamModeId", EnumToJson<"ETeamModeId">, EnumToJsonSimple<"ETeamModeId">);
static ZHMTypeInfo ZUIControlEntity_EScaleMode_TypeInfo = ZHMTypeInfo("ZUIControlEntity.EScaleMode", EnumToJson<"ZUIControlEntity.EScaleMode">, EnumToJsonSimple<"ZUIControlEntity.EScaleMode">);
static ZHMTypeInfo ZInputListenerActorPool_eInputListenerButtons_TypeInfo = ZHMTypeInfo("ZInputListenerActorPool.eInputListenerButtons", EnumToJson<"ZInputListenerActorPool.eInputListenerButtons">, EnumToJsonSimple<"ZInputListenerActorPool.eInputListenerButtons">);
static ZHMTypeInfo ERuntimeMemoryAllocationState_TypeInfo = ZHMTypeInfo("ERuntimeMemoryAllocationState", EnumToJson<"ERuntimeMemoryAllocationState">, EnumToJsonSimple<"ERuntimeMemoryAllocationState">);
static ZHMTypeInfo CrowdRegionType_TypeInfo = ZHMTypeInfo("CrowdRegionType", EnumToJson<"CrowdRegionType">, EnumToJsonSimple<"CrowdRegionType">);
static ZHMTypeInfo EDramaEventAction_TypeInfo = ZHMTypeInfo("EDramaEventAction", EnumToJson<"EDramaEventAction">, EnumToJsonSimple<"EDramaEventAction">);
static ZHMTypeInfo ZRecoverUnconsciousGroup_EInvestigateGroupState_TypeInfo = ZHMTypeInfo("ZRecoverUnconsciousGroup.EInvestigateGroupState", EnumToJson<"ZRecoverUnconsciousGroup.EInvestigateGroupState">, EnumToJsonSimple<"ZRecoverUnconsciousGroup.EInvestigateGroupState">);
static ZHMTypeInfo ECharacterActionRequests_TypeInfo = ZHMTypeInfo("ECharacterActionRequests", EnumToJson<"ECharacterActionRequests">, EnumToJsonSimple<"ECharacterActionRequests">);
static ZHMTypeInfo ZHM5HIKEventConsumer_EBlend_TypeInfo = ZHMTypeInfo("ZHM5HIKEventConsumer.EBlend", EnumToJson<"ZHM5HIKEventConsumer.EBlend">, EnumToJsonSimple<"ZHM5HIKEventConsumer.EBlend">);
static ZHMTypeInfo EWeaponUpgradeIcon_TypeInfo = ZHMTypeInfo("EWeaponUpgradeIcon", EnumToJson<"EWeaponUpgradeIcon">, EnumToJsonSimple<"EWeaponUpgradeIcon">);
static ZHMTypeInfo ECollisionResponse_TypeInfo = ZHMTypeInfo("ECollisionResponse", EnumToJson<"ECollisionResponse">, EnumToJsonSimple<"ECollisionResponse">);
static ZHMTypeInfo ZDramaSituationEntity_EReentryBehavior_TypeInfo = ZHMTypeInfo("ZDramaSituationEntity.EReentryBehavior", EnumToJson<"ZDramaSituationEntity.EReentryBehavior">, EnumToJsonSimple<"ZDramaSituationEntity.EReentryBehavior">);
static ZHMTypeInfo IScatterContainerEntity_EResizeMode_TypeInfo = ZHMTypeInfo("IScatterContainerEntity.EResizeMode", EnumToJson<"IScatterContainerEntity.EResizeMode">, EnumToJsonSimple<"IScatterContainerEntity.EResizeMode">);
static ZHMTypeInfo ZBoneWeightRotationEntity_eRotationAxises_TypeInfo = ZHMTypeInfo("ZBoneWeightRotationEntity.eRotationAxises", EnumToJson<"ZBoneWeightRotationEntity.eRotationAxises">, EnumToJsonSimple<"ZBoneWeightRotationEntity.eRotationAxises">);
static ZHMTypeInfo EGameTension_TypeInfo = ZHMTypeInfo("EGameTension", EnumToJson<"EGameTension">, EnumToJsonSimple<"EGameTension">);
static ZHMTypeInfo ERegionMask_TypeInfo = ZHMTypeInfo("ERegionMask", EnumToJson<"ERegionMask">, EnumToJsonSimple<"ERegionMask">);
static ZHMTypeInfo ECharacterAnimEvent_TypeInfo = ZHMTypeInfo("ECharacterAnimEvent", EnumToJson<"ECharacterAnimEvent">, EnumToJsonSimple<"ECharacterAnimEvent">);
static ZHMTypeInfo EMatchOverCondition_TypeInfo = ZHMTypeInfo("EMatchOverCondition", EnumToJson<"EMatchOverCondition">, EnumToJsonSimple<"EMatchOverCondition">);
static ZHMTypeInfo CrowdUtil_ECrowdStandingPush_TypeInfo = ZHMTypeInfo("CrowdUtil.ECrowdStandingPush", EnumToJson<"CrowdUtil.ECrowdStandingPush">, EnumToJsonSimple<"CrowdUtil.ECrowdStandingPush">);
static ZHMTypeInfo EDialogueLine_TypeInfo = ZHMTypeInfo("EDialogueLine", EnumToJson<"EDialogueLine">, EnumToJsonSimple<"EDialogueLine">);
static ZHMTypeInfo EPostProcessorComponentType_TypeInfo = ZHMTypeInfo("EPostProcessorComponentType", EnumToJson<"EPostProcessorComponentType">, EnumToJsonSimple<"EPostProcessorComponentType">);
static ZHMTypeInfo WebSocketUtils_ECloseStatus_TypeInfo = ZHMTypeInfo("WebSocketUtils.ECloseStatus", EnumToJson<"WebSocketUtils.ECloseStatus">, EnumToJsonSimple<"WebSocketUtils.ECloseStatus">);
static ZHMTypeInfo EControlButtonName_TypeInfo = ZHMTypeInfo("EControlButtonName", EnumToJson<"EControlButtonName">, EnumToJsonSimple<"EControlButtonName">);
static ZHMTypeInfo ZInvestigateDisguiseGroup_EState_TypeInfo = ZHMTypeInfo("ZInvestigateDisguiseGroup.EState", EnumToJson<"ZInvestigateDisguiseGroup.EState">, EnumToJsonSimple<"ZInvestigateDisguiseGroup.EState">);
static ZHMTypeInfo ECOMUsage_TypeInfo = ZHMTypeInfo("ECOMUsage", EnumToJson<"ECOMUsage">, EnumToJsonSimple<"ECOMUsage">);
static ZHMTypeInfo EAIEventType_TypeInfo = ZHMTypeInfo("EAIEventType", EnumToJson<"EAIEventType">, EnumToJsonSimple<"EAIEventType">);
static ZHMTypeInfo EHM5SoundCloseCombatEvent_TypeInfo = ZHMTypeInfo("EHM5SoundCloseCombatEvent", EnumToJson<"EHM5SoundCloseCombatEvent">, EnumToJsonSimple<"EHM5SoundCloseCombatEvent">);
static ZHMTypeInfo EVirtualPlatformID_TypeInfo = ZHMTypeInfo("EVirtualPlatformID", EnumToJson<"EVirtualPlatformID">, EnumToJsonSimple<"EVirtualPlatformID">);
static ZHMTypeInfo eAmmoType_TypeInfo = ZHMTypeInfo("eAmmoType", EnumToJson<"eAmmoType">, EnumToJsonSimple<"eAmmoType">);
static ZHMTypeInfo ZEntityPropertyReplica_EReplicationStrategy_TypeInfo = ZHMTypeInfo("ZEntityPropertyReplica.EReplicationStrategy", EnumToJson<"ZEntityPropertyReplica.EReplicationStrategy">, EnumToJsonSimple<"ZEntityPropertyReplica.EReplicationStrategy">);
static ZHMTypeInfo ZApproachOrder_EApproachStyle_TypeInfo = ZHMTypeInfo("ZApproachOrder.EApproachStyle", EnumToJson<"ZApproachOrder.EApproachStyle">, EnumToJsonSimple<"ZApproachOrder.EApproachStyle">);
static ZHMTypeInfo ZInvestigateCautiousSituation_EBystanderState_TypeInfo = ZHMTypeInfo("ZInvestigateCautiousSituation.EBystanderState", EnumToJson<"ZInvestigateCautiousSituation.EBystanderState">, EnumToJsonSimple<"ZInvestigateCautiousSituation.EBystanderState">);
static ZHMTypeInfo ZSmuggleSituationEntity_ESmuggleState_TypeInfo = ZHMTypeInfo("ZSmuggleSituationEntity.ESmuggleState", EnumToJson<"ZSmuggleSituationEntity.ESmuggleState">, EnumToJsonSimple<"ZSmuggleSituationEntity.ESmuggleState">);
static ZHMTypeInfo ZSniperCombatSituation_ESituationState_TypeInfo = ZHMTypeInfo("ZSniperCombatSituation.ESituationState", EnumToJson<"ZSniperCombatSituation.ESituationState">, EnumToJsonSimple<"ZSniperCombatSituation.ESituationState">);
static ZHMTypeInfo EOnlineEventInvestigationType_TypeInfo = ZHMTypeInfo("EOnlineEventInvestigationType", EnumToJson<"EOnlineEventInvestigationType">, EnumToJsonSimple<"EOnlineEventInvestigationType">);
static ZHMTypeInfo IItemWeapon_EDeadlyThrowType_TypeInfo = ZHMTypeInfo("IItemWeapon.EDeadlyThrowType", EnumToJson<"IItemWeapon.EDeadlyThrowType">, EnumToJsonSimple<"IItemWeapon.EDeadlyThrowType">);
static ZHMTypeInfo EValueUpdateStrategy_TypeInfo = ZHMTypeInfo("EValueUpdateStrategy", EnumToJson<"EValueUpdateStrategy">, EnumToJsonSimple<"EValueUpdateStrategy">);
static ZHMTypeInfo ZEscortSituationEntity_ETargetState_TypeInfo = ZHMTypeInfo("ZEscortSituationEntity.ETargetState", EnumToJson<"ZEscortSituationEntity.ETargetState">, EnumToJsonSimple<"ZEscortSituationEntity.ETargetState">);
static ZHMTypeInfo IRenderCompositorEntity_EViewportAnchor_TypeInfo = ZHMTypeInfo("IRenderCompositorEntity.EViewportAnchor", EnumToJson<"IRenderCompositorEntity.EViewportAnchor">, EnumToJsonSimple<"IRenderCompositorEntity.EViewportAnchor">);
static ZHMTypeInfo ECoverPosition_TypeInfo = ZHMTypeInfo("ECoverPosition", EnumToJson<"ECoverPosition">, EnumToJsonSimple<"ECoverPosition">);
static ZHMTypeInfo EAgilityState_TypeInfo = ZHMTypeInfo("EAgilityState", EnumToJson<"EAgilityState">, EnumToJsonSimple<"EAgilityState">);
static ZHMTypeInfo SUITestData_ETestEnum_TypeInfo = ZHMTypeInfo("SUITestData.ETestEnum", EnumToJson<"SUITestData.ETestEnum">, EnumToJsonSimple<"SUITestData.ETestEnum">);
static ZHMTypeInfo EVRConfigCinemaMode_TypeInfo = ZHMTypeInfo("EVRConfigCinemaMode", EnumToJson<"EVRConfigCinemaMode">, EnumToJsonSimple<"EVRConfigCinemaMode">);
static ZHMTypeInfo EOutfitType_TypeInfo = ZHMTypeInfo("EOutfitType", EnumToJson<"EOutfitType">, EnumToJsonSimple<"EOutfitType">);
static ZHMTypeInfo ZActorTensionEntity_ETensionCheckMode_TypeInfo = ZHMTypeInfo("ZActorTensionEntity.ETensionCheckMode", EnumToJson<"ZActorTensionEntity.ETensionCheckMode">, EnumToJsonSimple<"ZActorTensionEntity.ETensionCheckMode">);
static ZHMTypeInfo EUbitusRequest_TypeInfo = ZHMTypeInfo("EUbitusRequest", EnumToJson<"EUbitusRequest">, EnumToJsonSimple<"EUbitusRequest">);
static ZHMTypeInfo ZScreenplay_EState_TypeInfo = ZHMTypeInfo("ZScreenplay.EState", EnumToJson<"ZScreenplay.EState">, EnumToJsonSimple<"ZScreenplay.EState">);
static ZHMTypeInfo EDifficultyParameter_TypeInfo = ZHMTypeInfo("EDifficultyParameter", EnumToJson<"EDifficultyParameter">, EnumToJsonSimple<"EDifficultyParameter">);
static ZHMTypeInfo ZInputListenerButtonEntity_eInputListenerButtons_TypeInfo = ZHMTypeInfo("ZInputListenerButtonEntity.eInputListenerButtons", EnumToJson<"ZInputListenerButtonEntity.eInputListenerButtons">, EnumToJsonSimple<"ZInputListenerButtonEntity.eInputListenerButtons">);
static ZHMTypeInfo EEquipAbility_TypeInfo = ZHMTypeInfo("EEquipAbility", EnumToJson<"EEquipAbility">, EnumToJsonSimple<"EEquipAbility">);
static ZHMTypeInfo EAISituationEvent_TypeInfo = ZHMTypeInfo("EAISituationEvent", EnumToJson<"EAISituationEvent">, EnumToJsonSimple<"EAISituationEvent">);
static ZHMTypeInfo ZLeadEscortSituationEntity_EEscortState_TypeInfo = ZHMTypeInfo("ZLeadEscortSituationEntity.EEscortState", EnumToJson<"ZLeadEscortSituationEntity.EEscortState">, EnumToJsonSimple<"ZLeadEscortSituationEntity.EEscortState">);
static ZHMTypeInfo ZSniperCombatGroup_EGroupState_TypeInfo = ZHMTypeInfo("ZSniperCombatGroup.EGroupState", EnumToJson<"ZSniperCombatGroup.EGroupState">, EnumToJsonSimple<"ZSniperCombatGroup.EGroupState">);
static ZHMTypeInfo EVolumeTriggerEntityTypeFlags_TypeInfo = ZHMTypeInfo("EVolumeTriggerEntityTypeFlags", EnumToJson<"EVolumeTriggerEntityTypeFlags">, EnumToJsonSimple<"EVolumeTriggerEntityTypeFlags">);
static ZHMTypeInfo ZSetUIControlDisplayInfoEntity_EVisibilityOp_TypeInfo = ZHMTypeInfo("ZSetUIControlDisplayInfoEntity.EVisibilityOp", EnumToJson<"ZSetUIControlDisplayInfoEntity.EVisibilityOp">, EnumToJsonSimple<"ZSetUIControlDisplayInfoEntity.EVisibilityOp">);
static ZHMTypeInfo EActionPromptState_TypeInfo = ZHMTypeInfo("EActionPromptState", EnumToJson<"EActionPromptState">, EnumToJsonSimple<"EActionPromptState">);
static ZHMTypeInfo ZMoveToPositionBehaviorEntity_ERotationAlignment_TypeInfo = ZHMTypeInfo("ZMoveToPositionBehaviorEntity.ERotationAlignment", EnumToJson<"ZMoveToPositionBehaviorEntity.ERotationAlignment">, EnumToJsonSimple<"ZMoveToPositionBehaviorEntity.ERotationAlignment">);
static ZHMTypeInfo ESaveType_TypeInfo = ZHMTypeInfo("ESaveType", EnumToJson<"ESaveType">, EnumToJsonSimple<"ESaveType">);
static ZHMTypeInfo ZHM5WeaponBasicConfigEntity_EWeaponBasicConfigAudioFireType_TypeInfo = ZHMTypeInfo("ZHM5WeaponBasicConfigEntity.EWeaponBasicConfigAudioFireType", EnumToJson<"ZHM5WeaponBasicConfigEntity.EWeaponBasicConfigAudioFireType">, EnumToJsonSimple<"ZHM5WeaponBasicConfigEntity.EWeaponBasicConfigAudioFireType">);
static ZHMTypeInfo EButtonPressType_TypeInfo = ZHMTypeInfo("EButtonPressType", EnumToJson<"EButtonPressType">, EnumToJsonSimple<"EButtonPressType">);
static ZHMTypeInfo EImpactEffectsOptions_TypeInfo = ZHMTypeInfo("EImpactEffectsOptions", EnumToJson<"EImpactEffectsOptions">, EnumToJsonSimple<"EImpactEffectsOptions">);
static ZHMTypeInfo EBooleanOption_TypeInfo = ZHMTypeInfo("EBooleanOption", EnumToJson<"EBooleanOption">, EnumToJsonSimple<"EBooleanOption">);
static ZHMTypeInfo EStandRepositionStrategy_TypeInfo = ZHMTypeInfo("EStandRepositionStrategy", EnumToJson<"EStandRepositionStrategy">, EnumToJsonSimple<"EStandRepositionStrategy">);
static ZHMTypeInfo ZLookAtLogic_EAxisSelect_TypeInfo = ZHMTypeInfo("ZLookAtLogic.EAxisSelect", EnumToJson<"ZLookAtLogic.EAxisSelect">, EnumToJsonSimple<"ZLookAtLogic.EAxisSelect">);
static ZHMTypeInfo ESituationStateChangeReason_TypeInfo = ZHMTypeInfo("ESituationStateChangeReason", EnumToJson<"ESituationStateChangeReason">, EnumToJsonSimple<"ESituationStateChangeReason">);
static ZHMTypeInfo EMaterialRegistrationState_TypeInfo = ZHMTypeInfo("EMaterialRegistrationState", EnumToJson<"EMaterialRegistrationState">, EnumToJsonSimple<"EMaterialRegistrationState">);
static ZHMTypeInfo ZRenderPostfilterParametersEntity_EDOFBlurType_TypeInfo = ZHMTypeInfo("ZRenderPostfilterParametersEntity.EDOFBlurType", EnumToJson<"ZRenderPostfilterParametersEntity.EDOFBlurType">, EnumToJsonSimple<"ZRenderPostfilterParametersEntity.EDOFBlurType">);
static ZHMTypeInfo CrowdReactionAIEventType_TypeInfo = ZHMTypeInfo("CrowdReactionAIEventType", EnumToJson<"CrowdReactionAIEventType">, EnumToJsonSimple<"CrowdReactionAIEventType">);
static ZHMTypeInfo ZHeroEscortSituationEntity_ETargetState_TypeInfo = ZHMTypeInfo("ZHeroEscortSituationEntity.ETargetState", EnumToJson<"ZHeroEscortSituationEntity.ETargetState">, EnumToJsonSimple<"ZHeroEscortSituationEntity.ETargetState">);
static ZHMTypeInfo ZHitmanLocomotionQuery_EEvaluationType_TypeInfo = ZHMTypeInfo("ZHitmanLocomotionQuery.EEvaluationType", EnumToJson<"ZHitmanLocomotionQuery.EEvaluationType">, EnumToJsonSimple<"ZHitmanLocomotionQuery.EEvaluationType">);
static ZHMTypeInfo CrowdUtil_EDefaultStateTypes_TypeInfo = ZHMTypeInfo("CrowdUtil.EDefaultStateTypes", EnumToJson<"CrowdUtil.EDefaultStateTypes">, EnumToJsonSimple<"CrowdUtil.EDefaultStateTypes">);
static ZHMTypeInfo ZAIPerceptibleEntity_EReactionBehaviorMode_TypeInfo = ZHMTypeInfo("ZAIPerceptibleEntity.EReactionBehaviorMode", EnumToJson<"ZAIPerceptibleEntity.EReactionBehaviorMode">, EnumToJsonSimple<"ZAIPerceptibleEntity.EReactionBehaviorMode">);
static ZHMTypeInfo EGameEventArgType_TypeInfo = ZHMTypeInfo("EGameEventArgType", EnumToJson<"EGameEventArgType">, EnumToJsonSimple<"EGameEventArgType">);
static ZHMTypeInfo ZCautiousSearchGroup_ESearchGroupState_TypeInfo = ZHMTypeInfo("ZCautiousSearchGroup.ESearchGroupState", EnumToJson<"ZCautiousSearchGroup.ESearchGroupState">, EnumToJsonSimple<"ZCautiousSearchGroup.ESearchGroupState">);
static ZHMTypeInfo EVRConfigRotationType_TypeInfo = ZHMTypeInfo("EVRConfigRotationType", EnumToJson<"EVRConfigRotationType">, EnumToJsonSimple<"EVRConfigRotationType">);
static ZHMTypeInfo IRoomEntity_EReasoningGridImportance_TypeInfo = ZHMTypeInfo("IRoomEntity.EReasoningGridImportance", EnumToJson<"IRoomEntity.EReasoningGridImportance">, EnumToJsonSimple<"IRoomEntity.EReasoningGridImportance">);
static ZHMTypeInfo EFSMInternalEvent_TypeInfo = ZHMTypeInfo("EFSMInternalEvent", EnumToJson<"EFSMInternalEvent">, EnumToJsonSimple<"EFSMInternalEvent">);
static ZHMTypeInfo ZOnlineManager_EState_TypeInfo = ZHMTypeInfo("ZOnlineManager.EState", EnumToJson<"ZOnlineManager.EState">, EnumToJsonSimple<"ZOnlineManager.EState">);
static ZHMTypeInfo ZDebugHM5GameTimeMultiplierEnt_eTMLDReason_TypeInfo = ZHMTypeInfo("ZDebugHM5GameTimeMultiplierEnt.eTMLDReason", EnumToJson<"ZDebugHM5GameTimeMultiplierEnt.eTMLDReason">, EnumToJsonSimple<"ZDebugHM5GameTimeMultiplierEnt.eTMLDReason">);
static ZHMTypeInfo ECautiousDisturbanceState_TypeInfo = ZHMTypeInfo("ECautiousDisturbanceState", EnumToJson<"ECautiousDisturbanceState">, EnumToJsonSimple<"ECautiousDisturbanceState">);
static ZHMTypeInfo ZValueBool_Operation_EEvaluationType_TypeInfo = ZHMTypeInfo("ZValueBool_Operation.EEvaluationType", EnumToJson<"ZValueBool_Operation.EEvaluationType">, EnumToJsonSimple<"ZValueBool_Operation.EEvaluationType">);
static ZHMTypeInfo IContractObjective_SCounterData_ECounterType_TypeInfo = ZHMTypeInfo("IContractObjective.SCounterData.ECounterType", EnumToJson<"IContractObjective.SCounterData.ECounterType">, EnumToJsonSimple<"IContractObjective.SCounterData.ECounterType">);
static ZHMTypeInfo ECCNodeType_TypeInfo = ZHMTypeInfo("ECCNodeType", EnumToJson<"ECCNodeType">, EnumToJsonSimple<"ECCNodeType">);
static ZHMTypeInfo ZHM5CrowdGenericEventConsumer_EEvent_TypeInfo = ZHMTypeInfo("ZHM5CrowdGenericEventConsumer.EEvent", EnumToJson<"ZHM5CrowdGenericEventConsumer.EEvent">, EnumToJsonSimple<"ZHM5CrowdGenericEventConsumer.EEvent">);
static ZHMTypeInfo EFontFlags_TypeInfo = ZHMTypeInfo("EFontFlags", EnumToJson<"EFontFlags">, EnumToJsonSimple<"EFontFlags">);
static ZHMTypeInfo EDeathBehavior_TypeInfo = ZHMTypeInfo("EDeathBehavior", EnumToJson<"EDeathBehavior">, EnumToJsonSimple<"EDeathBehavior">);
static ZHMTypeInfo CrowdMapImpl_CellFlags_TypeInfo = ZHMTypeInfo("CrowdMapImpl.CellFlags", EnumToJson<"CrowdMapImpl.CellFlags">, EnumToJsonSimple<"CrowdMapImpl.CellFlags">);
static ZHMTypeInfo ZBoneAttachEntity_EResetMode_TypeInfo = ZHMTypeInfo("ZBoneAttachEntity.EResetMode", EnumToJson<"ZBoneAttachEntity.EResetMode">, EnumToJsonSimple<"ZBoneAttachEntity.EResetMode">);
static ZHMTypeInfo EAIModifiers_TypeInfo = ZHMTypeInfo("EAIModifiers", EnumToJson<"EAIModifiers">, EnumToJsonSimple<"EAIModifiers">);
static ZHMTypeInfo ESoundGateType_TypeInfo = ZHMTypeInfo("ESoundGateType", EnumToJson<"ESoundGateType">, EnumToJsonSimple<"ESoundGateType">);
static ZHMTypeInfo ZVRCameraEntity_ETurnMode_TypeInfo = ZHMTypeInfo("ZVRCameraEntity.ETurnMode", EnumToJson<"ZVRCameraEntity.ETurnMode">, EnumToJsonSimple<"ZVRCameraEntity.ETurnMode">);
static ZHMTypeInfo ZChannelKeywordCondition_EEvaluationType_TypeInfo = ZHMTypeInfo("ZChannelKeywordCondition.EEvaluationType", EnumToJson<"ZChannelKeywordCondition.EEvaluationType">, EnumToJsonSimple<"ZChannelKeywordCondition.EEvaluationType">);
static ZHMTypeInfo ZUIFlowLayoutEntity_EFlowType_TypeInfo = ZHMTypeInfo("ZUIFlowLayoutEntity.EFlowType", EnumToJson<"ZUIFlowLayoutEntity.EFlowType">, EnumToJsonSimple<"ZUIFlowLayoutEntity.EFlowType">);
static ZHMTypeInfo ZTrackDollyControllerQueryEntity_ETrackPointQueryType_TypeInfo = ZHMTypeInfo("ZTrackDollyControllerQueryEntity.ETrackPointQueryType", EnumToJson<"ZTrackDollyControllerQueryEntity.ETrackPointQueryType">, EnumToJsonSimple<"ZTrackDollyControllerQueryEntity.ETrackPointQueryType">);
static ZHMTypeInfo ESubcontrollerInventorySlot_TypeInfo = ZHMTypeInfo("ESubcontrollerInventorySlot", EnumToJson<"ESubcontrollerInventorySlot">, EnumToJsonSimple<"ESubcontrollerInventorySlot">);
static ZHMTypeInfo IHM5Door_EInitialState_TypeInfo = ZHMTypeInfo("IHM5Door.EInitialState", EnumToJson<"IHM5Door.EInitialState">, EnumToJsonSimple<"IHM5Door.EInitialState">);
static ZHMTypeInfo EActionType_TypeInfo = ZHMTypeInfo("EActionType", EnumToJson<"EActionType">, EnumToJsonSimple<"EActionType">);
static ZHMTypeInfo ERANDOM_DISTRIBUTION_TypeInfo = ZHMTypeInfo("ERANDOM_DISTRIBUTION", EnumToJson<"ERANDOM_DISTRIBUTION">, EnumToJsonSimple<"ERANDOM_DISTRIBUTION">);
static ZHMTypeInfo InputControlNamesp_eHM5InputActionType_TypeInfo = ZHMTypeInfo("InputControlNamesp.eHM5InputActionType", EnumToJson<"InputControlNamesp.eHM5InputActionType">, EnumToJsonSimple<"InputControlNamesp.eHM5InputActionType">);
static ZHMTypeInfo ERatingCategory_TypeInfo = ZHMTypeInfo("ERatingCategory", EnumToJson<"ERatingCategory">, EnumToJsonSimple<"ERatingCategory">);
static ZHMTypeInfo EDebugSpatialInfoVerbosity_TypeInfo = ZHMTypeInfo("EDebugSpatialInfoVerbosity", EnumToJson<"EDebugSpatialInfoVerbosity">, EnumToJsonSimple<"EDebugSpatialInfoVerbosity">);
static ZHMTypeInfo EPlayMode_TypeInfo = ZHMTypeInfo("EPlayMode", EnumToJson<"EPlayMode">, EnumToJsonSimple<"EPlayMode">);
static ZHMTypeInfo ZHM5FaceFXSpecificEventConsumer_EEvent_TypeInfo = ZHMTypeInfo("ZHM5FaceFXSpecificEventConsumer.EEvent", EnumToJson<"ZHM5FaceFXSpecificEventConsumer.EEvent">, EnumToJsonSimple<"ZHM5FaceFXSpecificEventConsumer.EEvent">);
static ZHMTypeInfo EIKEndEffector_TypeInfo = ZHMTypeInfo("EIKEndEffector", EnumToJson<"EIKEndEffector">, EnumToJsonSimple<"EIKEndEffector">);
static ZHMTypeInfo EHintMessageType_TypeInfo = ZHMTypeInfo("EHintMessageType", EnumToJson<"EHintMessageType">, EnumToJsonSimple<"EHintMessageType">);
static ZHMTypeInfo EHUDMessageStatus_TypeInfo = ZHMTypeInfo("EHUDMessageStatus", EnumToJson<"EHUDMessageStatus">, EnumToJsonSimple<"EHUDMessageStatus">);
static ZHMTypeInfo ERequirementId_TypeInfo = ZHMTypeInfo("ERequirementId", EnumToJson<"ERequirementId">, EnumToJsonSimple<"ERequirementId">);
static ZHMTypeInfo ZSecuritySystemCameraConfiguration_ECameraEscalationSituations_TypeInfo = ZHMTypeInfo("ZSecuritySystemCameraConfiguration.ECameraEscalationSituations", EnumToJson<"ZSecuritySystemCameraConfiguration.ECameraEscalationSituations">, EnumToJsonSimple<"ZSecuritySystemCameraConfiguration.ECameraEscalationSituations">);
static ZHMTypeInfo EConstraintType_TypeInfo = ZHMTypeInfo("EConstraintType", EnumToJson<"EConstraintType">, EnumToJsonSimple<"EConstraintType">);
static ZHMTypeInfo EVRIKElementMode_TypeInfo = ZHMTypeInfo("EVRIKElementMode", EnumToJson<"EVRIKElementMode">, EnumToJsonSimple<"EVRIKElementMode">);
static ZHMTypeInfo EObjectiveType_TypeInfo = ZHMTypeInfo("EObjectiveType", EnumToJson<"EObjectiveType">, EnumToJsonSimple<"EObjectiveType">);
static ZHMTypeInfo EWeaponUpgradeUse_TypeInfo = ZHMTypeInfo("EWeaponUpgradeUse", EnumToJson<"EWeaponUpgradeUse">, EnumToJsonSimple<"EWeaponUpgradeUse">);
static ZHMTypeInfo EActorSoundDefs_TypeInfo = ZHMTypeInfo("EActorSoundDefs", EnumToJson<"EActorSoundDefs">, EnumToJsonSimple<"EActorSoundDefs">);
static ZHMTypeInfo Network_OrderingChannel_TypeInfo = ZHMTypeInfo("Network.OrderingChannel", EnumToJson<"Network.OrderingChannel">, EnumToJsonSimple<"Network.OrderingChannel">);
static ZHMTypeInfo ZRenderPostfilterParametersEntity_EHDRAdaptationType_TypeInfo = ZHMTypeInfo("ZRenderPostfilterParametersEntity.EHDRAdaptationType", EnumToJson<"ZRenderPostfilterParametersEntity.EHDRAdaptationType">, EnumToJsonSimple<"ZRenderPostfilterParametersEntity.EHDRAdaptationType">);
static ZHMTypeInfo ECheatGroup_TypeInfo = ZHMTypeInfo("ECheatGroup", EnumToJson<"ECheatGroup">, EnumToJsonSimple<"ECheatGroup">);
static ZHMTypeInfo EReplicaOperation_TypeInfo = ZHMTypeInfo("EReplicaOperation", EnumToJson<"EReplicaOperation">, EnumToJsonSimple<"EReplicaOperation">);
static ZHMTypeInfo ECCEmitterEffect_TypeInfo = ZHMTypeInfo("ECCEmitterEffect", EnumToJson<"ECCEmitterEffect">, EnumToJsonSimple<"ECCEmitterEffect">);
static ZHMTypeInfo ECommunicationBarState_TypeInfo = ZHMTypeInfo("ECommunicationBarState", EnumToJson<"ECommunicationBarState">, EnumToJsonSimple<"ECommunicationBarState">);
static ZHMTypeInfo EButtonDisplay_TypeInfo = ZHMTypeInfo("EButtonDisplay", EnumToJson<"EButtonDisplay">, EnumToJsonSimple<"EButtonDisplay">);
static ZHMTypeInfo ZValueBool_OperationRecalc_EEvaluationType_TypeInfo = ZHMTypeInfo("ZValueBool_OperationRecalc.EEvaluationType", EnumToJson<"ZValueBool_OperationRecalc.EEvaluationType">, EnumToJsonSimple<"ZValueBool_OperationRecalc.EEvaluationType">);
static ZHMTypeInfo EHM5SoundBulletType_TypeInfo = ZHMTypeInfo("EHM5SoundBulletType", EnumToJson<"EHM5SoundBulletType">, EnumToJsonSimple<"EHM5SoundBulletType">);
static ZHMTypeInfo EContinuity_TypeInfo = ZHMTypeInfo("EContinuity", EnumToJson<"EContinuity">, EnumToJsonSimple<"EContinuity">);
static ZHMTypeInfo EVRRenderingMode_TypeInfo = ZHMTypeInfo("EVRRenderingMode", EnumToJson<"EVRRenderingMode">, EnumToJsonSimple<"EVRRenderingMode">);
static ZHMTypeInfo ZHM5WeaponBasicConfigEntity_EWeaponBasicConfigAudioHeadTailType_TypeInfo = ZHMTypeInfo("ZHM5WeaponBasicConfigEntity.EWeaponBasicConfigAudioHeadTailType", EnumToJson<"ZHM5WeaponBasicConfigEntity.EWeaponBasicConfigAudioHeadTailType">, EnumToJsonSimple<"ZHM5WeaponBasicConfigEntity.EWeaponBasicConfigAudioHeadTailType">);
static ZHMTypeInfo ECharacterFullBodyStateType_TypeInfo = ZHMTypeInfo("ECharacterFullBodyStateType", EnumToJson<"ECharacterFullBodyStateType">, EnumToJsonSimple<"ECharacterFullBodyStateType">);
static ZHMTypeInfo EControllerButton_TypeInfo = ZHMTypeInfo("EControllerButton", EnumToJson<"EControllerButton">, EnumToJsonSimple<"EControllerButton">);
static ZHMTypeInfo ZCautiousBackupGroup_EGroupState_TypeInfo = ZHMTypeInfo("ZCautiousBackupGroup.EGroupState", EnumToJson<"ZCautiousBackupGroup.EGroupState">, EnumToJsonSimple<"ZCautiousBackupGroup.EGroupState">);
static ZHMTypeInfo ZHM5HitmanHealthModifier_EHealthDrainType_TypeInfo = ZHMTypeInfo("ZHM5HitmanHealthModifier.EHealthDrainType", EnumToJson<"ZHM5HitmanHealthModifier.EHealthDrainType">, EnumToJsonSimple<"ZHM5HitmanHealthModifier.EHealthDrainType">);
static ZHMTypeInfo ERayType_TypeInfo = ZHMTypeInfo("ERayType", EnumToJson<"ERayType">, EnumToJsonSimple<"ERayType">);
static ZHMTypeInfo ZHM5BodyContainer_EBCBodyMode_TypeInfo = ZHMTypeInfo("ZHM5BodyContainer.EBCBodyMode", EnumToJson<"ZHM5BodyContainer.EBCBodyMode">, EnumToJsonSimple<"ZHM5BodyContainer.EBCBodyMode">);
static ZHMTypeInfo ESoundMaterialType_TypeInfo = ZHMTypeInfo("ESoundMaterialType", EnumToJson<"ESoundMaterialType">, EnumToJsonSimple<"ESoundMaterialType">);
static ZHMTypeInfo EScreenAnchor_TypeInfo = ZHMTypeInfo("EScreenAnchor", EnumToJson<"EScreenAnchor">, EnumToJsonSimple<"EScreenAnchor">);
static ZHMTypeInfo eHitmanPermissionReason_TypeInfo = ZHMTypeInfo("eHitmanPermissionReason", EnumToJson<"eHitmanPermissionReason">, EnumToJsonSimple<"eHitmanPermissionReason">);
static ZHMTypeInfo EActorAnimationOrder_TypeInfo = ZHMTypeInfo("EActorAnimationOrder", EnumToJson<"EActorAnimationOrder">, EnumToJsonSimple<"EActorAnimationOrder">);
static ZHMTypeInfo ESpeed_TypeInfo = ZHMTypeInfo("ESpeed", EnumToJson<"ESpeed">, EnumToJsonSimple<"ESpeed">);
static ZHMTypeInfo ESeamFixMode_TypeInfo = ZHMTypeInfo("ESeamFixMode", EnumToJson<"ESeamFixMode">, EnumToJsonSimple<"ESeamFixMode">);
static ZHMTypeInfo ESyncEvent_TypeInfo = ZHMTypeInfo("ESyncEvent", EnumToJson<"ESyncEvent">, EnumToJsonSimple<"ESyncEvent">);
static ZHMTypeInfo CrowdUtil_ECrowdDirection_TypeInfo = ZHMTypeInfo("CrowdUtil.ECrowdDirection", EnumToJson<"CrowdUtil.ECrowdDirection">, EnumToJsonSimple<"CrowdUtil.ECrowdDirection">);
static ZHMTypeInfo ZPreferenceItemEntity_EBoolOptions_TypeInfo = ZHMTypeInfo("ZPreferenceItemEntity.EBoolOptions", EnumToJson<"ZPreferenceItemEntity.EBoolOptions">, EnumToJsonSimple<"ZPreferenceItemEntity.EBoolOptions">);
static ZHMTypeInfo ZHM5WeaponBasicConfigEntity_EWeaponBasicConfigAudioFamily_TypeInfo = ZHMTypeInfo("ZHM5WeaponBasicConfigEntity.EWeaponBasicConfigAudioFamily", EnumToJson<"ZHM5WeaponBasicConfigEntity.EWeaponBasicConfigAudioFamily">, EnumToJsonSimple<"ZHM5WeaponBasicConfigEntity.EWeaponBasicConfigAudioFamily">);
static ZHMTypeInfo ZStandOffSituation_EDialogState_TypeInfo = ZHMTypeInfo("ZStandOffSituation.EDialogState", EnumToJson<"ZStandOffSituation.EDialogState">, EnumToJsonSimple<"ZStandOffSituation.EDialogState">);
static ZHMTypeInfo ZCameraConeTriggerEntity_EAlignment_TypeInfo = ZHMTypeInfo("ZCameraConeTriggerEntity.EAlignment", EnumToJson<"ZCameraConeTriggerEntity.EAlignment">, EnumToJsonSimple<"ZCameraConeTriggerEntity.EAlignment">);
static ZHMTypeInfo ZHeroInventoryAction_EEvaluationType_TypeInfo = ZHMTypeInfo("ZHeroInventoryAction.EEvaluationType", EnumToJson<"ZHeroInventoryAction.EEvaluationType">, EnumToJsonSimple<"ZHeroInventoryAction.EEvaluationType">);
static ZHMTypeInfo IContractObjective_Category_TypeInfo = ZHMTypeInfo("IContractObjective.Category", EnumToJson<"IContractObjective.Category">, EnumToJsonSimple<"IContractObjective.Category">);
static ZHMTypeInfo ZHM5LedgeMount_ELedgeEndState_TypeInfo = ZHMTypeInfo("ZHM5LedgeMount.ELedgeEndState", EnumToJson<"ZHM5LedgeMount.ELedgeEndState">, EnumToJsonSimple<"ZHM5LedgeMount.ELedgeEndState">);
static ZHMTypeInfo EHUDElement_TypeInfo = ZHMTypeInfo("EHUDElement", EnumToJson<"EHUDElement">, EnumToJsonSimple<"EHUDElement">);
static ZHMTypeInfo ZHUDCamera3DControllerEntity_EMode_TypeInfo = ZHMTypeInfo("ZHUDCamera3DControllerEntity.EMode", EnumToJson<"ZHUDCamera3DControllerEntity.EMode">, EnumToJsonSimple<"ZHUDCamera3DControllerEntity.EMode">);
static ZHMTypeInfo ZHUDTimerInstance_ETimeFormatChoice_TypeInfo = ZHMTypeInfo("ZHUDTimerInstance.ETimeFormatChoice", EnumToJson<"ZHUDTimerInstance.ETimeFormatChoice">, EnumToJsonSimple<"ZHUDTimerInstance.ETimeFormatChoice">);
static ZHMTypeInfo ECollidablesType_TypeInfo = ZHMTypeInfo("ECollidablesType", EnumToJson<"ECollidablesType">, EnumToJsonSimple<"ECollidablesType">);
static ZHMTypeInfo EParticleModifierImpulseDirections_TypeInfo = ZHMTypeInfo("EParticleModifierImpulseDirections", EnumToJson<"EParticleModifierImpulseDirections">, EnumToJsonSimple<"EParticleModifierImpulseDirections">);
static ZHMTypeInfo EItemPoisonType_TypeInfo = ZHMTypeInfo("EItemPoisonType", EnumToJson<"EItemPoisonType">, EnumToJsonSimple<"EItemPoisonType">);
static ZHMTypeInfo EScreenplayTriggerEvent_TypeInfo = ZHMTypeInfo("EScreenplayTriggerEvent", EnumToJson<"EScreenplayTriggerEvent">, EnumToJsonSimple<"EScreenplayTriggerEvent">);
static ZHMTypeInfo ETakeDownAnim_TypeInfo = ZHMTypeInfo("ETakeDownAnim", EnumToJson<"ETakeDownAnim">, EnumToJsonSimple<"ETakeDownAnim">);
static ZHMTypeInfo eVRFadeType_TypeInfo = ZHMTypeInfo("eVRFadeType", EnumToJson<"eVRFadeType">, EnumToJsonSimple<"eVRFadeType">);
static ZHMTypeInfo ZLogicMultipleGate_EGateType_TypeInfo = ZHMTypeInfo("ZLogicMultipleGate.EGateType", EnumToJson<"ZLogicMultipleGate.EGateType">, EnumToJsonSimple<"ZLogicMultipleGate.EGateType">);
static ZHMTypeInfo ZActBehaviorEntity_EMovementType_TypeInfo = ZHMTypeInfo("ZActBehaviorEntity.EMovementType", EnumToJson<"ZActBehaviorEntity.EMovementType">, EnumToJsonSimple<"ZActBehaviorEntity.EMovementType">);
static ZHMTypeInfo ZPatrolBehaviorEntity_EMovementType_TypeInfo = ZHMTypeInfo("ZPatrolBehaviorEntity.EMovementType", EnumToJson<"ZPatrolBehaviorEntity.EMovementType">, EnumToJsonSimple<"ZPatrolBehaviorEntity.EMovementType">);
static ZHMTypeInfo EUIActionGroupIcon_TypeInfo = ZHMTypeInfo("EUIActionGroupIcon", EnumToJson<"EUIActionGroupIcon">, EnumToJsonSimple<"EUIActionGroupIcon">);
static ZHMTypeInfo ESilenceRating_TypeInfo = ZHMTypeInfo("ESilenceRating", EnumToJson<"ESilenceRating">, EnumToJsonSimple<"ESilenceRating">);
static ZHMTypeInfo GameLobbyState_TypeInfo = ZHMTypeInfo("GameLobbyState", EnumToJson<"GameLobbyState">, EnumToJsonSimple<"GameLobbyState">);
static ZHMTypeInfo EVRConfigHeadAnchorMode_TypeInfo = ZHMTypeInfo("EVRConfigHeadAnchorMode", EnumToJson<"EVRConfigHeadAnchorMode">, EnumToJsonSimple<"EVRConfigHeadAnchorMode">);
static ZHMTypeInfo EFilterMaskBit_TypeInfo = ZHMTypeInfo("EFilterMaskBit", EnumToJson<"EFilterMaskBit">, EnumToJsonSimple<"EFilterMaskBit">);
static ZHMTypeInfo ECollisionPriority_TypeInfo = ZHMTypeInfo("ECollisionPriority", EnumToJson<"ECollisionPriority">, EnumToJsonSimple<"ECollisionPriority">);
static ZHMTypeInfo ZActStateCondition_EState_TypeInfo = ZHMTypeInfo("ZActStateCondition.EState", EnumToJson<"ZActStateCondition.EState">, EnumToJsonSimple<"ZActStateCondition.EState">);
static ZHMTypeInfo ELedgeDismountBehavior_TypeInfo = ZHMTypeInfo("ELedgeDismountBehavior", EnumToJson<"ELedgeDismountBehavior">, EnumToJsonSimple<"ELedgeDismountBehavior">);
static ZHMTypeInfo IContractObjective_Type_TypeInfo = ZHMTypeInfo("IContractObjective.Type", EnumToJson<"IContractObjective.Type">, EnumToJsonSimple<"IContractObjective.Type">);
static ZHMTypeInfo ZValueInt_Evaluation_EEvaluationType_TypeInfo = ZHMTypeInfo("ZValueInt_Evaluation.EEvaluationType", EnumToJson<"ZValueInt_Evaluation.EEvaluationType">, EnumToJsonSimple<"ZValueInt_Evaluation.EEvaluationType">);
static ZHMTypeInfo IScatterContainerEntity_ECanvasSize_TypeInfo = ZHMTypeInfo("IScatterContainerEntity.ECanvasSize", EnumToJson<"IScatterContainerEntity.ECanvasSize">, EnumToJsonSimple<"IScatterContainerEntity.ECanvasSize">);
static ZHMTypeInfo ZMoveToOrder_EMoveSpeed_TypeInfo = ZHMTypeInfo("ZMoveToOrder.EMoveSpeed", EnumToJson<"ZMoveToOrder.EMoveSpeed">, EnumToJsonSimple<"ZMoveToOrder.EMoveSpeed">);
static ZHMTypeInfo ECCDecalEffect_TypeInfo = ZHMTypeInfo("ECCDecalEffect", EnumToJson<"ECCDecalEffect">, EnumToJsonSimple<"ECCDecalEffect">);
static ZHMTypeInfo ZContractObjectiveHudHintEntity_EObjectiveHintIcon_TypeInfo = ZHMTypeInfo("ZContractObjectiveHudHintEntity.EObjectiveHintIcon", EnumToJson<"ZContractObjectiveHudHintEntity.EObjectiveHintIcon">, EnumToJsonSimple<"ZContractObjectiveHudHintEntity.EObjectiveHintIcon">);
static ZHMTypeInfo IScatterContainerEntity_ECanvasClearMode_TypeInfo = ZHMTypeInfo("IScatterContainerEntity.ECanvasClearMode", EnumToJson<"IScatterContainerEntity.ECanvasClearMode">, EnumToJsonSimple<"IScatterContainerEntity.ECanvasClearMode">);
static ZHMTypeInfo ESpeechPriority_TypeInfo = ZHMTypeInfo("ESpeechPriority", EnumToJson<"ESpeechPriority">, EnumToJsonSimple<"ESpeechPriority">);
static ZHMTypeInfo EActorRole_TypeInfo = ZHMTypeInfo("EActorRole", EnumToJson<"EActorRole">, EnumToJsonSimple<"EActorRole">);
static ZHMTypeInfo ECCWeaponAnimSet_TypeInfo = ZHMTypeInfo("ECCWeaponAnimSet", EnumToJson<"ECCWeaponAnimSet">, EnumToJsonSimple<"ECCWeaponAnimSet">);
static ZHMTypeInfo ECompiledBehaviorType_TypeInfo = ZHMTypeInfo("ECompiledBehaviorType", EnumToJson<"ECompiledBehaviorType">, EnumToJsonSimple<"ECompiledBehaviorType">);
static ZHMTypeInfo ZWaveformGeneratorEntity_ECurveType_TypeInfo = ZHMTypeInfo("ZWaveformGeneratorEntity.ECurveType", EnumToJson<"ZWaveformGeneratorEntity.ECurveType">, EnumToJsonSimple<"ZWaveformGeneratorEntity.ECurveType">);
static ZHMTypeInfo EItemHUDType_TypeInfo = ZHMTypeInfo("EItemHUDType", EnumToJson<"EItemHUDType">, EnumToJsonSimple<"EItemHUDType">);
static ZHMTypeInfo ZDetectedInPrivateGroup_EInvestigateGroupState_TypeInfo = ZHMTypeInfo("ZDetectedInPrivateGroup.EInvestigateGroupState", EnumToJson<"ZDetectedInPrivateGroup.EInvestigateGroupState">, EnumToJsonSimple<"ZDetectedInPrivateGroup.EInvestigateGroupState">);
static ZHMTypeInfo ZActorPickerFilterKeyword_EEvaluationType_TypeInfo = ZHMTypeInfo("ZActorPickerFilterKeyword.EEvaluationType", EnumToJson<"ZActorPickerFilterKeyword.EEvaluationType">, EnumToJsonSimple<"ZActorPickerFilterKeyword.EEvaluationType">);
static ZHMTypeInfo ZConditionListEntity_EEvaluationType_TypeInfo = ZHMTypeInfo("ZConditionListEntity.EEvaluationType", EnumToJson<"ZConditionListEntity.EEvaluationType">, EnumToJsonSimple<"ZConditionListEntity.EEvaluationType">);
static ZHMTypeInfo ENetworkSystemID_TypeInfo = ZHMTypeInfo("ENetworkSystemID", EnumToJson<"ENetworkSystemID">, EnumToJsonSimple<"ENetworkSystemID">);
static ZHMTypeInfo ZHM5FaceFXReactionEventConsumer_EEvent_TypeInfo = ZHMTypeInfo("ZHM5FaceFXReactionEventConsumer.EEvent", EnumToJson<"ZHM5FaceFXReactionEventConsumer.EEvent">, EnumToJsonSimple<"ZHM5FaceFXReactionEventConsumer.EEvent">);
static ZHMTypeInfo ZDebugSpatialEntity_EDrawLayer_TypeInfo = ZHMTypeInfo("ZDebugSpatialEntity.EDrawLayer", EnumToJson<"ZDebugSpatialEntity.EDrawLayer">, EnumToJsonSimple<"ZDebugSpatialEntity.EDrawLayer">);
static ZHMTypeInfo EIntelTensionLevel_TypeInfo = ZHMTypeInfo("EIntelTensionLevel", EnumToJson<"EIntelTensionLevel">, EnumToJsonSimple<"EIntelTensionLevel">);
static ZHMTypeInfo CrowdUtil_ECrowdSide_TypeInfo = ZHMTypeInfo("CrowdUtil.ECrowdSide", EnumToJson<"CrowdUtil.ECrowdSide">, EnumToJsonSimple<"CrowdUtil.ECrowdSide">);
static ZHMTypeInfo ESentryActionPrompt_TypeInfo = ZHMTypeInfo("ESentryActionPrompt", EnumToJson<"ESentryActionPrompt">, EnumToJsonSimple<"ESentryActionPrompt">);
static ZHMTypeInfo EInventoryConfigCustomRule_TypeInfo = ZHMTypeInfo("EInventoryConfigCustomRule", EnumToJson<"EInventoryConfigCustomRule">, EnumToJsonSimple<"EInventoryConfigCustomRule">);
static ZHMTypeInfo ZItemSpawner_EPhysicsMode_TypeInfo = ZHMTypeInfo("ZItemSpawner.EPhysicsMode", EnumToJson<"ZItemSpawner.EPhysicsMode">, EnumToJsonSimple<"ZItemSpawner.EPhysicsMode">);
static ZHMTypeInfo ICameraEntity_EProjectionType_TypeInfo = ZHMTypeInfo("ICameraEntity.EProjectionType", EnumToJson<"ICameraEntity.EProjectionType">, EnumToJsonSimple<"ICameraEntity.EProjectionType">);
static ZHMTypeInfo EBIEventTypes_TypeInfo = ZHMTypeInfo("EBIEventTypes", EnumToJson<"EBIEventTypes">, EnumToJsonSimple<"EBIEventTypes">);
static ZHMTypeInfo EInteractionInputType_TypeInfo = ZHMTypeInfo("EInteractionInputType", EnumToJson<"EInteractionInputType">, EnumToJsonSimple<"EInteractionInputType">);
static ZHMTypeInfo ZDeadBodySituation_ESituationFlavor_TypeInfo = ZHMTypeInfo("ZDeadBodySituation.ESituationFlavor", EnumToJson<"ZDeadBodySituation.ESituationFlavor">, EnumToJsonSimple<"ZDeadBodySituation.ESituationFlavor">);
static ZHMTypeInfo ZSetVisibleEntity_StartBehavior_TypeInfo = ZHMTypeInfo("ZSetVisibleEntity.StartBehavior", EnumToJson<"ZSetVisibleEntity.StartBehavior">, EnumToJsonSimple<"ZSetVisibleEntity.StartBehavior">);
static ZHMTypeInfo ZBoxReflectionEntity_EBoundsType_TypeInfo = ZHMTypeInfo("ZBoxReflectionEntity.EBoundsType", EnumToJson<"ZBoxReflectionEntity.EBoundsType">, EnumToJsonSimple<"ZBoxReflectionEntity.EBoundsType">);
static ZHMTypeInfo ERatingTitleRequirement_TypeInfo = ZHMTypeInfo("ERatingTitleRequirement", EnumToJson<"ERatingTitleRequirement">, EnumToJsonSimple<"ERatingTitleRequirement">);
static ZHMTypeInfo EVRIKElement_TypeInfo = ZHMTypeInfo("EVRIKElement", EnumToJson<"EVRIKElement">, EnumToJsonSimple<"EVRIKElement">);
static ZHMTypeInfo STestStruct_ETestEnum_TypeInfo = ZHMTypeInfo("STestStruct.ETestEnum", EnumToJson<"STestStruct.ETestEnum">, EnumToJsonSimple<"STestStruct.ETestEnum">);
static ZHMTypeInfo ZHM5BodySoundEventConsumer_EAnimSoundBody_TypeInfo = ZHMTypeInfo("ZHM5BodySoundEventConsumer.EAnimSoundBody", EnumToJson<"ZHM5BodySoundEventConsumer.EAnimSoundBody">, EnumToJsonSimple<"ZHM5BodySoundEventConsumer.EAnimSoundBody">);
static ZHMTypeInfo ECCNodeSubtype_TypeInfo = ZHMTypeInfo("ECCNodeSubtype", EnumToJson<"ECCNodeSubtype">, EnumToJsonSimple<"ECCNodeSubtype">);
static ZHMTypeInfo ZPIPMessageEntity_EIcon_TypeInfo = ZHMTypeInfo("ZPIPMessageEntity.EIcon", EnumToJson<"ZPIPMessageEntity.EIcon">, EnumToJsonSimple<"ZPIPMessageEntity.EIcon">);
static ZHMTypeInfo EWaypointRotationAlignment_TypeInfo = ZHMTypeInfo("EWaypointRotationAlignment", EnumToJson<"EWaypointRotationAlignment">, EnumToJsonSimple<"EWaypointRotationAlignment">);
static ZHMTypeInfo EHintMessageSoundType_TypeInfo = ZHMTypeInfo("EHintMessageSoundType", EnumToJson<"EHintMessageSoundType">, EnumToJsonSimple<"EHintMessageSoundType">);
static ZHMTypeInfo EAsyncRaycastsGroup_TypeInfo = ZHMTypeInfo("EAsyncRaycastsGroup", EnumToJson<"EAsyncRaycastsGroup">, EnumToJsonSimple<"EAsyncRaycastsGroup">);
static ZHMTypeInfo EKnownEntityType_TypeInfo = ZHMTypeInfo("EKnownEntityType", EnumToJson<"EKnownEntityType">, EnumToJsonSimple<"EKnownEntityType">);
static ZHMTypeInfo ZActorAccessoryItemCondition_EConditionTypes_TypeInfo = ZHMTypeInfo("ZActorAccessoryItemCondition.EConditionTypes", EnumToJson<"ZActorAccessoryItemCondition.EConditionTypes">, EnumToJsonSimple<"ZActorAccessoryItemCondition.EConditionTypes">);
static ZHMTypeInfo ZHM5DynamicRayCastEntity_ECollideType_TypeInfo = ZHMTypeInfo("ZHM5DynamicRayCastEntity.ECollideType", EnumToJson<"ZHM5DynamicRayCastEntity.ECollideType">, EnumToJsonSimple<"ZHM5DynamicRayCastEntity.ECollideType">);
static ZHMTypeInfo ZCausalNodeEntity_ECauseEvaluationType_TypeInfo = ZHMTypeInfo("ZCausalNodeEntity.ECauseEvaluationType", EnumToJson<"ZCausalNodeEntity.ECauseEvaluationType">, EnumToJsonSimple<"ZCausalNodeEntity.ECauseEvaluationType">);
static ZHMTypeInfo ESoundGateFlags_TypeInfo = ZHMTypeInfo("ESoundGateFlags", EnumToJson<"ESoundGateFlags">, EnumToJsonSimple<"ESoundGateFlags">);
static ZHMTypeInfo CrowdUtil_EGenderReq_TypeInfo = ZHMTypeInfo("CrowdUtil.EGenderReq", EnumToJson<"CrowdUtil.EGenderReq">, EnumToJsonSimple<"CrowdUtil.EGenderReq">);
static ZHMTypeInfo EInteractionIndicatorState_TypeInfo = ZHMTypeInfo("EInteractionIndicatorState", EnumToJson<"EInteractionIndicatorState">, EnumToJsonSimple<"EInteractionIndicatorState">);
static ZHMTypeInfo EActorLookAtPriority_TypeInfo = ZHMTypeInfo("EActorLookAtPriority", EnumToJson<"EActorLookAtPriority">, EnumToJsonSimple<"EActorLookAtPriority">);
static ZHMTypeInfo ZCameraPlaneTriggerEntity_EAlignment_TypeInfo = ZHMTypeInfo("ZCameraPlaneTriggerEntity.EAlignment", EnumToJson<"ZCameraPlaneTriggerEntity.EAlignment">, EnumToJsonSimple<"ZCameraPlaneTriggerEntity.EAlignment">);
static ZHMTypeInfo ECharacterAnimEventState_TypeInfo = ZHMTypeInfo("ECharacterAnimEventState", EnumToJson<"ECharacterAnimEventState">, EnumToJsonSimple<"ECharacterAnimEventState">);
static ZHMTypeInfo ZFriskSuspectGroup_EHitmanGreetState_TypeInfo = ZHMTypeInfo("ZFriskSuspectGroup.EHitmanGreetState", EnumToJson<"ZFriskSuspectGroup.EHitmanGreetState">, EnumToJsonSimple<"ZFriskSuspectGroup.EHitmanGreetState">);
static ZHMTypeInfo SDoorSoundDefs_EDefinition_TypeInfo = ZHMTypeInfo("SDoorSoundDefs.EDefinition", EnumToJson<"SDoorSoundDefs.EDefinition">, EnumToJsonSimple<"SDoorSoundDefs.EDefinition">);
static ZHMTypeInfo ZActorPickerEffectDrama_EEffectPhaseAction_TypeInfo = ZHMTypeInfo("ZActorPickerEffectDrama.EEffectPhaseAction", EnumToJson<"ZActorPickerEffectDrama.EEffectPhaseAction">, EnumToJsonSimple<"ZActorPickerEffectDrama.EEffectPhaseAction">);
static ZHMTypeInfo ZAudioSequenceTrack_EPlaybackTarget_TypeInfo = ZHMTypeInfo("ZAudioSequenceTrack.EPlaybackTarget", EnumToJson<"ZAudioSequenceTrack.EPlaybackTarget">, EnumToJsonSimple<"ZAudioSequenceTrack.EPlaybackTarget">);
static ZHMTypeInfo EItemModifierType_TypeInfo = ZHMTypeInfo("EItemModifierType", EnumToJson<"EItemModifierType">, EnumToJsonSimple<"EItemModifierType">);
static ZHMTypeInfo EAISituation_TypeInfo = ZHMTypeInfo("EAISituation", EnumToJson<"EAISituation">, EnumToJsonSimple<"EAISituation">);
static ZHMTypeInfo EScreenPlayState_TypeInfo = ZHMTypeInfo("EScreenPlayState", EnumToJson<"EScreenPlayState">, EnumToJsonSimple<"EScreenPlayState">);
static ZHMTypeInfo EDramaSituationDescriptors_TypeInfo = ZHMTypeInfo("EDramaSituationDescriptors", EnumToJson<"EDramaSituationDescriptors">, EnumToJsonSimple<"EDramaSituationDescriptors">);
static ZHMTypeInfo ERagdollPart_TypeInfo = ZHMTypeInfo("ERagdollPart", EnumToJson<"ERagdollPart">, EnumToJsonSimple<"ERagdollPart">);
static ZHMTypeInfo EOpportunityState_TypeInfo = ZHMTypeInfo("EOpportunityState", EnumToJson<"EOpportunityState">, EnumToJsonSimple<"EOpportunityState">);
static ZHMTypeInfo EOrderCompletionStatus_TypeInfo = ZHMTypeInfo("EOrderCompletionStatus", EnumToJson<"EOrderCompletionStatus">, EnumToJsonSimple<"EOrderCompletionStatus">);
static ZHMTypeInfo ZHM5ContextActionEntity_EInteraction_TypeInfo = ZHMTypeInfo("ZHM5ContextActionEntity.EInteraction", EnumToJson<"ZHM5ContextActionEntity.EInteraction">, EnumToJsonSimple<"ZHM5ContextActionEntity.EInteraction">);
static ZHMTypeInfo EOutbreakInfectionStage_TypeInfo = ZHMTypeInfo("EOutbreakInfectionStage", EnumToJson<"EOutbreakInfectionStage">, EnumToJsonSimple<"EOutbreakInfectionStage">);
static ZHMTypeInfo eActionRewardType_TypeInfo = ZHMTypeInfo("eActionRewardType", EnumToJson<"eActionRewardType">, EnumToJsonSimple<"eActionRewardType">);
static ZHMTypeInfo ZAT2Controller_EFootstepsMovementType_TypeInfo = ZHMTypeInfo("ZAT2Controller.EFootstepsMovementType", EnumToJson<"ZAT2Controller.EFootstepsMovementType">, EnumToJsonSimple<"ZAT2Controller.EFootstepsMovementType">);
static ZHMTypeInfo ZMoveToPositionBehaviorEntity_EMovementType_TypeInfo = ZHMTypeInfo("ZMoveToPositionBehaviorEntity.EMovementType", EnumToJson<"ZMoveToPositionBehaviorEntity.EMovementType">, EnumToJsonSimple<"ZMoveToPositionBehaviorEntity.EMovementType">);
static ZHMTypeInfo ZHM5ForceCover_EFaceDirection_TypeInfo = ZHMTypeInfo("ZHM5ForceCover.EFaceDirection", EnumToJson<"ZHM5ForceCover.EFaceDirection">, EnumToJsonSimple<"ZHM5ForceCover.EFaceDirection">);
static ZHMTypeInfo AudioCurve_TypeInfo = ZHMTypeInfo("AudioCurve", EnumToJson<"AudioCurve">, EnumToJsonSimple<"AudioCurve">);
static ZHMTypeInfo EActivationPriority_TypeInfo = ZHMTypeInfo("EActivationPriority", EnumToJson<"EActivationPriority">, EnumToJsonSimple<"EActivationPriority">);
static ZHMTypeInfo ZMenuSliderNavigationEntity_ESliderInputMode_TypeInfo = ZHMTypeInfo("ZMenuSliderNavigationEntity.ESliderInputMode", EnumToJson<"ZMenuSliderNavigationEntity.ESliderInputMode">, EnumToJsonSimple<"ZMenuSliderNavigationEntity.ESliderInputMode">);
static ZHMTypeInfo ZActDurationCondition_EState_TypeInfo = ZHMTypeInfo("ZActDurationCondition.EState", EnumToJson<"ZActDurationCondition.EState">, EnumToJsonSimple<"ZActDurationCondition.EState">);
static ZHMTypeInfo ETextAlignment_TypeInfo = ZHMTypeInfo("ETextAlignment", EnumToJson<"ETextAlignment">, EnumToJsonSimple<"ETextAlignment">);
static ZHMTypeInfo eItemSize_TypeInfo = ZHMTypeInfo("eItemSize", EnumToJson<"eItemSize">, EnumToJsonSimple<"eItemSize">);
static ZHMTypeInfo ZEscortSituation2Entity_EEscortState_TypeInfo = ZHMTypeInfo("ZEscortSituation2Entity.EEscortState", EnumToJson<"ZEscortSituation2Entity.EEscortState">, EnumToJsonSimple<"ZEscortSituation2Entity.EEscortState">);
static ZHMTypeInfo ZLeadEscortSituationEntity_ETargetState_TypeInfo = ZHMTypeInfo("ZLeadEscortSituationEntity.ETargetState", EnumToJson<"ZLeadEscortSituationEntity.ETargetState">, EnumToJsonSimple<"ZLeadEscortSituationEntity.ETargetState">);
static ZHMTypeInfo ECharacterSubcontrollerType_TypeInfo = ZHMTypeInfo("ECharacterSubcontrollerType", EnumToJson<"ECharacterSubcontrollerType">, EnumToJsonSimple<"ECharacterSubcontrollerType">);
static ZHMTypeInfo ECrowdFlowCandidates_TypeInfo = ZHMTypeInfo("ECrowdFlowCandidates", EnumToJson<"ECrowdFlowCandidates">, EnumToJsonSimple<"ECrowdFlowCandidates">);
static ZHMTypeInfo EThrownCollisionSoundLoudness_TypeInfo = ZHMTypeInfo("EThrownCollisionSoundLoudness", EnumToJson<"EThrownCollisionSoundLoudness">, EnumToJsonSimple<"EThrownCollisionSoundLoudness">);
static ZHMTypeInfo EUIBusyOperationId_TypeInfo = ZHMTypeInfo("EUIBusyOperationId", EnumToJson<"EUIBusyOperationId">, EnumToJsonSimple<"EUIBusyOperationId">);
static ZHMTypeInfo EAttachLocation_TypeInfo = ZHMTypeInfo("EAttachLocation", EnumToJson<"EAttachLocation">, EnumToJsonSimple<"EAttachLocation">);
static ZHMTypeInfo EEngineFrameUpdatePriority_TypeInfo = ZHMTypeInfo("EEngineFrameUpdatePriority", EnumToJson<"EEngineFrameUpdatePriority">, EnumToJsonSimple<"EEngineFrameUpdatePriority">);
static ZHMTypeInfo EInformationBarMessage_TypeInfo = ZHMTypeInfo("EInformationBarMessage", EnumToJson<"EInformationBarMessage">, EnumToJsonSimple<"EInformationBarMessage">);
static ZHMTypeInfo ESniperScoreMessageType_TypeInfo = ZHMTypeInfo("ESniperScoreMessageType", EnumToJson<"ESniperScoreMessageType">, EnumToJsonSimple<"ESniperScoreMessageType">);
static ZHMTypeInfo ZHttpUrl_EVerb_TypeInfo = ZHMTypeInfo("ZHttpUrl.EVerb", EnumToJson<"ZHttpUrl.EVerb">, EnumToJsonSimple<"ZHttpUrl.EVerb">);
static ZHMTypeInfo ESmoothingMode_TypeInfo = ZHMTypeInfo("ESmoothingMode", EnumToJson<"ESmoothingMode">, EnumToJsonSimple<"ESmoothingMode">);
static ZHMTypeInfo ZActorPickerEffectTemplate_EEffectPhaseAction_TypeInfo = ZHMTypeInfo("ZActorPickerEffectTemplate.EEffectPhaseAction", EnumToJson<"ZActorPickerEffectTemplate.EEffectPhaseAction">, EnumToJsonSimple<"ZActorPickerEffectTemplate.EEffectPhaseAction">);
static ZHMTypeInfo EActorAIDot_TypeInfo = ZHMTypeInfo("EActorAIDot", EnumToJson<"EActorAIDot">, EnumToJsonSimple<"EActorAIDot">);
static ZHMTypeInfo ZDecalControllerEntity_EScaleType_TypeInfo = ZHMTypeInfo("ZDecalControllerEntity.EScaleType", EnumToJson<"ZDecalControllerEntity.EScaleType">, EnumToJsonSimple<"ZDecalControllerEntity.EScaleType">);
static ZHMTypeInfo ZUIControlLayoutLegacyAspect_ELayoutMode_TypeInfo = ZHMTypeInfo("ZUIControlLayoutLegacyAspect.ELayoutMode", EnumToJson<"ZUIControlLayoutLegacyAspect.ELayoutMode">, EnumToJsonSimple<"ZUIControlLayoutLegacyAspect.ELayoutMode">);
static ZHMTypeInfo ZHM5WeaponBasicConfigEntity_EWeaponBasicConfigAudioClass_TypeInfo = ZHMTypeInfo("ZHM5WeaponBasicConfigEntity.EWeaponBasicConfigAudioClass", EnumToJson<"ZHM5WeaponBasicConfigEntity.EWeaponBasicConfigAudioClass">, EnumToJsonSimple<"ZHM5WeaponBasicConfigEntity.EWeaponBasicConfigAudioClass">);
static ZHMTypeInfo ZUIControlLayoutLegacyAspect_EAlignmentType_TypeInfo = ZHMTypeInfo("ZUIControlLayoutLegacyAspect.EAlignmentType", EnumToJson<"ZUIControlLayoutLegacyAspect.EAlignmentType">, EnumToJsonSimple<"ZUIControlLayoutLegacyAspect.EAlignmentType">);
static ZHMTypeInfo ZEscortSituationEntity_EEscortState_TypeInfo = ZHMTypeInfo("ZEscortSituationEntity.EEscortState", EnumToJson<"ZEscortSituationEntity.EEscortState">, EnumToJsonSimple<"ZEscortSituationEntity.EEscortState">);
static ZHMTypeInfo SniperControllerConditionType_TypeInfo = ZHMTypeInfo("SniperControllerConditionType", EnumToJson<"SniperControllerConditionType">, EnumToJsonSimple<"SniperControllerConditionType">);
static ZHMTypeInfo ZActorInstanceEntity_EFFXMode_TypeInfo = ZHMTypeInfo("ZActorInstanceEntity.EFFXMode", EnumToJson<"ZActorInstanceEntity.EFFXMode">, EnumToJsonSimple<"ZActorInstanceEntity.EFFXMode">);
static ZHMTypeInfo EMapType_TypeInfo = ZHMTypeInfo("EMapType", EnumToJson<"EMapType">, EnumToJsonSimple<"EMapType">);
static ZHMTypeInfo CrowdUtil_ECrowdFacing_TypeInfo = ZHMTypeInfo("CrowdUtil.ECrowdFacing", EnumToJson<"CrowdUtil.ECrowdFacing">, EnumToJsonSimple<"CrowdUtil.ECrowdFacing">);
static ZHMTypeInfo EActorEmotionState_TypeInfo = ZHMTypeInfo("EActorEmotionState", EnumToJson<"EActorEmotionState">, EnumToJsonSimple<"EActorEmotionState">);
static ZHMTypeInfo EKeywordSetBehavior_TypeInfo = ZHMTypeInfo("EKeywordSetBehavior", EnumToJson<"EKeywordSetBehavior">, EnumToJsonSimple<"EKeywordSetBehavior">);
static ZHMTypeInfo eItemRarity_TypeInfo = ZHMTypeInfo("eItemRarity", EnumToJson<"eItemRarity">, EnumToJsonSimple<"eItemRarity">);
static ZHMTypeInfo eHolsterAbility_TypeInfo = ZHMTypeInfo("eHolsterAbility", EnumToJson<"eHolsterAbility">, EnumToJsonSimple<"eHolsterAbility">);
static ZHMTypeInfo EMoveEndState_TypeInfo = ZHMTypeInfo("EMoveEndState", EnumToJson<"EMoveEndState">, EnumToJsonSimple<"EMoveEndState">);
static ZHMTypeInfo EPlaceableType_TypeInfo = ZHMTypeInfo("EPlaceableType", EnumToJson<"EPlaceableType">, EnumToJsonSimple<"EPlaceableType">);
static ZHMTypeInfo ELastSoundTension_TypeInfo = ZHMTypeInfo("ELastSoundTension", EnumToJson<"ELastSoundTension">, EnumToJsonSimple<"ELastSoundTension">);
static ZHMTypeInfo ZSequenceEntity_ELetterBoxAspect_TypeInfo = ZHMTypeInfo("ZSequenceEntity.ELetterBoxAspect", EnumToJson<"ZSequenceEntity.ELetterBoxAspect">, EnumToJsonSimple<"ZSequenceEntity.ELetterBoxAspect">);
static ZHMTypeInfo ZHM5HIKEventConsumer_EEffector_TypeInfo = ZHMTypeInfo("ZHM5HIKEventConsumer.EEffector", EnumToJson<"ZHM5HIKEventConsumer.EEffector">, EnumToJsonSimple<"ZHM5HIKEventConsumer.EEffector">);
static ZHMTypeInfo ZWaypointEntity_EMovementType_TypeInfo = ZHMTypeInfo("ZWaypointEntity.EMovementType", EnumToJson<"ZWaypointEntity.EMovementType">, EnumToJsonSimple<"ZWaypointEntity.EMovementType">);
static ZHMTypeInfo EInventoryStorageType_TypeInfo = ZHMTypeInfo("EInventoryStorageType", EnumToJson<"EInventoryStorageType">, EnumToJsonSimple<"EInventoryStorageType">);
static ZHMTypeInfo EDialogEventEndReason_TypeInfo = ZHMTypeInfo("EDialogEventEndReason", EnumToJson<"EDialogEventEndReason">, EnumToJsonSimple<"EDialogEventEndReason">);
static ZHMTypeInfo EDefaultCollidableLayer_TypeInfo = ZHMTypeInfo("EDefaultCollidableLayer", EnumToJson<"EDefaultCollidableLayer">, EnumToJsonSimple<"EDefaultCollidableLayer">);
static ZHMTypeInfo eItemHands_TypeInfo = ZHMTypeInfo("eItemHands", EnumToJson<"eItemHands">, EnumToJsonSimple<"eItemHands">);
static ZHMTypeInfo ZActorProviderFilterKeyword_EEvaluationType_TypeInfo = ZHMTypeInfo("ZActorProviderFilterKeyword.EEvaluationType", EnumToJson<"ZActorProviderFilterKeyword.EEvaluationType">, EnumToJsonSimple<"ZActorProviderFilterKeyword.EEvaluationType">);
static ZHMTypeInfo ZHUDUIRoot_EHUDVisibility_TypeInfo = ZHMTypeInfo("ZHUDUIRoot.EHUDVisibility", EnumToJson<"ZHUDUIRoot.EHUDVisibility">, EnumToJsonSimple<"ZHUDUIRoot.EHUDVisibility">);
static ZHMTypeInfo EKillType_TypeInfo = ZHMTypeInfo("EKillType", EnumToJson<"EKillType">, EnumToJsonSimple<"EKillType">);
static ZHMTypeInfo EHUDIconType_TypeInfo = ZHMTypeInfo("EHUDIconType", EnumToJson<"EHUDIconType">, EnumToJsonSimple<"EHUDIconType">);
static ZHMTypeInfo ECharacterActionSyncRequests_TypeInfo = ZHMTypeInfo("ECharacterActionSyncRequests", EnumToJson<"ECharacterActionSyncRequests">, EnumToJsonSimple<"ECharacterActionSyncRequests">);
static ZHMTypeInfo ZInvestigateCautiousSituation_ESituationState_TypeInfo = ZHMTypeInfo("ZInvestigateCautiousSituation.ESituationState", EnumToJson<"ZInvestigateCautiousSituation.ESituationState">, EnumToJsonSimple<"ZInvestigateCautiousSituation.ESituationState">);
static ZHMTypeInfo EActBodyType_TypeInfo = ZHMTypeInfo("EActBodyType", EnumToJson<"EActBodyType">, EnumToJsonSimple<"EActBodyType">);
static ZHMTypeInfo ZHUDOccluderTriggerEntity_EOccluderTestBit_TypeInfo = ZHMTypeInfo("ZHUDOccluderTriggerEntity.EOccluderTestBit", EnumToJson<"ZHUDOccluderTriggerEntity.EOccluderTestBit">, EnumToJsonSimple<"ZHUDOccluderTriggerEntity.EOccluderTestBit">);
static ZHMTypeInfo EOpportunityRevealState_TypeInfo = ZHMTypeInfo("EOpportunityRevealState", EnumToJson<"EOpportunityRevealState">, EnumToJsonSimple<"EOpportunityRevealState">);
static ZHMTypeInfo EGSBodyPart_TypeInfo = ZHMTypeInfo("EGSBodyPart", EnumToJson<"EGSBodyPart">, EnumToJsonSimple<"EGSBodyPart">);
static ZHMTypeInfo EActorSecondaryIconState_TypeInfo = ZHMTypeInfo("EActorSecondaryIconState", EnumToJson<"EActorSecondaryIconState">, EnumToJsonSimple<"EActorSecondaryIconState">);
static ZHMTypeInfo ZInputListenerAxisEntity_eInputListenerAxes_TypeInfo = ZHMTypeInfo("ZInputListenerAxisEntity.eInputListenerAxes", EnumToJson<"ZInputListenerAxisEntity.eInputListenerAxes">, EnumToJsonSimple<"ZInputListenerAxisEntity.eInputListenerAxes">);
static ZHMTypeInfo EActorEventTypes_TypeInfo = ZHMTypeInfo("EActorEventTypes", EnumToJson<"EActorEventTypes">, EnumToJsonSimple<"EActorEventTypes">);
static ZHMTypeInfo EVRConfigCustomEvent_TypeInfo = ZHMTypeInfo("EVRConfigCustomEvent", EnumToJson<"EVRConfigCustomEvent">, EnumToJsonSimple<"EVRConfigCustomEvent">);
static ZHMTypeInfo EMultiplayerNetworkState_TypeInfo = ZHMTypeInfo("EMultiplayerNetworkState", EnumToJson<"EMultiplayerNetworkState">, EnumToJsonSimple<"EMultiplayerNetworkState">);
static ZHMTypeInfo EBoolCheckType_TypeInfo = ZHMTypeInfo("EBoolCheckType", EnumToJson<"EBoolCheckType">, EnumToJsonSimple<"EBoolCheckType">);
static ZHMTypeInfo EActorFaction_TypeInfo = ZHMTypeInfo("EActorFaction", EnumToJson<"EActorFaction">, EnumToJsonSimple<"EActorFaction">);
static ZHMTypeInfo SoundPlayState_TypeInfo = ZHMTypeInfo("SoundPlayState", EnumToJson<"SoundPlayState">, EnumToJsonSimple<"SoundPlayState">);
static ZHMTypeInfo ECausalGraphTraversal_TypeInfo = ZHMTypeInfo("ECausalGraphTraversal", EnumToJson<"ECausalGraphTraversal">, EnumToJsonSimple<"ECausalGraphTraversal">);
static ZHMTypeInfo EPushNotificationType_TypeInfo = ZHMTypeInfo("EPushNotificationType", EnumToJson<"EPushNotificationType">, EnumToJsonSimple<"EPushNotificationType">);
static ZHMTypeInfo ZCharacterSpeakCondition_EState_TypeInfo = ZHMTypeInfo("ZCharacterSpeakCondition.EState", EnumToJson<"ZCharacterSpeakCondition.EState">, EnumToJsonSimple<"ZCharacterSpeakCondition.EState">);
static ZHMTypeInfo EVRRenderDeviceType_TypeInfo = ZHMTypeInfo("EVRRenderDeviceType", EnumToJson<"EVRRenderDeviceType">, EnumToJsonSimple<"EVRRenderDeviceType">);
static ZHMTypeInfo IHM5Door_EOpenDir_TypeInfo = ZHMTypeInfo("IHM5Door.EOpenDir", EnumToJson<"IHM5Door.EOpenDir">, EnumToJsonSimple<"IHM5Door.EOpenDir">);
static ZHMTypeInfo EDamageResponse_TypeInfo = ZHMTypeInfo("EDamageResponse", EnumToJson<"EDamageResponse">, EnumToJsonSimple<"EDamageResponse">);
static ZHMTypeInfo EInventoryConfigFormerEquippedItems_TypeInfo = ZHMTypeInfo("EInventoryConfigFormerEquippedItems", EnumToJson<"EInventoryConfigFormerEquippedItems">, EnumToJsonSimple<"EInventoryConfigFormerEquippedItems">);
static ZHMTypeInfo ESituationJoinReason_TypeInfo = ZHMTypeInfo("ESituationJoinReason", EnumToJson<"ESituationJoinReason">, EnumToJsonSimple<"ESituationJoinReason">);
static ZHMTypeInfo UIMapLayer_EUIMapLayerID_TypeInfo = ZHMTypeInfo("UIMapLayer.EUIMapLayerID", EnumToJson<"UIMapLayer.EUIMapLayerID">, EnumToJsonSimple<"UIMapLayer.EUIMapLayerID">);
static ZHMTypeInfo EScreenplayStateFlag_TypeInfo = ZHMTypeInfo("EScreenplayStateFlag", EnumToJson<"EScreenplayStateFlag">, EnumToJsonSimple<"EScreenplayStateFlag">);
static ZHMTypeInfo ENetPlayerEvent_TypeInfo = ZHMTypeInfo("ENetPlayerEvent", EnumToJson<"ENetPlayerEvent">, EnumToJsonSimple<"ENetPlayerEvent">);
static ZHMTypeInfo ZCoverPlane_ECoverType_TypeInfo = ZHMTypeInfo("ZCoverPlane.ECoverType", EnumToJson<"ZCoverPlane.ECoverType">, EnumToJsonSimple<"ZCoverPlane.ECoverType">);
static ZHMTypeInfo ECameraOffset_old_TypeInfo = ZHMTypeInfo("ECameraOffset_old", EnumToJson<"ECameraOffset_old">, EnumToJsonSimple<"ECameraOffset_old">);
static ZHMTypeInfo EVRConfigCapsuleGridSize_TypeInfo = ZHMTypeInfo("EVRConfigCapsuleGridSize", EnumToJson<"EVRConfigCapsuleGridSize">, EnumToJsonSimple<"EVRConfigCapsuleGridSize">);
static ZHMTypeInfo ECompiledConditionType_TypeInfo = ZHMTypeInfo("ECompiledConditionType", EnumToJson<"ECompiledConditionType">, EnumToJsonSimple<"ECompiledConditionType">);
static ZHMTypeInfo EItemGripType_TypeInfo = ZHMTypeInfo("EItemGripType", EnumToJson<"EItemGripType">, EnumToJsonSimple<"EItemGripType">);
static ZHMTypeInfo EUIBusyState_TypeInfo = ZHMTypeInfo("EUIBusyState", EnumToJson<"EUIBusyState">, EnumToJsonSimple<"EUIBusyState">);
static ZHMTypeInfo EBulletType_TypeInfo = ZHMTypeInfo("EBulletType", EnumToJson<"EBulletType">, EnumToJsonSimple<"EBulletType">);
static ZHMTypeInfo EPathFinderBoxType_TypeInfo = ZHMTypeInfo("EPathFinderBoxType", EnumToJson<"EPathFinderBoxType">, EnumToJsonSimple<"EPathFinderBoxType">);
static ZHMTypeInfo ZVRHUDWristAlignmentController_EAxis_TypeInfo = ZHMTypeInfo("ZVRHUDWristAlignmentController.EAxis", EnumToJson<"ZVRHUDWristAlignmentController.EAxis">, EnumToJsonSimple<"ZVRHUDWristAlignmentController.EAxis">);
static ZHMTypeInfo EMotionType_TypeInfo = ZHMTypeInfo("EMotionType", EnumToJson<"EMotionType">, EnumToJsonSimple<"EMotionType">);
static ZHMTypeInfo ECharacterStateTags_TypeInfo = ZHMTypeInfo("ECharacterStateTags", EnumToJson<"ECharacterStateTags">, EnumToJsonSimple<"ECharacterStateTags">);
static ZHMTypeInfo ECCDUsage_TypeInfo = ZHMTypeInfo("ECCDUsage", EnumToJson<"ECCDUsage">, EnumToJsonSimple<"ECCDUsage">);
static ZHMTypeInfo ZUIControlEntity_EAlignment_TypeInfo = ZHMTypeInfo("ZUIControlEntity.EAlignment", EnumToJson<"ZUIControlEntity.EAlignment">, EnumToJsonSimple<"ZUIControlEntity.EAlignment">);
static ZHMTypeInfo EAmmoBehaviourConfigType_TypeInfo = ZHMTypeInfo("EAmmoBehaviourConfigType", EnumToJson<"EAmmoBehaviourConfigType">, EnumToJsonSimple<"EAmmoBehaviourConfigType">);
static ZHMTypeInfo ZHM5BodyContainer_eBCCloseMode_TypeInfo = ZHMTypeInfo("ZHM5BodyContainer.eBCCloseMode", EnumToJson<"ZHM5BodyContainer.eBCCloseMode">, EnumToJsonSimple<"ZHM5BodyContainer.eBCCloseMode">);
static ZHMTypeInfo EFSMStateStatus_TypeInfo = ZHMTypeInfo("EFSMStateStatus", EnumToJson<"EFSMStateStatus">, EnumToJsonSimple<"EFSMStateStatus">);
static ZHMTypeInfo EHM5SoundFootstepEvent_TypeInfo = ZHMTypeInfo("EHM5SoundFootstepEvent", EnumToJson<"EHM5SoundFootstepEvent">, EnumToJsonSimple<"EHM5SoundFootstepEvent">);
static ZHMTypeInfo ZHM5ValueEntity_bool_EForwardRule_TypeInfo = ZHMTypeInfo("ZHM5ValueEntity_bool.EForwardRule", EnumToJson<"ZHM5ValueEntity_bool.EForwardRule">, EnumToJsonSimple<"ZHM5ValueEntity_bool.EForwardRule">);
static ZHMTypeInfo Network_PacketReliability_TypeInfo = ZHMTypeInfo("Network.PacketReliability", EnumToJson<"Network.PacketReliability">, EnumToJsonSimple<"Network.PacketReliability">);
static ZHMTypeInfo IContractObjective_State_TypeInfo = ZHMTypeInfo("IContractObjective.State", EnumToJson<"IContractObjective.State">, EnumToJsonSimple<"IContractObjective.State">);
static ZHMTypeInfo ZActorDebugEntity_EActorDebugColor_TypeInfo = ZHMTypeInfo("ZActorDebugEntity.EActorDebugColor", EnumToJson<"ZActorDebugEntity.EActorDebugColor">, EnumToJsonSimple<"ZActorDebugEntity.EActorDebugColor">);
static ZHMTypeInfo ERenderVRTrackingID_TypeInfo = ZHMTypeInfo("ERenderVRTrackingID", EnumToJson<"ERenderVRTrackingID">, EnumToJsonSimple<"ERenderVRTrackingID">);
static ZHMTypeInfo EMoveSpeed_TypeInfo = ZHMTypeInfo("EMoveSpeed", EnumToJson<"EMoveSpeed">, EnumToJsonSimple<"EMoveSpeed">);
static ZHMTypeInfo EDeathContext_TypeInfo = ZHMTypeInfo("EDeathContext", EnumToJson<"EDeathContext">, EnumToJsonSimple<"EDeathContext">);
static ZHMTypeInfo ECoordinateSpace_TypeInfo = ZHMTypeInfo("ECoordinateSpace", EnumToJson<"ECoordinateSpace">, EnumToJsonSimple<"ECoordinateSpace">);
static ZHMTypeInfo ECameraAssistanceMode_TypeInfo = ZHMTypeInfo("ECameraAssistanceMode", EnumToJson<"ECameraAssistanceMode">, EnumToJsonSimple<"ECameraAssistanceMode">);
static ZHMTypeInfo ZUIListNavigationEntity_ENavigationInputMode_TypeInfo = ZHMTypeInfo("ZUIListNavigationEntity.ENavigationInputMode", EnumToJson<"ZUIListNavigationEntity.ENavigationInputMode">, EnumToJsonSimple<"ZUIListNavigationEntity.ENavigationInputMode">);
static ZHMTypeInfo EExtendedPropertyType_TypeInfo = ZHMTypeInfo("EExtendedPropertyType", EnumToJson<"EExtendedPropertyType">, EnumToJsonSimple<"EExtendedPropertyType">);
static ZHMTypeInfo ERegistrationState_TypeInfo = ZHMTypeInfo("ERegistrationState", EnumToJson<"ERegistrationState">, EnumToJsonSimple<"ERegistrationState">);
static ZHMTypeInfo EDisconnectReason_TypeInfo = ZHMTypeInfo("EDisconnectReason", EnumToJson<"EDisconnectReason">, EnumToJsonSimple<"EDisconnectReason">);
static ZHMTypeInfo EIntelStage_TypeInfo = ZHMTypeInfo("EIntelStage", EnumToJson<"EIntelStage">, EnumToJsonSimple<"EIntelStage">);
static ZHMTypeInfo EActorVoiceVariation_TypeInfo = ZHMTypeInfo("EActorVoiceVariation", EnumToJson<"EActorVoiceVariation">, EnumToJsonSimple<"EActorVoiceVariation">);
static ZHMTypeInfo ECharacterAnimChildNetworkSlot_TypeInfo = ZHMTypeInfo("ECharacterAnimChildNetworkSlot", EnumToJson<"ECharacterAnimChildNetworkSlot">, EnumToJsonSimple<"ECharacterAnimChildNetworkSlot">);
static ZHMTypeInfo EStealthSituation_TypeInfo = ZHMTypeInfo("EStealthSituation", EnumToJson<"EStealthSituation">, EnumToJsonSimple<"EStealthSituation">);
static ZHMTypeInfo ZHeroKeywordCondition_EEvaluationType_TypeInfo = ZHMTypeInfo("ZHeroKeywordCondition.EEvaluationType", EnumToJson<"ZHeroKeywordCondition.EEvaluationType">, EnumToJsonSimple<"ZHeroKeywordCondition.EEvaluationType">);
static ZHMTypeInfo EAudioVolumetricMixingMode_TypeInfo = ZHMTypeInfo("EAudioVolumetricMixingMode", EnumToJson<"EAudioVolumetricMixingMode">, EnumToJsonSimple<"EAudioVolumetricMixingMode">);
static ZHMTypeInfo ZActorBoneAttachEntity_EResetMode_TypeInfo = ZHMTypeInfo("ZActorBoneAttachEntity.EResetMode", EnumToJson<"ZActorBoneAttachEntity.EResetMode">, EnumToJsonSimple<"ZActorBoneAttachEntity.EResetMode">);
static ZHMTypeInfo IHM5Door_ECPDoorLockType_TypeInfo = ZHMTypeInfo("IHM5Door.ECPDoorLockType", EnumToJson<"IHM5Door.ECPDoorLockType">, EnumToJsonSimple<"IHM5Door.ECPDoorLockType">);
static ZHMTypeInfo EActorRank_TypeInfo = ZHMTypeInfo("EActorRank", EnumToJson<"EActorRank">, EnumToJsonSimple<"EActorRank">);
static ZHMTypeInfo EPersistentBoolDataSyncType_TypeInfo = ZHMTypeInfo("EPersistentBoolDataSyncType", EnumToJson<"EPersistentBoolDataSyncType">, EnumToJsonSimple<"EPersistentBoolDataSyncType">);
static ZHMTypeInfo ESaveLoadStatus_TypeInfo = ZHMTypeInfo("ESaveLoadStatus", EnumToJson<"ESaveLoadStatus">, EnumToJsonSimple<"ESaveLoadStatus">);
static ZHMTypeInfo ESituationAvailability_TypeInfo = ZHMTypeInfo("ESituationAvailability", EnumToJson<"ESituationAvailability">, EnumToJsonSimple<"ESituationAvailability">);
static ZHMTypeInfo EEntityOrdering_TypeInfo = ZHMTypeInfo("EEntityOrdering", EnumToJson<"EEntityOrdering">, EnumToJsonSimple<"EEntityOrdering">);
static ZHMTypeInfo EAccidentDeathContext_TypeInfo = ZHMTypeInfo("EAccidentDeathContext", EnumToJson<"EAccidentDeathContext">, EnumToJsonSimple<"EAccidentDeathContext">);
static ZHMTypeInfo EActorType_TypeInfo = ZHMTypeInfo("EActorType", EnumToJson<"EActorType">, EnumToJsonSimple<"EActorType">);
static ZHMTypeInfo EDialogEventItemType_TypeInfo = ZHMTypeInfo("EDialogEventItemType", EnumToJson<"EDialogEventItemType">, EnumToJsonSimple<"EDialogEventItemType">);
static ZHMTypeInfo ZAT2Controller_EFoot_TypeInfo = ZHMTypeInfo("ZAT2Controller.EFoot", EnumToJson<"ZAT2Controller.EFoot">, EnumToJsonSimple<"ZAT2Controller.EFoot">);
static ZHMTypeInfo ECharacterUpperBodyStateType_TypeInfo = ZHMTypeInfo("ECharacterUpperBodyStateType", EnumToJson<"ECharacterUpperBodyStateType">, EnumToJsonSimple<"ECharacterUpperBodyStateType">);
static ZHMTypeInfo ZDecalControllerEntity_ERotationType_TypeInfo = ZHMTypeInfo("ZDecalControllerEntity.ERotationType", EnumToJson<"ZDecalControllerEntity.ERotationType">, EnumToJsonSimple<"ZDecalControllerEntity.ERotationType">);
static ZHMTypeInfo IScatterContainerEntity_EBrushType_TypeInfo = ZHMTypeInfo("IScatterContainerEntity.EBrushType", EnumToJson<"IScatterContainerEntity.EBrushType">, EnumToJsonSimple<"IScatterContainerEntity.EBrushType">);
static ZHMTypeInfo EBaseMovementType_TypeInfo = ZHMTypeInfo("EBaseMovementType", EnumToJson<"EBaseMovementType">, EnumToJsonSimple<"EBaseMovementType">);
static ZHMTypeInfo ZHM5LedgeMount_EFaceDirection_TypeInfo = ZHMTypeInfo("ZHM5LedgeMount.EFaceDirection", EnumToJson<"ZHM5LedgeMount.EFaceDirection">, EnumToJsonSimple<"ZHM5LedgeMount.EFaceDirection">);
static ZHMTypeInfo ZMoveToPositionBehaviorEntity_EApproachAlignment_TypeInfo = ZHMTypeInfo("ZMoveToPositionBehaviorEntity.EApproachAlignment", EnumToJson<"ZMoveToPositionBehaviorEntity.EApproachAlignment">, EnumToJsonSimple<"ZMoveToPositionBehaviorEntity.EApproachAlignment">);
static ZHMTypeInfo EClothBendConstrainType_TypeInfo = ZHMTypeInfo("EClothBendConstrainType", EnumToJson<"EClothBendConstrainType">, EnumToJsonSimple<"EClothBendConstrainType">);
static ZHMTypeInfo ERoleEvent_TypeInfo = ZHMTypeInfo("ERoleEvent", EnumToJson<"ERoleEvent">, EnumToJsonSimple<"ERoleEvent">);
static ZHMTypeInfo ZWorldUIElementInstanceBase_EVisibility_TypeInfo = ZHMTypeInfo("ZWorldUIElementInstanceBase.EVisibility", EnumToJson<"ZWorldUIElementInstanceBase.EVisibility">, EnumToJsonSimple<"ZWorldUIElementInstanceBase.EVisibility">);
static ZHMTypeInfo EHUDIconFlags_TypeInfo = ZHMTypeInfo("EHUDIconFlags", EnumToJson<"EHUDIconFlags">, EnumToJsonSimple<"EHUDIconFlags">);
static ZHMTypeInfo EDeathAnimationType_TypeInfo = ZHMTypeInfo("EDeathAnimationType", EnumToJson<"EDeathAnimationType">, EnumToJsonSimple<"EDeathAnimationType">);
static ZHMTypeInfo ZCautiousInvestigateGroup_EAssistantState_TypeInfo = ZHMTypeInfo("ZCautiousInvestigateGroup.EAssistantState", EnumToJson<"ZCautiousInvestigateGroup.EAssistantState">, EnumToJsonSimple<"ZCautiousInvestigateGroup.EAssistantState">);
static ZHMTypeInfo ZHM5Animator_EBoneAnimator_TypeInfo = ZHMTypeInfo("ZHM5Animator.EBoneAnimator", EnumToJson<"ZHM5Animator.EBoneAnimator">, EnumToJsonSimple<"ZHM5Animator.EBoneAnimator">);
static ZHMTypeInfo ERestitutionCombineMode_TypeInfo = ZHMTypeInfo("ERestitutionCombineMode", EnumToJson<"ERestitutionCombineMode">, EnumToJsonSimple<"ERestitutionCombineMode">);
static ZHMTypeInfo ECharacterIdlePriority_TypeInfo = ZHMTypeInfo("ECharacterIdlePriority", EnumToJson<"ECharacterIdlePriority">, EnumToJsonSimple<"ECharacterIdlePriority">);
static ZHMTypeInfo ZSequenceEntity_ECommand_TypeInfo = ZHMTypeInfo("ZSequenceEntity.ECommand", EnumToJson<"ZSequenceEntity.ECommand">, EnumToJsonSimple<"ZSequenceEntity.ECommand">);
static ZHMTypeInfo ZVRCameraEntity_EEye_TypeInfo = ZHMTypeInfo("ZVRCameraEntity.EEye", EnumToJson<"ZVRCameraEntity.EEye">, EnumToJsonSimple<"ZVRCameraEntity.EEye">);
static ZHMTypeInfo EDisposalType_TypeInfo = ZHMTypeInfo("EDisposalType", EnumToJson<"EDisposalType">, EnumToJsonSimple<"EDisposalType">);
static ZHMTypeInfo EDynamicVariableType_TypeInfo = ZHMTypeInfo("EDynamicVariableType", EnumToJson<"EDynamicVariableType">, EnumToJsonSimple<"EDynamicVariableType">);
static ZHMTypeInfo EButtonState_TypeInfo = ZHMTypeInfo("EButtonState", EnumToJson<"EButtonState">, EnumToJsonSimple<"EButtonState">);
static ZHMTypeInfo ZHM5AgilityEventConsumer_EEvent_TypeInfo = ZHMTypeInfo("ZHM5AgilityEventConsumer.EEvent", EnumToJson<"ZHM5AgilityEventConsumer.EEvent">, EnumToJsonSimple<"ZHM5AgilityEventConsumer.EEvent">);
static ZHMTypeInfo ZHM5BodyContainer_EBCState_TypeInfo = ZHMTypeInfo("ZHM5BodyContainer.EBCState", EnumToJson<"ZHM5BodyContainer.EBCState">, EnumToJsonSimple<"ZHM5BodyContainer.EBCState">);
static ZHMTypeInfo ZHM5Item_EKeywordEvaluationType_TypeInfo = ZHMTypeInfo("ZHM5Item.EKeywordEvaluationType", EnumToJson<"ZHM5Item.EKeywordEvaluationType">, EnumToJsonSimple<"ZHM5Item.EKeywordEvaluationType">);
static ZHMTypeInfo InputControlNamesp_eHM5InputActionID_TypeInfo = ZHMTypeInfo("InputControlNamesp.eHM5InputActionID", EnumToJson<"InputControlNamesp.eHM5InputActionID">, EnumToJsonSimple<"InputControlNamesp.eHM5InputActionID">);
static ZHMTypeInfo JSONTemplate_ETemplateType_TypeInfo = ZHMTypeInfo("JSONTemplate.ETemplateType", EnumToJson<"JSONTemplate.ETemplateType">, EnumToJsonSimple<"JSONTemplate.ETemplateType">);
static ZHMTypeInfo ZMirrorEntity_EMirrorQuality_TypeInfo = ZHMTypeInfo("ZMirrorEntity.EMirrorQuality", EnumToJson<"ZMirrorEntity.EMirrorQuality">, EnumToJsonSimple<"ZMirrorEntity.EMirrorQuality">);
static ZHMTypeInfo EWeaponAnimationCategory_TypeInfo = ZHMTypeInfo("EWeaponAnimationCategory", EnumToJson<"EWeaponAnimationCategory">, EnumToJsonSimple<"EWeaponAnimationCategory">);
static ZHMTypeInfo EAILegalType_TypeInfo = ZHMTypeInfo("EAILegalType", EnumToJson<"EAILegalType">, EnumToJsonSimple<"EAILegalType">);
static ZHMTypeInfo ZActorPickerFilterGroup_EEvaluationType_TypeInfo = ZHMTypeInfo("ZActorPickerFilterGroup.EEvaluationType", EnumToJson<"ZActorPickerFilterGroup.EEvaluationType">, EnumToJsonSimple<"ZActorPickerFilterGroup.EEvaluationType">);
static ZHMTypeInfo ZHM5HitmanHealthModifier_EHealthValue_TypeInfo = ZHMTypeInfo("ZHM5HitmanHealthModifier.EHealthValue", EnumToJson<"ZHM5HitmanHealthModifier.EHealthValue">, EnumToJsonSimple<"ZHM5HitmanHealthModifier.EHealthValue">);
static ZHMTypeInfo EConversationID_TypeInfo = ZHMTypeInfo("EConversationID", EnumToJson<"EConversationID">, EnumToJsonSimple<"EConversationID">);
static ZHMTypeInfo ZDebugTextEntity_EHorizontalAlignment_TypeInfo = ZHMTypeInfo("ZDebugTextEntity.EHorizontalAlignment", EnumToJson<"ZDebugTextEntity.EHorizontalAlignment">, EnumToJsonSimple<"ZDebugTextEntity.EHorizontalAlignment">);
static ZHMTypeInfo EClipSpawnAxis_TypeInfo = ZHMTypeInfo("EClipSpawnAxis", EnumToJson<"EClipSpawnAxis">, EnumToJsonSimple<"EClipSpawnAxis">);
static ZHMTypeInfo EMeBarState_TypeInfo = ZHMTypeInfo("EMeBarState", EnumToJson<"EMeBarState">, EnumToJsonSimple<"EMeBarState">);
static ZHMTypeInfo ECameraCollisionMode_TypeInfo = ZHMTypeInfo("ECameraCollisionMode", EnumToJson<"ECameraCollisionMode">, EnumToJsonSimple<"ECameraCollisionMode">);
static ZHMTypeInfo EClothStretchConstrainType_TypeInfo = ZHMTypeInfo("EClothStretchConstrainType", EnumToJson<"EClothStretchConstrainType">, EnumToJsonSimple<"EClothStretchConstrainType">);
static ZHMTypeInfo ENamedGameEvents_TypeInfo = ZHMTypeInfo("ENamedGameEvents", EnumToJson<"ENamedGameEvents">, EnumToJsonSimple<"ENamedGameEvents">);
static ZHMTypeInfo ZDebugTextEntity_EVerticalAlignment_TypeInfo = ZHMTypeInfo("ZDebugTextEntity.EVerticalAlignment", EnumToJson<"ZDebugTextEntity.EVerticalAlignment">, EnumToJsonSimple<"ZDebugTextEntity.EVerticalAlignment">);
static ZHMTypeInfo ZSetUIControlDisplayInfoEntity_EProjectionOp_TypeInfo = ZHMTypeInfo("ZSetUIControlDisplayInfoEntity.EProjectionOp", EnumToJson<"ZSetUIControlDisplayInfoEntity.EProjectionOp">, EnumToJsonSimple<"ZSetUIControlDisplayInfoEntity.EProjectionOp">);
static ZHMTypeInfo ZDistanceCondition_EObjectType_TypeInfo = ZHMTypeInfo("ZDistanceCondition.EObjectType", EnumToJson<"ZDistanceCondition.EObjectType">, EnumToJsonSimple<"ZDistanceCondition.EObjectType">);
static ZHMTypeInfo EHM5SoundFootstepEmitterTarget_TypeInfo = ZHMTypeInfo("EHM5SoundFootstepEmitterTarget", EnumToJson<"EHM5SoundFootstepEmitterTarget">, EnumToJsonSimple<"EHM5SoundFootstepEmitterTarget">);
static ZHMTypeInfo EGuardPointType_TypeInfo = ZHMTypeInfo("EGuardPointType", EnumToJson<"EGuardPointType">, EnumToJsonSimple<"EGuardPointType">);
static ZHMTypeInfo ECharacterEvent_TypeInfo = ZHMTypeInfo("ECharacterEvent", EnumToJson<"ECharacterEvent">, EnumToJsonSimple<"ECharacterEvent">);
static ZHMTypeInfo ECharacterIdleHandlerUpperBodyType_TypeInfo = ZHMTypeInfo("ECharacterIdleHandlerUpperBodyType", EnumToJson<"ECharacterIdleHandlerUpperBodyType">, EnumToJsonSimple<"ECharacterIdleHandlerUpperBodyType">);
static ZHMTypeInfo ECharacterBodyType_TypeInfo = ZHMTypeInfo("ECharacterBodyType", EnumToJson<"ECharacterBodyType">, EnumToJsonSimple<"ECharacterBodyType">);
static ZHMTypeInfo EAimAssistActivationState_TypeInfo = ZHMTypeInfo("EAimAssistActivationState", EnumToJson<"EAimAssistActivationState">, EnumToJsonSimple<"EAimAssistActivationState">);
static ZHMTypeInfo ZHM5BodyContainer_EBCAnimSet_TypeInfo = ZHMTypeInfo("ZHM5BodyContainer.EBCAnimSet", EnumToJson<"ZHM5BodyContainer.EBCAnimSet">, EnumToJsonSimple<"ZHM5BodyContainer.EBCAnimSet">);
static ZHMTypeInfo ELedgeDismountDirection_TypeInfo = ZHMTypeInfo("ELedgeDismountDirection", EnumToJson<"ELedgeDismountDirection">, EnumToJsonSimple<"ELedgeDismountDirection">);
static ZHMTypeInfo ETargetPrintDestination_TypeInfo = ZHMTypeInfo("ETargetPrintDestination", EnumToJson<"ETargetPrintDestination">, EnumToJsonSimple<"ETargetPrintDestination">);
static ZHMTypeInfo ZHUDWorldSpatialAttachEntity_EOrientation_TypeInfo = ZHMTypeInfo("ZHUDWorldSpatialAttachEntity.EOrientation", EnumToJson<"ZHUDWorldSpatialAttachEntity.EOrientation">, EnumToJsonSimple<"ZHUDWorldSpatialAttachEntity.EOrientation">);
static ZHMTypeInfo eParticleEmitterBoxEntity_SpawnModes_TypeInfo = ZHMTypeInfo("eParticleEmitterBoxEntity_SpawnModes", EnumToJson<"eParticleEmitterBoxEntity_SpawnModes">, EnumToJsonSimple<"eParticleEmitterBoxEntity_SpawnModes">);
static ZHMTypeInfo EDeathType_TypeInfo = ZHMTypeInfo("EDeathType", EnumToJson<"EDeathType">, EnumToJsonSimple<"EDeathType">);
static ZHMTypeInfo ECommunicationBarMessage_TypeInfo = ZHMTypeInfo("ECommunicationBarMessage", EnumToJson<"ECommunicationBarMessage">, EnumToJsonSimple<"ECommunicationBarMessage">);
static ZHMTypeInfo ZHUDCamera3DControllerEntity_EType_TypeInfo = ZHMTypeInfo("ZHUDCamera3DControllerEntity.EType", EnumToJson<"ZHUDCamera3DControllerEntity.EType">, EnumToJsonSimple<"ZHUDCamera3DControllerEntity.EType">);
static ZHMTypeInfo EThrowType_TypeInfo = ZHMTypeInfo("EThrowType", EnumToJson<"EThrowType">, EnumToJsonSimple<"EThrowType">);
static ZHMTypeInfo EDetectedNatType_TypeInfo = ZHMTypeInfo("EDetectedNatType", EnumToJson<"EDetectedNatType">, EnumToJsonSimple<"EDetectedNatType">);
static ZHMTypeInfo ILightEntity_ERoomLightFlow_TypeInfo = ZHMTypeInfo("ILightEntity.ERoomLightFlow", EnumToJson<"ILightEntity.ERoomLightFlow">, EnumToJsonSimple<"ILightEntity.ERoomLightFlow">);
static ZHMTypeInfo ECrossHairType_TypeInfo = ZHMTypeInfo("ECrossHairType", EnumToJson<"ECrossHairType">, EnumToJsonSimple<"ECrossHairType">);
static ZHMTypeInfo EMarkerClipAlgorithm_TypeInfo = ZHMTypeInfo("EMarkerClipAlgorithm", EnumToJson<"EMarkerClipAlgorithm">, EnumToJsonSimple<"EMarkerClipAlgorithm">);
static ZHMTypeInfo ZHeroBoneAttachEntity_EResetMode_TypeInfo = ZHMTypeInfo("ZHeroBoneAttachEntity.EResetMode", EnumToJson<"ZHeroBoneAttachEntity.EResetMode">, EnumToJsonSimple<"ZHeroBoneAttachEntity.EResetMode">);
static ZHMTypeInfo eBurstPatternType_TypeInfo = ZHMTypeInfo("eBurstPatternType", EnumToJson<"eBurstPatternType">, EnumToJsonSimple<"eBurstPatternType">);
static ZHMTypeInfo EQueryMaskType_TypeInfo = ZHMTypeInfo("EQueryMaskType", EnumToJson<"EQueryMaskType">, EnumToJsonSimple<"EQueryMaskType">);
static ZHMTypeInfo ZPointOfInterestEntity_EPOIType_TypeInfo = ZHMTypeInfo("ZPointOfInterestEntity.EPOIType", EnumToJson<"ZPointOfInterestEntity.EPOIType">, EnumToJsonSimple<"ZPointOfInterestEntity.EPOIType">);
static ZHMTypeInfo EGait_TypeInfo = ZHMTypeInfo("EGait", EnumToJson<"EGait">, EnumToJsonSimple<"EGait">);
static ZHMTypeInfo EAIGoal_TypeInfo = ZHMTypeInfo("EAIGoal", EnumToJson<"EAIGoal">, EnumToJsonSimple<"EAIGoal">);
static ZHMTypeInfo ECharacterResourceType_TypeInfo = ZHMTypeInfo("ECharacterResourceType", EnumToJson<"ECharacterResourceType">, EnumToJsonSimple<"ECharacterResourceType">);
static ZHMTypeInfo ZHM5WeaponBasicConfigEntity_EWeaponBasicConfigAudioExoticType_TypeInfo = ZHMTypeInfo("ZHM5WeaponBasicConfigEntity.EWeaponBasicConfigAudioExoticType", EnumToJson<"ZHM5WeaponBasicConfigEntity.EWeaponBasicConfigAudioExoticType">, EnumToJsonSimple<"ZHM5WeaponBasicConfigEntity.EWeaponBasicConfigAudioExoticType">);
static ZHMTypeInfo EDisturbanceType_TypeInfo = ZHMTypeInfo("EDisturbanceType", EnumToJson<"EDisturbanceType">, EnumToJsonSimple<"EDisturbanceType">);
static ZHMTypeInfo IRenderMaterialEntity_EModifierOperation_TypeInfo = ZHMTypeInfo("IRenderMaterialEntity.EModifierOperation", EnumToJson<"IRenderMaterialEntity.EModifierOperation">, EnumToJsonSimple<"IRenderMaterialEntity.EModifierOperation">);
static ZHMTypeInfo ZBoxReflectionEntity_EType_TypeInfo = ZHMTypeInfo("ZBoxReflectionEntity.EType", EnumToJson<"ZBoxReflectionEntity.EType">, EnumToJsonSimple<"ZBoxReflectionEntity.EType">);
static ZHMTypeInfo ZGetHelpGroup_EInvestigateGroupState_TypeInfo = ZHMTypeInfo("ZGetHelpGroup.EInvestigateGroupState", EnumToJson<"ZGetHelpGroup.EInvestigateGroupState">, EnumToJsonSimple<"ZGetHelpGroup.EInvestigateGroupState">);
static ZHMTypeInfo ECollisionNotifyGroup_TypeInfo = ZHMTypeInfo("ECollisionNotifyGroup", EnumToJson<"ECollisionNotifyGroup">, EnumToJsonSimple<"ECollisionNotifyGroup">);
static ZHMTypeInfo ECharSetCharacterType_TypeInfo = ZHMTypeInfo("ECharSetCharacterType", EnumToJson<"ECharSetCharacterType">, EnumToJsonSimple<"ECharSetCharacterType">);
static ZHMTypeInfo EActorGroup_TypeInfo = ZHMTypeInfo("EActorGroup", EnumToJson<"EActorGroup">, EnumToJsonSimple<"EActorGroup">);
static ZHMTypeInfo InputControlNamesp_eHM5InputAction_TypeInfo = ZHMTypeInfo("InputControlNamesp.eHM5InputAction", EnumToJson<"InputControlNamesp.eHM5InputAction">, EnumToJsonSimple<"InputControlNamesp.eHM5InputAction">);
static ZHMTypeInfo EAISharedEventType_TypeInfo = ZHMTypeInfo("EAISharedEventType", EnumToJson<"EAISharedEventType">, EnumToJsonSimple<"EAISharedEventType">);
static ZHMTypeInfo ZPathfinderDebugEntity_EDebugTestType_TypeInfo = ZHMTypeInfo("ZPathfinderDebugEntity.EDebugTestType", EnumToJson<"ZPathfinderDebugEntity.EDebugTestType">, EnumToJsonSimple<"ZPathfinderDebugEntity.EDebugTestType">);
static ZHMTypeInfo ECombatZoneState_TypeInfo = ZHMTypeInfo("ECombatZoneState", EnumToJson<"ECombatZoneState">, EnumToJsonSimple<"ECombatZoneState">);
static ZHMTypeInfo ELocale_TypeInfo = ZHMTypeInfo("ELocale", EnumToJson<"ELocale">, EnumToJsonSimple<"ELocale">);
static ZHMTypeInfo EGameUIMenu_TypeInfo = ZHMTypeInfo("EGameUIMenu", EnumToJson<"EGameUIMenu">, EnumToJsonSimple<"EGameUIMenu">);
static ZHMTypeInfo EAutoScanMode_TypeInfo = ZHMTypeInfo("EAutoScanMode", EnumToJson<"EAutoScanMode">, EnumToJsonSimple<"EAutoScanMode">);
static ZHMTypeInfo ENetRole_TypeInfo = ZHMTypeInfo("ENetRole", EnumToJson<"ENetRole">, EnumToJsonSimple<"ENetRole">);
static ZHMTypeInfo EActorCCPreset_TypeInfo = ZHMTypeInfo("EActorCCPreset", EnumToJson<"EActorCCPreset">, EnumToJsonSimple<"EActorCCPreset">);
static ZHMTypeInfo EItemRequirement_TypeInfo = ZHMTypeInfo("EItemRequirement", EnumToJson<"EItemRequirement">, EnumToJsonSimple<"EItemRequirement">);
static ZHMTypeInfo EClothColliderFilter_TypeInfo = ZHMTypeInfo("EClothColliderFilter", EnumToJson<"EClothColliderFilter">, EnumToJsonSimple<"EClothColliderFilter">);
static ZHMTypeInfo EVsGenericEvent_TypeInfo = ZHMTypeInfo("EVsGenericEvent", EnumToJson<"EVsGenericEvent">, EnumToJsonSimple<"EVsGenericEvent">);
static ZHMTypeInfo ESmartBehaviorOrder_TypeInfo = ZHMTypeInfo("ESmartBehaviorOrder", EnumToJson<"ESmartBehaviorOrder">, EnumToJsonSimple<"ESmartBehaviorOrder">);
static ZHMTypeInfo ZRagdollAttacherEntity_EResetMode_TypeInfo = ZHMTypeInfo("ZRagdollAttacherEntity.EResetMode", EnumToJson<"ZRagdollAttacherEntity.EResetMode">, EnumToJsonSimple<"ZRagdollAttacherEntity.EResetMode">);
