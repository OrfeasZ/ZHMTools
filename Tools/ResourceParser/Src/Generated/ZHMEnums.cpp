...
static ZHMTypeInfo EItemMeleeDamageBehavior_TypeInfo = ZHMTypeInfo("EItemMeleeDamageBehavior", WriteEnumJson<"EItemMeleeDamageBehavior">, WriteEnumJsonSimple<"EItemMeleeDamageBehavior">);
static ZHMTypeInfo ZStateControllerEntity_WrapMode_TypeInfo = ZHMTypeInfo("ZStateControllerEntity.WrapMode", WriteEnumJson<"ZStateControllerEntity.WrapMode">, WriteEnumJsonSimple<"ZStateControllerEntity.WrapMode">);
static ZHMTypeInfo ZFriskSuspectGroup_EAssistantState_TypeInfo = ZHMTypeInfo("ZFriskSuspectGroup.EAssistantState", WriteEnumJson<"ZFriskSuspectGroup.EAssistantState">, WriteEnumJsonSimple<"ZFriskSuspectGroup.EAssistantState">);
static ZHMTypeInfo ZRenderPostfilterParametersEntity_EHDRGlareType_TypeInfo = ZHMTypeInfo("ZRenderPostfilterParametersEntity.EHDRGlareType", WriteEnumJson<"ZRenderPostfilterParametersEntity.EHDRGlareType">, WriteEnumJsonSimple<"ZRenderPostfilterParametersEntity.EHDRGlareType">);
static ZHMTypeInfo ZOperatorBool_EEvaluationType_TypeInfo = ZHMTypeInfo("ZOperatorBool.EEvaluationType", WriteEnumJson<"ZOperatorBool.EEvaluationType">, WriteEnumJsonSimple<"ZOperatorBool.EEvaluationType">);
static ZHMTypeInfo EGSEvent_TypeInfo = ZHMTypeInfo("EGSEvent", WriteEnumJson<"EGSEvent">, WriteEnumJsonSimple<"EGSEvent">);
static ZHMTypeInfo ZCautiousInvestigateGroup_EApproachOrderState_TypeInfo = ZHMTypeInfo("ZCautiousInvestigateGroup.EApproachOrderState", WriteEnumJson<"ZCautiousInvestigateGroup.EApproachOrderState">, WriteEnumJsonSimple<"ZCautiousInvestigateGroup.EApproachOrderState">);
static ZHMTypeInfo EGSKillSituation_TypeInfo = ZHMTypeInfo("EGSKillSituation", WriteEnumJson<"EGSKillSituation">, WriteEnumJsonSimple<"EGSKillSituation">);
static ZHMTypeInfo ZHUDCamera3DControllerEntity_ESpace_TypeInfo = ZHMTypeInfo("ZHUDCamera3DControllerEntity.ESpace", WriteEnumJson<"ZHUDCamera3DControllerEntity.ESpace">, WriteEnumJsonSimple<"ZHUDCamera3DControllerEntity.ESpace">);
static ZHMTypeInfo ETessellationMode_TypeInfo = ZHMTypeInfo("ETessellationMode", WriteEnumJson<"ETessellationMode">, WriteEnumJsonSimple<"ETessellationMode">);
static ZHMTypeInfo EBystanderPointType_TypeInfo = ZHMTypeInfo("EBystanderPointType", WriteEnumJson<"EBystanderPointType">, WriteEnumJsonSimple<"EBystanderPointType">);
static ZHMTypeInfo _EUIOptionKey_TypeInfo = ZHMTypeInfo("_EUIOptionKey", WriteEnumJson<"_EUIOptionKey">, WriteEnumJsonSimple<"_EUIOptionKey">);
static ZHMTypeInfo EVRConfigCameraRotationAllowed_TypeInfo = ZHMTypeInfo("EVRConfigCameraRotationAllowed", WriteEnumJson<"EVRConfigCameraRotationAllowed">, WriteEnumJsonSimple<"EVRConfigCameraRotationAllowed">);
static ZHMTypeInfo ZInteractionGuideData_EDirection_TypeInfo = ZHMTypeInfo("ZInteractionGuideData.EDirection", WriteEnumJson<"ZInteractionGuideData.EDirection">, WriteEnumJsonSimple<"ZInteractionGuideData.EDirection">);
static ZHMTypeInfo ZInteractionData_EFilterResult_TypeInfo = ZHMTypeInfo("ZInteractionData.EFilterResult", WriteEnumJson<"ZInteractionData.EFilterResult">, WriteEnumJsonSimple<"ZInteractionData.EFilterResult">);
static ZHMTypeInfo ZHeroEscortSituation2Entity_ETargetState_TypeInfo = ZHMTypeInfo("ZHeroEscortSituation2Entity.ETargetState", WriteEnumJson<"ZHeroEscortSituation2Entity.ETargetState">, WriteEnumJsonSimple<"ZHeroEscortSituation2Entity.ETargetState">);
static ZHMTypeInfo EOutfitAICategory_TypeInfo = ZHMTypeInfo("EOutfitAICategory", WriteEnumJson<"EOutfitAICategory">, WriteEnumJsonSimple<"EOutfitAICategory">);
static ZHMTypeInfo ESoundChannelGroup_TypeInfo = ZHMTypeInfo("ESoundChannelGroup", WriteEnumJson<"ESoundChannelGroup">, WriteEnumJsonSimple<"ESoundChannelGroup">);
static ZHMTypeInfo ZActorKeywordCondition_EEvaluationType_TypeInfo = ZHMTypeInfo("ZActorKeywordCondition.EEvaluationType", WriteEnumJson<"ZActorKeywordCondition.EEvaluationType">, WriteEnumJsonSimple<"ZActorKeywordCondition.EEvaluationType">);
static ZHMTypeInfo EGSExplodingPropType_TypeInfo = ZHMTypeInfo("EGSExplodingPropType", WriteEnumJson<"EGSExplodingPropType">, WriteEnumJsonSimple<"EGSExplodingPropType">);
static ZHMTypeInfo ZCrowdActorEntity_ECharacterSoundType_TypeInfo = ZHMTypeInfo("ZCrowdActorEntity.ECharacterSoundType", WriteEnumJson<"ZCrowdActorEntity.ECharacterSoundType">, WriteEnumJsonSimple<"ZCrowdActorEntity.ECharacterSoundType">);
static ZHMTypeInfo eItemType_TypeInfo = ZHMTypeInfo("eItemType", WriteEnumJson<"eItemType">, WriteEnumJsonSimple<"eItemType">);
static ZHMTypeInfo EDebugExclusionLayerState_TypeInfo = ZHMTypeInfo("EDebugExclusionLayerState", WriteEnumJson<"EDebugExclusionLayerState">, WriteEnumJsonSimple<"EDebugExclusionLayerState">);
static ZHMTypeInfo ILightEntity_ELightType_TypeInfo = ZHMTypeInfo("ILightEntity.ELightType", WriteEnumJson<"ILightEntity.ELightType">, WriteEnumJsonSimple<"ILightEntity.ELightType">);
static ZHMTypeInfo ZPhotoModeMenuDataProvider_EMenuEntryType_TypeInfo = ZHMTypeInfo("ZPhotoModeMenuDataProvider.EMenuEntryType", WriteEnumJson<"ZPhotoModeMenuDataProvider.EMenuEntryType">, WriteEnumJsonSimple<"ZPhotoModeMenuDataProvider.EMenuEntryType">);
static ZHMTypeInfo EOnlinTest_TypeInfo = ZHMTypeInfo("EOnlinTest", WriteEnumJson<"EOnlinTest">, WriteEnumJsonSimple<"EOnlinTest">);
static ZHMTypeInfo eContractSessionStartError_TypeInfo = ZHMTypeInfo("eContractSessionStartError", WriteEnumJson<"eContractSessionStartError">, WriteEnumJsonSimple<"eContractSessionStartError">);
static ZHMTypeInfo EParticleColorUsage_TypeInfo = ZHMTypeInfo("EParticleColorUsage", WriteEnumJson<"EParticleColorUsage">, WriteEnumJsonSimple<"EParticleColorUsage">);
static ZHMTypeInfo EGameModeId_TypeInfo = ZHMTypeInfo("EGameModeId", WriteEnumJson<"EGameModeId">, WriteEnumJsonSimple<"EGameModeId">);
static ZHMTypeInfo ZActBehaviorEntity_EApproachAlignment_TypeInfo = ZHMTypeInfo("ZActBehaviorEntity.EApproachAlignment", WriteEnumJson<"ZActBehaviorEntity.EApproachAlignment">, WriteEnumJsonSimple<"ZActBehaviorEntity.EApproachAlignment">);
static ZHMTypeInfo ILightEntity_EFrameIndexStrategy_TypeInfo = ZHMTypeInfo("ILightEntity.EFrameIndexStrategy", WriteEnumJson<"ILightEntity.EFrameIndexStrategy">, WriteEnumJsonSimple<"ILightEntity.EFrameIndexStrategy">);
static ZHMTypeInfo EViewportLock_TypeInfo = ZHMTypeInfo("EViewportLock", WriteEnumJson<"EViewportLock">, WriteEnumJsonSimple<"EViewportLock">);
static ZHMTypeInfo ZInputListenerDpadEntity_eInputListenerDpad_TypeInfo = ZHMTypeInfo("ZInputListenerDpadEntity.eInputListenerDpad", WriteEnumJson<"ZInputListenerDpadEntity.eInputListenerDpad">, WriteEnumJsonSimple<"ZInputListenerDpadEntity.eInputListenerDpad">);
static ZHMTypeInfo ZEscortSituation2Entity_ETargetState_TypeInfo = ZHMTypeInfo("ZEscortSituation2Entity.ETargetState", WriteEnumJson<"ZEscortSituation2Entity.ETargetState">, WriteEnumJsonSimple<"ZEscortSituation2Entity.ETargetState">);
static ZHMTypeInfo ZTrespassingSituation_ESituationState_TypeInfo = ZHMTypeInfo("ZTrespassingSituation.ESituationState", WriteEnumJson<"ZTrespassingSituation.ESituationState">, WriteEnumJsonSimple<"ZTrespassingSituation.ESituationState">);
static ZHMTypeInfo EAIFormationMemberSpeed_TypeInfo = ZHMTypeInfo("EAIFormationMemberSpeed", WriteEnumJson<"EAIFormationMemberSpeed">, WriteEnumJsonSimple<"EAIFormationMemberSpeed">);
static ZHMTypeInfo ERenderGlowTypes_TypeInfo = ZHMTypeInfo("ERenderGlowTypes", WriteEnumJson<"ERenderGlowTypes">, WriteEnumJsonSimple<"ERenderGlowTypes">);
static ZHMTypeInfo EFocusBarState_TypeInfo = ZHMTypeInfo("EFocusBarState", WriteEnumJson<"EFocusBarState">, WriteEnumJsonSimple<"EFocusBarState">);
static ZHMTypeInfo ESoundCollisionObjectType_TypeInfo = ZHMTypeInfo("ESoundCollisionObjectType", WriteEnumJson<"ESoundCollisionObjectType">, WriteEnumJsonSimple<"ESoundCollisionObjectType">);
static ZHMTypeInfo ZDistanceCondition_ECompareMethod_TypeInfo = ZHMTypeInfo("ZDistanceCondition.ECompareMethod", WriteEnumJson<"ZDistanceCondition.ECompareMethod">, WriteEnumJsonSimple<"ZDistanceCondition.ECompareMethod">);
static ZHMTypeInfo TeleportActionType_TypeInfo = ZHMTypeInfo("TeleportActionType", WriteEnumJson<"TeleportActionType">, WriteEnumJsonSimple<"TeleportActionType">);
static ZHMTypeInfo EActorAIState_TypeInfo = ZHMTypeInfo("EActorAIState", WriteEnumJson<"EActorAIState">, WriteEnumJsonSimple<"EActorAIState">);
static ZHMTypeInfo EMorphemeEventId_TypeInfo = ZHMTypeInfo("EMorphemeEventId", WriteEnumJson<"EMorphemeEventId">, WriteEnumJsonSimple<"EMorphemeEventId">);
static ZHMTypeInfo EAccidentScaleContext_TypeInfo = ZHMTypeInfo("EAccidentScaleContext", WriteEnumJson<"EAccidentScaleContext">, WriteEnumJsonSimple<"EAccidentScaleContext">);
static ZHMTypeInfo EEngineModeId_TypeInfo = ZHMTypeInfo("EEngineModeId", WriteEnumJson<"EEngineModeId">, WriteEnumJsonSimple<"EEngineModeId">);
static ZHMTypeInfo ZActBehaviorEntity_EState_TypeInfo = ZHMTypeInfo("ZActBehaviorEntity.EState", WriteEnumJson<"ZActBehaviorEntity.EState">, WriteEnumJsonSimple<"ZActBehaviorEntity.EState">);
static ZHMTypeInfo ZSoundAmbienceGroup_ESoundCollisionType_TypeInfo = ZHMTypeInfo("ZSoundAmbienceGroup.ESoundCollisionType", WriteEnumJson<"ZSoundAmbienceGroup.ESoundCollisionType">, WriteEnumJsonSimple<"ZSoundAmbienceGroup.ESoundCollisionType">);
static ZHMTypeInfo EDamageEvent_TypeInfo = ZHMTypeInfo("EDamageEvent", WriteEnumJson<"EDamageEvent">, WriteEnumJsonSimple<"EDamageEvent">);
static ZHMTypeInfo ZDebugGizmoEntity_EDrawLayer_TypeInfo = ZHMTypeInfo("ZDebugGizmoEntity.EDrawLayer", WriteEnumJson<"ZDebugGizmoEntity.EDrawLayer">, WriteEnumJsonSimple<"ZDebugGizmoEntity.EDrawLayer">);
static ZHMTypeInfo ZCoverPlane_ECoverSize_TypeInfo = ZHMTypeInfo("ZCoverPlane.ECoverSize", WriteEnumJson<"ZCoverPlane.ECoverSize">, WriteEnumJsonSimple<"ZCoverPlane.ECoverSize">);
static ZHMTypeInfo EAnimSetType_TypeInfo = ZHMTypeInfo("EAnimSetType", WriteEnumJson<"EAnimSetType">, WriteEnumJsonSimple<"EAnimSetType">);
static ZHMTypeInfo ZContextKillGuide_EEvaluationType_TypeInfo = ZHMTypeInfo("ZContextKillGuide.EEvaluationType", WriteEnumJson<"ZContextKillGuide.EEvaluationType">, WriteEnumJsonSimple<"ZContextKillGuide.EEvaluationType">);
static ZHMTypeInfo EMassImpulseType_TypeInfo = ZHMTypeInfo("EMassImpulseType", WriteEnumJson<"EMassImpulseType">, WriteEnumJsonSimple<"EMassImpulseType">);
static ZHMTypeInfo ReverbFidelity_TypeInfo = ZHMTypeInfo("ReverbFidelity", WriteEnumJson<"ReverbFidelity">, WriteEnumJsonSimple<"ReverbFidelity">);
static ZHMTypeInfo EDifficultyLevel_TypeInfo = ZHMTypeInfo("EDifficultyLevel", WriteEnumJson<"EDifficultyLevel">, WriteEnumJsonSimple<"EDifficultyLevel">);
static ZHMTypeInfo ECharacterCollidableLayer_TypeInfo = ZHMTypeInfo("ECharacterCollidableLayer", WriteEnumJson<"ECharacterCollidableLayer">, WriteEnumJsonSimple<"ECharacterCollidableLayer">);
static ZHMTypeInfo ZHUDOutfitWidgetControllerEntity_EVisibilityPolicy_TypeInfo = ZHMTypeInfo("ZHUDOutfitWidgetControllerEntity.EVisibilityPolicy", WriteEnumJson<"ZHUDOutfitWidgetControllerEntity.EVisibilityPolicy">, WriteEnumJsonSimple<"ZHUDOutfitWidgetControllerEntity.EVisibilityPolicy">);
static ZHMTypeInfo ESmartWaitCondition_TypeInfo = ZHMTypeInfo("ESmartWaitCondition", WriteEnumJson<"ESmartWaitCondition">, WriteEnumJsonSimple<"ESmartWaitCondition">);
static ZHMTypeInfo ZActorPickerEffectTrack_EEffectPhaseAction_TypeInfo = ZHMTypeInfo("ZActorPickerEffectTrack.EEffectPhaseAction", WriteEnumJson<"ZActorPickerEffectTrack.EEffectPhaseAction">, WriteEnumJsonSimple<"ZActorPickerEffectTrack.EEffectPhaseAction">);
static ZHMTypeInfo ERegionId_TypeInfo = ZHMTypeInfo("ERegionId", WriteEnumJson<"ERegionId">, WriteEnumJsonSimple<"ERegionId">);
static ZHMTypeInfo ZTestGroupPath_EModifierType_TypeInfo = ZHMTypeInfo("ZTestGroupPath.EModifierType", WriteEnumJson<"ZTestGroupPath.EModifierType">, WriteEnumJsonSimple<"ZTestGroupPath.EModifierType">);
static ZHMTypeInfo ZCautiousSearchGroup_EAssistantState_TypeInfo = ZHMTypeInfo("ZCautiousSearchGroup.EAssistantState", WriteEnumJson<"ZCautiousSearchGroup.EAssistantState">, WriteEnumJsonSimple<"ZCautiousSearchGroup.EAssistantState">);
static ZHMTypeInfo EAnimationPose_TypeInfo = ZHMTypeInfo("EAnimationPose", WriteEnumJson<"EAnimationPose">, WriteEnumJsonSimple<"EAnimationPose">);
static ZHMTypeInfo EActorLookAtStopReason_TypeInfo = ZHMTypeInfo("EActorLookAtStopReason", WriteEnumJson<"EActorLookAtStopReason">, WriteEnumJsonSimple<"EActorLookAtStopReason">);
static ZHMTypeInfo ZHM5Item_EUseTypes_TypeInfo = ZHMTypeInfo("ZHM5Item.EUseTypes", WriteEnumJson<"ZHM5Item.EUseTypes">, WriteEnumJsonSimple<"ZHM5Item.EUseTypes">);
static ZHMTypeInfo EHM5SoundFootwearType_TypeInfo = ZHMTypeInfo("EHM5SoundFootwearType", WriteEnumJson<"EHM5SoundFootwearType">, WriteEnumJsonSimple<"EHM5SoundFootwearType">);
static ZHMTypeInfo ECharacterIdleHandlerFullbodyType_TypeInfo = ZHMTypeInfo("ECharacterIdleHandlerFullbodyType", WriteEnumJson<"ECharacterIdleHandlerFullbodyType">, WriteEnumJsonSimple<"ECharacterIdleHandlerFullbodyType">);
static ZHMTypeInfo ZValueBool_Operation_Signal_EEvaluationType_TypeInfo = ZHMTypeInfo("ZValueBool_Operation_Signal.EEvaluationType", WriteEnumJson<"ZValueBool_Operation_Signal.EEvaluationType">, WriteEnumJsonSimple<"ZValueBool_Operation_Signal.EEvaluationType">);
static ZHMTypeInfo ZCautiousInvestigateGroup_EInvestigateGroupState_TypeInfo = ZHMTypeInfo("ZCautiousInvestigateGroup.EInvestigateGroupState", WriteEnumJson<"ZCautiousInvestigateGroup.EInvestigateGroupState">, WriteEnumJsonSimple<"ZCautiousInvestigateGroup.EInvestigateGroupState">);
static ZHMTypeInfo IHM5Door_eCloseMode_TypeInfo = ZHMTypeInfo("IHM5Door.eCloseMode", WriteEnumJson<"IHM5Door.eCloseMode">, WriteEnumJsonSimple<"IHM5Door.eCloseMode">);
static ZHMTypeInfo EParticleSpritePivotLocation_TypeInfo = ZHMTypeInfo("EParticleSpritePivotLocation", WriteEnumJson<"EParticleSpritePivotLocation">, WriteEnumJsonSimple<"EParticleSpritePivotLocation">);
static ZHMTypeInfo WebSocketUtils_EOpCode_TypeInfo = ZHMTypeInfo("WebSocketUtils.EOpCode", WriteEnumJson<"WebSocketUtils.EOpCode">, WriteEnumJsonSimple<"WebSocketUtils.EOpCode">);
static ZHMTypeInfo EVRConfigAnimationMode_TypeInfo = ZHMTypeInfo("EVRConfigAnimationMode", WriteEnumJson<"EVRConfigAnimationMode">, WriteEnumJsonSimple<"EVRConfigAnimationMode">);
static ZHMTypeInfo EAnimSetState_TypeInfo = ZHMTypeInfo("EAnimSetState", WriteEnumJson<"EAnimSetState">, WriteEnumJsonSimple<"EAnimSetState">);
static ZHMTypeInfo ZRenderPostfilterParametersEntity_EHDRToneMapType_TypeInfo = ZHMTypeInfo("ZRenderPostfilterParametersEntity.EHDRToneMapType", WriteEnumJson<"ZRenderPostfilterParametersEntity.EHDRToneMapType">, WriteEnumJsonSimple<"ZRenderPostfilterParametersEntity.EHDRToneMapType">);
static ZHMTypeInfo SFootIKEventData_EFoot_TypeInfo = ZHMTypeInfo("SFootIKEventData.EFoot", WriteEnumJson<"SFootIKEventData.EFoot">, WriteEnumJsonSimple<"SFootIKEventData.EFoot">);
static ZHMTypeInfo EHM5GameInputFlag_TypeInfo = ZHMTypeInfo("EHM5GameInputFlag", WriteEnumJson<"EHM5GameInputFlag">, WriteEnumJsonSimple<"EHM5GameInputFlag">);
static ZHMTypeInfo EDramaStateFlag_TypeInfo = ZHMTypeInfo("EDramaStateFlag", WriteEnumJson<"EDramaStateFlag">, WriteEnumJsonSimple<"EDramaStateFlag">);
static ZHMTypeInfo ZHeroEscortSituation2Entity_EEscortState_TypeInfo = ZHMTypeInfo("ZHeroEscortSituation2Entity.EEscortState", WriteEnumJson<"ZHeroEscortSituation2Entity.EEscortState">, WriteEnumJsonSimple<"ZHeroEscortSituation2Entity.EEscortState">);
static ZHMTypeInfo EActorState_TypeInfo = ZHMTypeInfo("EActorState", WriteEnumJson<"EActorState">, WriteEnumJsonSimple<"EActorState">);
static ZHMTypeInfo SActorSoundDefs_EDefinition_TypeInfo = ZHMTypeInfo("SActorSoundDefs.EDefinition", WriteEnumJson<"SActorSoundDefs.EDefinition">, WriteEnumJsonSimple<"SActorSoundDefs.EDefinition">);
static ZHMTypeInfo ZKeywordCondition_EEvaluationType_TypeInfo = ZHMTypeInfo("ZKeywordCondition.EEvaluationType", WriteEnumJson<"ZKeywordCondition.EEvaluationType">, WriteEnumJsonSimple<"ZKeywordCondition.EEvaluationType">);
static ZHMTypeInfo EBehaviorTreeVariableType_TypeInfo = ZHMTypeInfo("EBehaviorTreeVariableType", WriteEnumJson<"EBehaviorTreeVariableType">, WriteEnumJsonSimple<"EBehaviorTreeVariableType">);
static ZHMTypeInfo EActorPerceptionSensitivity_TypeInfo = ZHMTypeInfo("EActorPerceptionSensitivity", WriteEnumJson<"EActorPerceptionSensitivity">, WriteEnumJsonSimple<"EActorPerceptionSensitivity">);
static ZHMTypeInfo ECharacterStateTransitionAttempt_TypeInfo = ZHMTypeInfo("ECharacterStateTransitionAttempt", WriteEnumJson<"ECharacterStateTransitionAttempt">, WriteEnumJsonSimple<"ECharacterStateTransitionAttempt">);
static ZHMTypeInfo ETakeDownState_TypeInfo = ZHMTypeInfo("ETakeDownState", WriteEnumJson<"ETakeDownState">, WriteEnumJsonSimple<"ETakeDownState">);
static ZHMTypeInfo ESequencePreviewState_TypeInfo = ZHMTypeInfo("ESequencePreviewState", WriteEnumJson<"ESequencePreviewState">, WriteEnumJsonSimple<"ESequencePreviewState">);
static ZHMTypeInfo ECameraState_TypeInfo = ZHMTypeInfo("ECameraState", WriteEnumJson<"ECameraState">, WriteEnumJsonSimple<"ECameraState">);
static ZHMTypeInfo IContractObjective_ObjectiveType_TypeInfo = ZHMTypeInfo("IContractObjective.ObjectiveType", WriteEnumJson<"IContractObjective.ObjectiveType">, WriteEnumJsonSimple<"IContractObjective.ObjectiveType">);
static ZHMTypeInfo ZAISoundEvent_ELoudness_TypeInfo = ZHMTypeInfo("ZAISoundEvent.ELoudness", WriteEnumJson<"ZAISoundEvent.ELoudness">, WriteEnumJsonSimple<"ZAISoundEvent.ELoudness">);
static ZHMTypeInfo ZStandOffSituation_ESituationState_TypeInfo = ZHMTypeInfo("ZStandOffSituation.ESituationState", WriteEnumJson<"ZStandOffSituation.ESituationState">, WriteEnumJsonSimple<"ZStandOffSituation.ESituationState">);
static ZHMTypeInfo ECppTypeFlags_TypeInfo = ZHMTypeInfo("ECppTypeFlags", WriteEnumJson<"ECppTypeFlags">, WriteEnumJsonSimple<"ECppTypeFlags">);
static ZHMTypeInfo ESynchronisedActionState_TypeInfo = ZHMTypeInfo("ESynchronisedActionState", WriteEnumJson<"ESynchronisedActionState">, WriteEnumJsonSimple<"ESynchronisedActionState">);
static ZHMTypeInfo EInventoryConfigItemHandling_TypeInfo = ZHMTypeInfo("EInventoryConfigItemHandling", WriteEnumJson<"EInventoryConfigItemHandling">, WriteEnumJsonSimple<"EInventoryConfigItemHandling">);
static ZHMTypeInfo ZUISubtitleDataProvider_EAlignment_TypeInfo = ZHMTypeInfo("ZUISubtitleDataProvider.EAlignment", WriteEnumJson<"ZUISubtitleDataProvider.EAlignment">, WriteEnumJsonSimple<"ZUISubtitleDataProvider.EAlignment">);
static ZHMTypeInfo ECollidableLayer_TypeInfo = ZHMTypeInfo("ECollidableLayer", WriteEnumJson<"ECollidableLayer">, WriteEnumJsonSimple<"ECollidableLayer">);
static ZHMTypeInfo EGSKillVictim_TypeInfo = ZHMTypeInfo("EGSKillVictim", WriteEnumJson<"EGSKillVictim">, WriteEnumJsonSimple<"EGSKillVictim">);
static ZHMTypeInfo IContractEvaluationContextListener_EListenerType_TypeInfo = ZHMTypeInfo("IContractEvaluationContextListener.EListenerType", WriteEnumJson<"IContractEvaluationContextListener.EListenerType">, WriteEnumJsonSimple<"IContractEvaluationContextListener.EListenerType">);
static ZHMTypeInfo IRenderCompositorEntity_EMode_TypeInfo = ZHMTypeInfo("IRenderCompositorEntity.EMode", WriteEnumJson<"IRenderCompositorEntity.EMode">, WriteEnumJsonSimple<"IRenderCompositorEntity.EMode">);
static ZHMTypeInfo ZActorKnowledgeCondition_EEvaluationType_TypeInfo = ZHMTypeInfo("ZActorKnowledgeCondition.EEvaluationType", WriteEnumJson<"ZActorKnowledgeCondition.EEvaluationType">, WriteEnumJsonSimple<"ZActorKnowledgeCondition.EEvaluationType">);
static ZHMTypeInfo IHM5Door_EOpenMode_TypeInfo = ZHMTypeInfo("IHM5Door.EOpenMode", WriteEnumJson<"IHM5Door.EOpenMode">, WriteEnumJsonSimple<"IHM5Door.EOpenMode">);
static ZHMTypeInfo EHeroGameState_TypeInfo = ZHMTypeInfo("EHeroGameState", WriteEnumJson<"EHeroGameState">, WriteEnumJsonSimple<"EHeroGameState">);
static ZHMTypeInfo EMarkerInclusionMode_TypeInfo = ZHMTypeInfo("EMarkerInclusionMode", WriteEnumJson<"EMarkerInclusionMode">, WriteEnumJsonSimple<"EMarkerInclusionMode">);
static ZHMTypeInfo ZHM5ItemInteractionEventConsumer_EHM5SoundItemInteractionEvent_TypeInfo = ZHMTypeInfo("ZHM5ItemInteractionEventConsumer.EHM5SoundItemInteractionEvent", WriteEnumJson<"ZHM5ItemInteractionEventConsumer.EHM5SoundItemInteractionEvent">, WriteEnumJsonSimple<"ZHM5ItemInteractionEventConsumer.EHM5SoundItemInteractionEvent">);
static ZHMTypeInfo ETargetType_TypeInfo = ZHMTypeInfo("ETargetType", WriteEnumJson<"ETargetType">, WriteEnumJsonSimple<"ETargetType">);
static ZHMTypeInfo ETessellationFactorMode_TypeInfo = ZHMTypeInfo("ETessellationFactorMode", WriteEnumJson<"ETessellationFactorMode">, WriteEnumJsonSimple<"ETessellationFactorMode">);
static ZHMTypeInfo ZHM5GenericEventConsumer_EEvent_TypeInfo = ZHMTypeInfo("ZHM5GenericEventConsumer.EEvent", WriteEnumJson<"ZHM5GenericEventConsumer.EEvent">, WriteEnumJsonSimple<"ZHM5GenericEventConsumer.EEvent">);
static ZHMTypeInfo EActorBumpType_TypeInfo = ZHMTypeInfo("EActorBumpType", WriteEnumJson<"EActorBumpType">, WriteEnumJsonSimple<"EActorBumpType">);
static ZHMTypeInfo ETimerEntityCommandType_TypeInfo = ZHMTypeInfo("ETimerEntityCommandType", WriteEnumJson<"ETimerEntityCommandType">, WriteEnumJsonSimple<"ETimerEntityCommandType">);
static ZHMTypeInfo ZValueInt_Comparator_Poll_EEvaluationType_TypeInfo = ZHMTypeInfo("ZValueInt_Comparator_Poll.EEvaluationType", WriteEnumJson<"ZValueInt_Comparator_Poll.EEvaluationType">, WriteEnumJsonSimple<"ZValueInt_Comparator_Poll.EEvaluationType">);
static ZHMTypeInfo EHM5SoundFootstepStance_TypeInfo = ZHMTypeInfo("EHM5SoundFootstepStance", WriteEnumJson<"EHM5SoundFootstepStance">, WriteEnumJsonSimple<"EHM5SoundFootstepStance">);
static ZHMTypeInfo EGestureCategory_TypeInfo = ZHMTypeInfo("EGestureCategory", WriteEnumJson<"EGestureCategory">, WriteEnumJsonSimple<"EGestureCategory">);
static ZHMTypeInfo eWeaponOperation_TypeInfo = ZHMTypeInfo("eWeaponOperation", WriteEnumJson<"eWeaponOperation">, WriteEnumJsonSimple<"eWeaponOperation">);
static ZHMTypeInfo ERayDetailLevel_TypeInfo = ZHMTypeInfo("ERayDetailLevel", WriteEnumJson<"ERayDetailLevel">, WriteEnumJsonSimple<"ERayDetailLevel">);
static ZHMTypeInfo EVictimMovementType_TypeInfo = ZHMTypeInfo("EVictimMovementType", WriteEnumJson<"EVictimMovementType">, WriteEnumJsonSimple<"EVictimMovementType">);
static ZHMTypeInfo ZHM5WeaponBasicConfigEntity_EWeaponBasicConfigAudioImpactType_TypeInfo = ZHMTypeInfo("ZHM5WeaponBasicConfigEntity.EWeaponBasicConfigAudioImpactType", WriteEnumJson<"ZHM5WeaponBasicConfigEntity.EWeaponBasicConfigAudioImpactType">, WriteEnumJsonSimple<"ZHM5WeaponBasicConfigEntity.EWeaponBasicConfigAudioImpactType">);
static ZHMTypeInfo ECameraShakerChannel_TypeInfo = ZHMTypeInfo("ECameraShakerChannel", WriteEnumJson<"ECameraShakerChannel">, WriteEnumJsonSimple<"ECameraShakerChannel">);
static ZHMTypeInfo CrowdUtil_ECrowdActorMood_TypeInfo = ZHMTypeInfo("CrowdUtil.ECrowdActorMood", WriteEnumJson<"CrowdUtil.ECrowdActorMood">, WriteEnumJsonSimple<"CrowdUtil.ECrowdActorMood">);
static ZHMTypeInfo EItemLocation_TypeInfo = ZHMTypeInfo("EItemLocation", WriteEnumJson<"EItemLocation">, WriteEnumJsonSimple<"EItemLocation">);
static ZHMTypeInfo ESituationType_TypeInfo = ZHMTypeInfo("ESituationType", WriteEnumJson<"ESituationType">, WriteEnumJsonSimple<"ESituationType">);
static ZHMTypeInfo ZContextKillGuide_EContextKillType_TypeInfo = ZHMTypeInfo("ZContextKillGuide.EContextKillType", WriteEnumJson<"ZContextKillGuide.EContextKillType">, WriteEnumJsonSimple<"ZContextKillGuide.EContextKillType">);
static ZHMTypeInfo MenuWeaponUpgradeData_EUpgradeAction_TypeInfo = ZHMTypeInfo("MenuWeaponUpgradeData.EUpgradeAction", WriteEnumJson<"MenuWeaponUpgradeData.EUpgradeAction">, WriteEnumJsonSimple<"MenuWeaponUpgradeData.EUpgradeAction">);
static ZHMTypeInfo ZUIPerformanceTestMetricsCollectorEntity_EVsyncPolicy_TypeInfo = ZHMTypeInfo("ZUIPerformanceTestMetricsCollectorEntity.EVsyncPolicy", WriteEnumJson<"ZUIPerformanceTestMetricsCollectorEntity.EVsyncPolicy">, WriteEnumJsonSimple<"ZUIPerformanceTestMetricsCollectorEntity.EVsyncPolicy">);
static ZHMTypeInfo EBoolStateRequirement_TypeInfo = ZHMTypeInfo("EBoolStateRequirement", WriteEnumJson<"EBoolStateRequirement">, WriteEnumJsonSimple<"EBoolStateRequirement">);
static ZHMTypeInfo EIntelType_TypeInfo = ZHMTypeInfo("EIntelType", WriteEnumJson<"EIntelType">, WriteEnumJsonSimple<"EIntelType">);
static ZHMTypeInfo EMultiplayerLobbyRequestType_TypeInfo = ZHMTypeInfo("EMultiplayerLobbyRequestType", WriteEnumJson<"EMultiplayerLobbyRequestType">, WriteEnumJsonSimple<"EMultiplayerLobbyRequestType">);
static ZHMTypeInfo ERayLayer_TypeInfo = ZHMTypeInfo("ERayLayer", WriteEnumJson<"ERayLayer">, WriteEnumJsonSimple<"ERayLayer">);
static ZHMTypeInfo EExclusionLayer_TypeInfo = ZHMTypeInfo("EExclusionLayer", WriteEnumJson<"EExclusionLayer">, WriteEnumJsonSimple<"EExclusionLayer">);
static ZHMTypeInfo ZHeroEscortSituationEntity_EEscortState_TypeInfo = ZHMTypeInfo("ZHeroEscortSituationEntity.EEscortState", WriteEnumJson<"ZHeroEscortSituationEntity.EEscortState">, WriteEnumJsonSimple<"ZHeroEscortSituationEntity.EEscortState">);
static ZHMTypeInfo EConversationRole_TypeInfo = ZHMTypeInfo("EConversationRole", WriteEnumJson<"EConversationRole">, WriteEnumJsonSimple<"EConversationRole">);
static ZHMTypeInfo AudioEventCullingBehavior_TypeInfo = ZHMTypeInfo("AudioEventCullingBehavior", WriteEnumJson<"AudioEventCullingBehavior">, WriteEnumJsonSimple<"AudioEventCullingBehavior">);
static ZHMTypeInfo Network_PacketPriority_TypeInfo = ZHMTypeInfo("Network.PacketPriority", WriteEnumJson<"Network.PacketPriority">, WriteEnumJsonSimple<"Network.PacketPriority">);
static ZHMTypeInfo EReplicaMode_TypeInfo = ZHMTypeInfo("EReplicaMode", WriteEnumJson<"EReplicaMode">, WriteEnumJsonSimple<"EReplicaMode">);
static ZHMTypeInfo ZValueInt_Comparator_EEvaluationType_TypeInfo = ZHMTypeInfo("ZValueInt_Comparator.EEvaluationType", WriteEnumJson<"ZValueInt_Comparator.EEvaluationType">, WriteEnumJsonSimple<"ZValueInt_Comparator.EEvaluationType">);
static ZHMTypeInfo ZSpatialEntity_ERoomBehaviour_TypeInfo = ZHMTypeInfo("ZSpatialEntity.ERoomBehaviour", WriteEnumJson<"ZSpatialEntity.ERoomBehaviour">, WriteEnumJsonSimple<"ZSpatialEntity.ERoomBehaviour">);
static ZHMTypeInfo ZOnlineManager_EError_TypeInfo = ZHMTypeInfo("ZOnlineManager.EError", WriteEnumJson<"ZOnlineManager.EError">, WriteEnumJsonSimple<"ZOnlineManager.EError">);
static ZHMTypeInfo EDetachUsage_TypeInfo = ZHMTypeInfo("EDetachUsage", WriteEnumJson<"EDetachUsage">, WriteEnumJsonSimple<"EDetachUsage">);
static ZHMTypeInfo ZActorPicker_EKeywordEvaluationType_TypeInfo = ZHMTypeInfo("ZActorPicker.EKeywordEvaluationType", WriteEnumJson<"ZActorPicker.EKeywordEvaluationType">, WriteEnumJsonSimple<"ZActorPicker.EKeywordEvaluationType">);
static ZHMTypeInfo EDestructibleInteractionType_TypeInfo = ZHMTypeInfo("EDestructibleInteractionType", WriteEnumJson<"EDestructibleInteractionType">, WriteEnumJsonSimple<"EDestructibleInteractionType">);
static ZHMTypeInfo EGameEventType_TypeInfo = ZHMTypeInfo("EGameEventType", WriteEnumJson<"EGameEventType">, WriteEnumJsonSimple<"EGameEventType">);
static ZHMTypeInfo EPhysicsObjectType_TypeInfo = ZHMTypeInfo("EPhysicsObjectType", WriteEnumJson<"EPhysicsObjectType">, WriteEnumJsonSimple<"EPhysicsObjectType">);
static ZHMTypeInfo eParticleEmitterMeshEntity_SpawnModes_TypeInfo = ZHMTypeInfo("eParticleEmitterMeshEntity_SpawnModes", WriteEnumJson<"eParticleEmitterMeshEntity_SpawnModes">, WriteEnumJsonSimple<"eParticleEmitterMeshEntity_SpawnModes">);
static ZHMTypeInfo eWeaponType_TypeInfo = ZHMTypeInfo("eWeaponType", WriteEnumJson<"eWeaponType">, WriteEnumJsonSimple<"eWeaponType">);
static ZHMTypeInfo ERatingTitle_TypeInfo = ZHMTypeInfo("ERatingTitle", WriteEnumJson<"ERatingTitle">, WriteEnumJsonSimple<"ERatingTitle">);
static ZHMTypeInfo ECameraControls_TypeInfo = ZHMTypeInfo("ECameraControls", WriteEnumJson<"ECameraControls">, WriteEnumJsonSimple<"ECameraControls">);
static ZHMTypeInfo ECollidableShape_TypeInfo = ZHMTypeInfo("ECollidableShape", WriteEnumJson<"ECollidableShape">, WriteEnumJsonSimple<"ECollidableShape">);
static ZHMTypeInfo EHM5SoundRicochetType_TypeInfo = ZHMTypeInfo("EHM5SoundRicochetType", WriteEnumJson<"EHM5SoundRicochetType">, WriteEnumJsonSimple<"EHM5SoundRicochetType">);
static ZHMTypeInfo ZUISplashHintDataProviderEntity_ESplashHintType_TypeInfo = ZHMTypeInfo("ZUISplashHintDataProviderEntity.ESplashHintType", WriteEnumJson<"ZUISplashHintDataProviderEntity.ESplashHintType">, WriteEnumJsonSimple<"ZUISplashHintDataProviderEntity.ESplashHintType">);
static ZHMTypeInfo ZHM5GameTimeMultiplierEntity_eTMLDReason_TypeInfo = ZHMTypeInfo("ZHM5GameTimeMultiplierEntity.eTMLDReason", WriteEnumJson<"ZHM5GameTimeMultiplierEntity.eTMLDReason">, WriteEnumJsonSimple<"ZHM5GameTimeMultiplierEntity.eTMLDReason">);
static ZHMTypeInfo ZInteractionEventConsumer_EEvent_TypeInfo = ZHMTypeInfo("ZInteractionEventConsumer.EEvent", WriteEnumJson<"ZInteractionEventConsumer.EEvent">, WriteEnumJsonSimple<"ZInteractionEventConsumer.EEvent">);
static ZHMTypeInfo ZHM5IndicatorManager_EIndicatorType_TypeInfo = ZHMTypeInfo("ZHM5IndicatorManager.EIndicatorType", WriteEnumJson<"ZHM5IndicatorManager.EIndicatorType">, WriteEnumJsonSimple<"ZHM5IndicatorManager.EIndicatorType">);
static ZHMTypeInfo BoneId_Enum_TypeInfo = ZHMTypeInfo("BoneId.Enum", WriteEnumJson<"BoneId.Enum">, WriteEnumJsonSimple<"BoneId.Enum">);
static ZHMTypeInfo ZVsTargetPicker_ETargetSelectionType_TypeInfo = ZHMTypeInfo("ZVsTargetPicker.ETargetSelectionType", WriteEnumJson<"ZVsTargetPicker.ETargetSelectionType">, WriteEnumJsonSimple<"ZVsTargetPicker.ETargetSelectionType">);
static ZHMTypeInfo ZAvoidDangerousAreaGroup_EAvoidDangerousAreaGroupState_TypeInfo = ZHMTypeInfo("ZAvoidDangerousAreaGroup.EAvoidDangerousAreaGroupState", WriteEnumJson<"ZAvoidDangerousAreaGroup.EAvoidDangerousAreaGroupState">, WriteEnumJsonSimple<"ZAvoidDangerousAreaGroup.EAvoidDangerousAreaGroupState">);
static ZHMTypeInfo EActorLookAtTargetType_TypeInfo = ZHMTypeInfo("EActorLookAtTargetType", WriteEnumJson<"EActorLookAtTargetType">, WriteEnumJsonSimple<"EActorLookAtTargetType">);
static ZHMTypeInfo ECustomSoundDefType_TypeInfo = ZHMTypeInfo("ECustomSoundDefType", WriteEnumJson<"ECustomSoundDefType">, WriteEnumJsonSimple<"ECustomSoundDefType">);
static ZHMTypeInfo EWeaponSpecialSituation_TypeInfo = ZHMTypeInfo("EWeaponSpecialSituation", WriteEnumJson<"EWeaponSpecialSituation">, WriteEnumJsonSimple<"EWeaponSpecialSituation">);
static ZHMTypeInfo EAIModifierScope_TypeInfo = ZHMTypeInfo("EAIModifierScope", WriteEnumJson<"EAIModifierScope">, WriteEnumJsonSimple<"EAIModifierScope">);
static ZHMTypeInfo ZHM5WeaponEventConsumer_EAnimWeapon_TypeInfo = ZHMTypeInfo("ZHM5WeaponEventConsumer.EAnimWeapon", WriteEnumJson<"ZHM5WeaponEventConsumer.EAnimWeapon">, WriteEnumJsonSimple<"ZHM5WeaponEventConsumer.EAnimWeapon">);
static ZHMTypeInfo EStashpointContainedEntityType_TypeInfo = ZHMTypeInfo("EStashpointContainedEntityType", WriteEnumJson<"EStashpointContainedEntityType">, WriteEnumJsonSimple<"EStashpointContainedEntityType">);
static ZHMTypeInfo ESoundCollisionType_TypeInfo = ZHMTypeInfo("ESoundCollisionType", WriteEnumJson<"ESoundCollisionType">, WriteEnumJsonSimple<"ESoundCollisionType">);
static ZHMTypeInfo ICloset_EClosetType_TypeInfo = ZHMTypeInfo("ICloset.EClosetType", WriteEnumJson<"ICloset.EClosetType">, WriteEnumJsonSimple<"ICloset.EClosetType">);
static ZHMTypeInfo EHitmanPermissionFlag_TypeInfo = ZHMTypeInfo("EHitmanPermissionFlag", WriteEnumJson<"EHitmanPermissionFlag">, WriteEnumJsonSimple<"EHitmanPermissionFlag">);
static ZHMTypeInfo EActionRadialArcIconType_TypeInfo = ZHMTypeInfo("EActionRadialArcIconType", WriteEnumJson<"EActionRadialArcIconType">, WriteEnumJsonSimple<"EActionRadialArcIconType">);
static ZHMTypeInfo EParticleDecalSpawnEntity_Constraints_TypeInfo = ZHMTypeInfo("EParticleDecalSpawnEntity_Constraints", WriteEnumJson<"EParticleDecalSpawnEntity_Constraints">, WriteEnumJsonSimple<"EParticleDecalSpawnEntity_Constraints">);
static ZHMTypeInfo ZActBehaviorEntity_ERotationAlignment_TypeInfo = ZHMTypeInfo("ZActBehaviorEntity.ERotationAlignment", WriteEnumJson<"ZActBehaviorEntity.ERotationAlignment">, WriteEnumJsonSimple<"ZActBehaviorEntity.ERotationAlignment">);
static ZHMTypeInfo ZPatrolBehaviorEntity_ERotationAlignment_TypeInfo = ZHMTypeInfo("ZPatrolBehaviorEntity.ERotationAlignment", WriteEnumJson<"ZPatrolBehaviorEntity.ERotationAlignment">, WriteEnumJsonSimple<"ZPatrolBehaviorEntity.ERotationAlignment">);
static ZHMTypeInfo EAnimBlendMode_TypeInfo = ZHMTypeInfo("EAnimBlendMode", WriteEnumJson<"EAnimBlendMode">, WriteEnumJsonSimple<"EAnimBlendMode">);
static ZHMTypeInfo ETeamModeId_TypeInfo = ZHMTypeInfo("ETeamModeId", WriteEnumJson<"ETeamModeId">, WriteEnumJsonSimple<"ETeamModeId">);
static ZHMTypeInfo ZUIControlEntity_EScaleMode_TypeInfo = ZHMTypeInfo("ZUIControlEntity.EScaleMode", WriteEnumJson<"ZUIControlEntity.EScaleMode">, WriteEnumJsonSimple<"ZUIControlEntity.EScaleMode">);
static ZHMTypeInfo ZInputListenerActorPool_eInputListenerButtons_TypeInfo = ZHMTypeInfo("ZInputListenerActorPool.eInputListenerButtons", WriteEnumJson<"ZInputListenerActorPool.eInputListenerButtons">, WriteEnumJsonSimple<"ZInputListenerActorPool.eInputListenerButtons">);
static ZHMTypeInfo ERuntimeMemoryAllocationState_TypeInfo = ZHMTypeInfo("ERuntimeMemoryAllocationState", WriteEnumJson<"ERuntimeMemoryAllocationState">, WriteEnumJsonSimple<"ERuntimeMemoryAllocationState">);
static ZHMTypeInfo CrowdRegionType_TypeInfo = ZHMTypeInfo("CrowdRegionType", WriteEnumJson<"CrowdRegionType">, WriteEnumJsonSimple<"CrowdRegionType">);
static ZHMTypeInfo EDramaEventAction_TypeInfo = ZHMTypeInfo("EDramaEventAction", WriteEnumJson<"EDramaEventAction">, WriteEnumJsonSimple<"EDramaEventAction">);
static ZHMTypeInfo ZRecoverUnconsciousGroup_EInvestigateGroupState_TypeInfo = ZHMTypeInfo("ZRecoverUnconsciousGroup.EInvestigateGroupState", WriteEnumJson<"ZRecoverUnconsciousGroup.EInvestigateGroupState">, WriteEnumJsonSimple<"ZRecoverUnconsciousGroup.EInvestigateGroupState">);
static ZHMTypeInfo ECharacterActionRequests_TypeInfo = ZHMTypeInfo("ECharacterActionRequests", WriteEnumJson<"ECharacterActionRequests">, WriteEnumJsonSimple<"ECharacterActionRequests">);
static ZHMTypeInfo ZHM5HIKEventConsumer_EBlend_TypeInfo = ZHMTypeInfo("ZHM5HIKEventConsumer.EBlend", WriteEnumJson<"ZHM5HIKEventConsumer.EBlend">, WriteEnumJsonSimple<"ZHM5HIKEventConsumer.EBlend">);
static ZHMTypeInfo EWeaponUpgradeIcon_TypeInfo = ZHMTypeInfo("EWeaponUpgradeIcon", WriteEnumJson<"EWeaponUpgradeIcon">, WriteEnumJsonSimple<"EWeaponUpgradeIcon">);
static ZHMTypeInfo ECollisionResponse_TypeInfo = ZHMTypeInfo("ECollisionResponse", WriteEnumJson<"ECollisionResponse">, WriteEnumJsonSimple<"ECollisionResponse">);
static ZHMTypeInfo ZDramaSituationEntity_EReentryBehavior_TypeInfo = ZHMTypeInfo("ZDramaSituationEntity.EReentryBehavior", WriteEnumJson<"ZDramaSituationEntity.EReentryBehavior">, WriteEnumJsonSimple<"ZDramaSituationEntity.EReentryBehavior">);
static ZHMTypeInfo IScatterContainerEntity_EResizeMode_TypeInfo = ZHMTypeInfo("IScatterContainerEntity.EResizeMode", WriteEnumJson<"IScatterContainerEntity.EResizeMode">, WriteEnumJsonSimple<"IScatterContainerEntity.EResizeMode">);
static ZHMTypeInfo ZBoneWeightRotationEntity_eRotationAxises_TypeInfo = ZHMTypeInfo("ZBoneWeightRotationEntity.eRotationAxises", WriteEnumJson<"ZBoneWeightRotationEntity.eRotationAxises">, WriteEnumJsonSimple<"ZBoneWeightRotationEntity.eRotationAxises">);
static ZHMTypeInfo EGameTension_TypeInfo = ZHMTypeInfo("EGameTension", WriteEnumJson<"EGameTension">, WriteEnumJsonSimple<"EGameTension">);
static ZHMTypeInfo ERegionMask_TypeInfo = ZHMTypeInfo("ERegionMask", WriteEnumJson<"ERegionMask">, WriteEnumJsonSimple<"ERegionMask">);
static ZHMTypeInfo ECharacterAnimEvent_TypeInfo = ZHMTypeInfo("ECharacterAnimEvent", WriteEnumJson<"ECharacterAnimEvent">, WriteEnumJsonSimple<"ECharacterAnimEvent">);
static ZHMTypeInfo EMatchOverCondition_TypeInfo = ZHMTypeInfo("EMatchOverCondition", WriteEnumJson<"EMatchOverCondition">, WriteEnumJsonSimple<"EMatchOverCondition">);
static ZHMTypeInfo CrowdUtil_ECrowdStandingPush_TypeInfo = ZHMTypeInfo("CrowdUtil.ECrowdStandingPush", WriteEnumJson<"CrowdUtil.ECrowdStandingPush">, WriteEnumJsonSimple<"CrowdUtil.ECrowdStandingPush">);
static ZHMTypeInfo EDialogueLine_TypeInfo = ZHMTypeInfo("EDialogueLine", WriteEnumJson<"EDialogueLine">, WriteEnumJsonSimple<"EDialogueLine">);
static ZHMTypeInfo EPostProcessorComponentType_TypeInfo = ZHMTypeInfo("EPostProcessorComponentType", WriteEnumJson<"EPostProcessorComponentType">, WriteEnumJsonSimple<"EPostProcessorComponentType">);
static ZHMTypeInfo WebSocketUtils_ECloseStatus_TypeInfo = ZHMTypeInfo("WebSocketUtils.ECloseStatus", WriteEnumJson<"WebSocketUtils.ECloseStatus">, WriteEnumJsonSimple<"WebSocketUtils.ECloseStatus">);
static ZHMTypeInfo EControlButtonName_TypeInfo = ZHMTypeInfo("EControlButtonName", WriteEnumJson<"EControlButtonName">, WriteEnumJsonSimple<"EControlButtonName">);
static ZHMTypeInfo ZInvestigateDisguiseGroup_EState_TypeInfo = ZHMTypeInfo("ZInvestigateDisguiseGroup.EState", WriteEnumJson<"ZInvestigateDisguiseGroup.EState">, WriteEnumJsonSimple<"ZInvestigateDisguiseGroup.EState">);
static ZHMTypeInfo ECOMUsage_TypeInfo = ZHMTypeInfo("ECOMUsage", WriteEnumJson<"ECOMUsage">, WriteEnumJsonSimple<"ECOMUsage">);
static ZHMTypeInfo EAIEventType_TypeInfo = ZHMTypeInfo("EAIEventType", WriteEnumJson<"EAIEventType">, WriteEnumJsonSimple<"EAIEventType">);
static ZHMTypeInfo EHM5SoundCloseCombatEvent_TypeInfo = ZHMTypeInfo("EHM5SoundCloseCombatEvent", WriteEnumJson<"EHM5SoundCloseCombatEvent">, WriteEnumJsonSimple<"EHM5SoundCloseCombatEvent">);
static ZHMTypeInfo EVirtualPlatformID_TypeInfo = ZHMTypeInfo("EVirtualPlatformID", WriteEnumJson<"EVirtualPlatformID">, WriteEnumJsonSimple<"EVirtualPlatformID">);
static ZHMTypeInfo eAmmoType_TypeInfo = ZHMTypeInfo("eAmmoType", WriteEnumJson<"eAmmoType">, WriteEnumJsonSimple<"eAmmoType">);
static ZHMTypeInfo ZEntityPropertyReplica_EReplicationStrategy_TypeInfo = ZHMTypeInfo("ZEntityPropertyReplica.EReplicationStrategy", WriteEnumJson<"ZEntityPropertyReplica.EReplicationStrategy">, WriteEnumJsonSimple<"ZEntityPropertyReplica.EReplicationStrategy">);
static ZHMTypeInfo ZApproachOrder_EApproachStyle_TypeInfo = ZHMTypeInfo("ZApproachOrder.EApproachStyle", WriteEnumJson<"ZApproachOrder.EApproachStyle">, WriteEnumJsonSimple<"ZApproachOrder.EApproachStyle">);
static ZHMTypeInfo ZInvestigateCautiousSituation_EBystanderState_TypeInfo = ZHMTypeInfo("ZInvestigateCautiousSituation.EBystanderState", WriteEnumJson<"ZInvestigateCautiousSituation.EBystanderState">, WriteEnumJsonSimple<"ZInvestigateCautiousSituation.EBystanderState">);
static ZHMTypeInfo ZSmuggleSituationEntity_ESmuggleState_TypeInfo = ZHMTypeInfo("ZSmuggleSituationEntity.ESmuggleState", WriteEnumJson<"ZSmuggleSituationEntity.ESmuggleState">, WriteEnumJsonSimple<"ZSmuggleSituationEntity.ESmuggleState">);
static ZHMTypeInfo ZSniperCombatSituation_ESituationState_TypeInfo = ZHMTypeInfo("ZSniperCombatSituation.ESituationState", WriteEnumJson<"ZSniperCombatSituation.ESituationState">, WriteEnumJsonSimple<"ZSniperCombatSituation.ESituationState">);
static ZHMTypeInfo EOnlineEventInvestigationType_TypeInfo = ZHMTypeInfo("EOnlineEventInvestigationType", WriteEnumJson<"EOnlineEventInvestigationType">, WriteEnumJsonSimple<"EOnlineEventInvestigationType">);
static ZHMTypeInfo IItemWeapon_EDeadlyThrowType_TypeInfo = ZHMTypeInfo("IItemWeapon.EDeadlyThrowType", WriteEnumJson<"IItemWeapon.EDeadlyThrowType">, WriteEnumJsonSimple<"IItemWeapon.EDeadlyThrowType">);
static ZHMTypeInfo EValueUpdateStrategy_TypeInfo = ZHMTypeInfo("EValueUpdateStrategy", WriteEnumJson<"EValueUpdateStrategy">, WriteEnumJsonSimple<"EValueUpdateStrategy">);
static ZHMTypeInfo ZEscortSituationEntity_ETargetState_TypeInfo = ZHMTypeInfo("ZEscortSituationEntity.ETargetState", WriteEnumJson<"ZEscortSituationEntity.ETargetState">, WriteEnumJsonSimple<"ZEscortSituationEntity.ETargetState">);
static ZHMTypeInfo IRenderCompositorEntity_EViewportAnchor_TypeInfo = ZHMTypeInfo("IRenderCompositorEntity.EViewportAnchor", WriteEnumJson<"IRenderCompositorEntity.EViewportAnchor">, WriteEnumJsonSimple<"IRenderCompositorEntity.EViewportAnchor">);
static ZHMTypeInfo ECoverPosition_TypeInfo = ZHMTypeInfo("ECoverPosition", WriteEnumJson<"ECoverPosition">, WriteEnumJsonSimple<"ECoverPosition">);
static ZHMTypeInfo EAgilityState_TypeInfo = ZHMTypeInfo("EAgilityState", WriteEnumJson<"EAgilityState">, WriteEnumJsonSimple<"EAgilityState">);
static ZHMTypeInfo SUITestData_ETestEnum_TypeInfo = ZHMTypeInfo("SUITestData.ETestEnum", WriteEnumJson<"SUITestData.ETestEnum">, WriteEnumJsonSimple<"SUITestData.ETestEnum">);
static ZHMTypeInfo EVRConfigCinemaMode_TypeInfo = ZHMTypeInfo("EVRConfigCinemaMode", WriteEnumJson<"EVRConfigCinemaMode">, WriteEnumJsonSimple<"EVRConfigCinemaMode">);
static ZHMTypeInfo EOutfitType_TypeInfo = ZHMTypeInfo("EOutfitType", WriteEnumJson<"EOutfitType">, WriteEnumJsonSimple<"EOutfitType">);
static ZHMTypeInfo ZActorTensionEntity_ETensionCheckMode_TypeInfo = ZHMTypeInfo("ZActorTensionEntity.ETensionCheckMode", WriteEnumJson<"ZActorTensionEntity.ETensionCheckMode">, WriteEnumJsonSimple<"ZActorTensionEntity.ETensionCheckMode">);
static ZHMTypeInfo EUbitusRequest_TypeInfo = ZHMTypeInfo("EUbitusRequest", WriteEnumJson<"EUbitusRequest">, WriteEnumJsonSimple<"EUbitusRequest">);
static ZHMTypeInfo ZScreenplay_EState_TypeInfo = ZHMTypeInfo("ZScreenplay.EState", WriteEnumJson<"ZScreenplay.EState">, WriteEnumJsonSimple<"ZScreenplay.EState">);
static ZHMTypeInfo EDifficultyParameter_TypeInfo = ZHMTypeInfo("EDifficultyParameter", WriteEnumJson<"EDifficultyParameter">, WriteEnumJsonSimple<"EDifficultyParameter">);
static ZHMTypeInfo ZInputListenerButtonEntity_eInputListenerButtons_TypeInfo = ZHMTypeInfo("ZInputListenerButtonEntity.eInputListenerButtons", WriteEnumJson<"ZInputListenerButtonEntity.eInputListenerButtons">, WriteEnumJsonSimple<"ZInputListenerButtonEntity.eInputListenerButtons">);
static ZHMTypeInfo EEquipAbility_TypeInfo = ZHMTypeInfo("EEquipAbility", WriteEnumJson<"EEquipAbility">, WriteEnumJsonSimple<"EEquipAbility">);
static ZHMTypeInfo EAISituationEvent_TypeInfo = ZHMTypeInfo("EAISituationEvent", WriteEnumJson<"EAISituationEvent">, WriteEnumJsonSimple<"EAISituationEvent">);
static ZHMTypeInfo ZLeadEscortSituationEntity_EEscortState_TypeInfo = ZHMTypeInfo("ZLeadEscortSituationEntity.EEscortState", WriteEnumJson<"ZLeadEscortSituationEntity.EEscortState">, WriteEnumJsonSimple<"ZLeadEscortSituationEntity.EEscortState">);
static ZHMTypeInfo ZSniperCombatGroup_EGroupState_TypeInfo = ZHMTypeInfo("ZSniperCombatGroup.EGroupState", WriteEnumJson<"ZSniperCombatGroup.EGroupState">, WriteEnumJsonSimple<"ZSniperCombatGroup.EGroupState">);
static ZHMTypeInfo EVolumeTriggerEntityTypeFlags_TypeInfo = ZHMTypeInfo("EVolumeTriggerEntityTypeFlags", WriteEnumJson<"EVolumeTriggerEntityTypeFlags">, WriteEnumJsonSimple<"EVolumeTriggerEntityTypeFlags">);
static ZHMTypeInfo ZSetUIControlDisplayInfoEntity_EVisibilityOp_TypeInfo = ZHMTypeInfo("ZSetUIControlDisplayInfoEntity.EVisibilityOp", WriteEnumJson<"ZSetUIControlDisplayInfoEntity.EVisibilityOp">, WriteEnumJsonSimple<"ZSetUIControlDisplayInfoEntity.EVisibilityOp">);
static ZHMTypeInfo EActionPromptState_TypeInfo = ZHMTypeInfo("EActionPromptState", WriteEnumJson<"EActionPromptState">, WriteEnumJsonSimple<"EActionPromptState">);
static ZHMTypeInfo ZMoveToPositionBehaviorEntity_ERotationAlignment_TypeInfo = ZHMTypeInfo("ZMoveToPositionBehaviorEntity.ERotationAlignment", WriteEnumJson<"ZMoveToPositionBehaviorEntity.ERotationAlignment">, WriteEnumJsonSimple<"ZMoveToPositionBehaviorEntity.ERotationAlignment">);
static ZHMTypeInfo ESaveType_TypeInfo = ZHMTypeInfo("ESaveType", WriteEnumJson<"ESaveType">, WriteEnumJsonSimple<"ESaveType">);
static ZHMTypeInfo ZHM5WeaponBasicConfigEntity_EWeaponBasicConfigAudioFireType_TypeInfo = ZHMTypeInfo("ZHM5WeaponBasicConfigEntity.EWeaponBasicConfigAudioFireType", WriteEnumJson<"ZHM5WeaponBasicConfigEntity.EWeaponBasicConfigAudioFireType">, WriteEnumJsonSimple<"ZHM5WeaponBasicConfigEntity.EWeaponBasicConfigAudioFireType">);
static ZHMTypeInfo EButtonPressType_TypeInfo = ZHMTypeInfo("EButtonPressType", WriteEnumJson<"EButtonPressType">, WriteEnumJsonSimple<"EButtonPressType">);
static ZHMTypeInfo EImpactEffectsOptions_TypeInfo = ZHMTypeInfo("EImpactEffectsOptions", WriteEnumJson<"EImpactEffectsOptions">, WriteEnumJsonSimple<"EImpactEffectsOptions">);
static ZHMTypeInfo EBooleanOption_TypeInfo = ZHMTypeInfo("EBooleanOption", WriteEnumJson<"EBooleanOption">, WriteEnumJsonSimple<"EBooleanOption">);
static ZHMTypeInfo EStandRepositionStrategy_TypeInfo = ZHMTypeInfo("EStandRepositionStrategy", WriteEnumJson<"EStandRepositionStrategy">, WriteEnumJsonSimple<"EStandRepositionStrategy">);
static ZHMTypeInfo ZLookAtLogic_EAxisSelect_TypeInfo = ZHMTypeInfo("ZLookAtLogic.EAxisSelect", WriteEnumJson<"ZLookAtLogic.EAxisSelect">, WriteEnumJsonSimple<"ZLookAtLogic.EAxisSelect">);
static ZHMTypeInfo ESituationStateChangeReason_TypeInfo = ZHMTypeInfo("ESituationStateChangeReason", WriteEnumJson<"ESituationStateChangeReason">, WriteEnumJsonSimple<"ESituationStateChangeReason">);
static ZHMTypeInfo EMaterialRegistrationState_TypeInfo = ZHMTypeInfo("EMaterialRegistrationState", WriteEnumJson<"EMaterialRegistrationState">, WriteEnumJsonSimple<"EMaterialRegistrationState">);
static ZHMTypeInfo ZRenderPostfilterParametersEntity_EDOFBlurType_TypeInfo = ZHMTypeInfo("ZRenderPostfilterParametersEntity.EDOFBlurType", WriteEnumJson<"ZRenderPostfilterParametersEntity.EDOFBlurType">, WriteEnumJsonSimple<"ZRenderPostfilterParametersEntity.EDOFBlurType">);
static ZHMTypeInfo CrowdReactionAIEventType_TypeInfo = ZHMTypeInfo("CrowdReactionAIEventType", WriteEnumJson<"CrowdReactionAIEventType">, WriteEnumJsonSimple<"CrowdReactionAIEventType">);
static ZHMTypeInfo ZHeroEscortSituationEntity_ETargetState_TypeInfo = ZHMTypeInfo("ZHeroEscortSituationEntity.ETargetState", WriteEnumJson<"ZHeroEscortSituationEntity.ETargetState">, WriteEnumJsonSimple<"ZHeroEscortSituationEntity.ETargetState">);
static ZHMTypeInfo ZHitmanLocomotionQuery_EEvaluationType_TypeInfo = ZHMTypeInfo("ZHitmanLocomotionQuery.EEvaluationType", WriteEnumJson<"ZHitmanLocomotionQuery.EEvaluationType">, WriteEnumJsonSimple<"ZHitmanLocomotionQuery.EEvaluationType">);
static ZHMTypeInfo CrowdUtil_EDefaultStateTypes_TypeInfo = ZHMTypeInfo("CrowdUtil.EDefaultStateTypes", WriteEnumJson<"CrowdUtil.EDefaultStateTypes">, WriteEnumJsonSimple<"CrowdUtil.EDefaultStateTypes">);
static ZHMTypeInfo ZAIPerceptibleEntity_EReactionBehaviorMode_TypeInfo = ZHMTypeInfo("ZAIPerceptibleEntity.EReactionBehaviorMode", WriteEnumJson<"ZAIPerceptibleEntity.EReactionBehaviorMode">, WriteEnumJsonSimple<"ZAIPerceptibleEntity.EReactionBehaviorMode">);
static ZHMTypeInfo EGameEventArgType_TypeInfo = ZHMTypeInfo("EGameEventArgType", WriteEnumJson<"EGameEventArgType">, WriteEnumJsonSimple<"EGameEventArgType">);
static ZHMTypeInfo ZCautiousSearchGroup_ESearchGroupState_TypeInfo = ZHMTypeInfo("ZCautiousSearchGroup.ESearchGroupState", WriteEnumJson<"ZCautiousSearchGroup.ESearchGroupState">, WriteEnumJsonSimple<"ZCautiousSearchGroup.ESearchGroupState">);
static ZHMTypeInfo EVRConfigRotationType_TypeInfo = ZHMTypeInfo("EVRConfigRotationType", WriteEnumJson<"EVRConfigRotationType">, WriteEnumJsonSimple<"EVRConfigRotationType">);
static ZHMTypeInfo IRoomEntity_EReasoningGridImportance_TypeInfo = ZHMTypeInfo("IRoomEntity.EReasoningGridImportance", WriteEnumJson<"IRoomEntity.EReasoningGridImportance">, WriteEnumJsonSimple<"IRoomEntity.EReasoningGridImportance">);
static ZHMTypeInfo EFSMInternalEvent_TypeInfo = ZHMTypeInfo("EFSMInternalEvent", WriteEnumJson<"EFSMInternalEvent">, WriteEnumJsonSimple<"EFSMInternalEvent">);
static ZHMTypeInfo ZOnlineManager_EState_TypeInfo = ZHMTypeInfo("ZOnlineManager.EState", WriteEnumJson<"ZOnlineManager.EState">, WriteEnumJsonSimple<"ZOnlineManager.EState">);
static ZHMTypeInfo ZDebugHM5GameTimeMultiplierEnt_eTMLDReason_TypeInfo = ZHMTypeInfo("ZDebugHM5GameTimeMultiplierEnt.eTMLDReason", WriteEnumJson<"ZDebugHM5GameTimeMultiplierEnt.eTMLDReason">, WriteEnumJsonSimple<"ZDebugHM5GameTimeMultiplierEnt.eTMLDReason">);
static ZHMTypeInfo ECautiousDisturbanceState_TypeInfo = ZHMTypeInfo("ECautiousDisturbanceState", WriteEnumJson<"ECautiousDisturbanceState">, WriteEnumJsonSimple<"ECautiousDisturbanceState">);
static ZHMTypeInfo ZValueBool_Operation_EEvaluationType_TypeInfo = ZHMTypeInfo("ZValueBool_Operation.EEvaluationType", WriteEnumJson<"ZValueBool_Operation.EEvaluationType">, WriteEnumJsonSimple<"ZValueBool_Operation.EEvaluationType">);
static ZHMTypeInfo IContractObjective_SCounterData_ECounterType_TypeInfo = ZHMTypeInfo("IContractObjective.SCounterData.ECounterType", WriteEnumJson<"IContractObjective.SCounterData.ECounterType">, WriteEnumJsonSimple<"IContractObjective.SCounterData.ECounterType">);
static ZHMTypeInfo ECCNodeType_TypeInfo = ZHMTypeInfo("ECCNodeType", WriteEnumJson<"ECCNodeType">, WriteEnumJsonSimple<"ECCNodeType">);
static ZHMTypeInfo ZHM5CrowdGenericEventConsumer_EEvent_TypeInfo = ZHMTypeInfo("ZHM5CrowdGenericEventConsumer.EEvent", WriteEnumJson<"ZHM5CrowdGenericEventConsumer.EEvent">, WriteEnumJsonSimple<"ZHM5CrowdGenericEventConsumer.EEvent">);
static ZHMTypeInfo EFontFlags_TypeInfo = ZHMTypeInfo("EFontFlags", WriteEnumJson<"EFontFlags">, WriteEnumJsonSimple<"EFontFlags">);
static ZHMTypeInfo EDeathBehavior_TypeInfo = ZHMTypeInfo("EDeathBehavior", WriteEnumJson<"EDeathBehavior">, WriteEnumJsonSimple<"EDeathBehavior">);
static ZHMTypeInfo CrowdMapImpl_CellFlags_TypeInfo = ZHMTypeInfo("CrowdMapImpl.CellFlags", WriteEnumJson<"CrowdMapImpl.CellFlags">, WriteEnumJsonSimple<"CrowdMapImpl.CellFlags">);
static ZHMTypeInfo ZBoneAttachEntity_EResetMode_TypeInfo = ZHMTypeInfo("ZBoneAttachEntity.EResetMode", WriteEnumJson<"ZBoneAttachEntity.EResetMode">, WriteEnumJsonSimple<"ZBoneAttachEntity.EResetMode">);
static ZHMTypeInfo EAIModifiers_TypeInfo = ZHMTypeInfo("EAIModifiers", WriteEnumJson<"EAIModifiers">, WriteEnumJsonSimple<"EAIModifiers">);
static ZHMTypeInfo ESoundGateType_TypeInfo = ZHMTypeInfo("ESoundGateType", WriteEnumJson<"ESoundGateType">, WriteEnumJsonSimple<"ESoundGateType">);
static ZHMTypeInfo ZVRCameraEntity_ETurnMode_TypeInfo = ZHMTypeInfo("ZVRCameraEntity.ETurnMode", WriteEnumJson<"ZVRCameraEntity.ETurnMode">, WriteEnumJsonSimple<"ZVRCameraEntity.ETurnMode">);
static ZHMTypeInfo ZChannelKeywordCondition_EEvaluationType_TypeInfo = ZHMTypeInfo("ZChannelKeywordCondition.EEvaluationType", WriteEnumJson<"ZChannelKeywordCondition.EEvaluationType">, WriteEnumJsonSimple<"ZChannelKeywordCondition.EEvaluationType">);
static ZHMTypeInfo ZUIFlowLayoutEntity_EFlowType_TypeInfo = ZHMTypeInfo("ZUIFlowLayoutEntity.EFlowType", WriteEnumJson<"ZUIFlowLayoutEntity.EFlowType">, WriteEnumJsonSimple<"ZUIFlowLayoutEntity.EFlowType">);
static ZHMTypeInfo ZTrackDollyControllerQueryEntity_ETrackPointQueryType_TypeInfo = ZHMTypeInfo("ZTrackDollyControllerQueryEntity.ETrackPointQueryType", WriteEnumJson<"ZTrackDollyControllerQueryEntity.ETrackPointQueryType">, WriteEnumJsonSimple<"ZTrackDollyControllerQueryEntity.ETrackPointQueryType">);
static ZHMTypeInfo ESubcontrollerInventorySlot_TypeInfo = ZHMTypeInfo("ESubcontrollerInventorySlot", WriteEnumJson<"ESubcontrollerInventorySlot">, WriteEnumJsonSimple<"ESubcontrollerInventorySlot">);
static ZHMTypeInfo IHM5Door_EInitialState_TypeInfo = ZHMTypeInfo("IHM5Door.EInitialState", WriteEnumJson<"IHM5Door.EInitialState">, WriteEnumJsonSimple<"IHM5Door.EInitialState">);
static ZHMTypeInfo EActionType_TypeInfo = ZHMTypeInfo("EActionType", WriteEnumJson<"EActionType">, WriteEnumJsonSimple<"EActionType">);
static ZHMTypeInfo ERANDOM_DISTRIBUTION_TypeInfo = ZHMTypeInfo("ERANDOM_DISTRIBUTION", WriteEnumJson<"ERANDOM_DISTRIBUTION">, WriteEnumJsonSimple<"ERANDOM_DISTRIBUTION">);
static ZHMTypeInfo InputControlNamesp_eHM5InputActionType_TypeInfo = ZHMTypeInfo("InputControlNamesp.eHM5InputActionType", WriteEnumJson<"InputControlNamesp.eHM5InputActionType">, WriteEnumJsonSimple<"InputControlNamesp.eHM5InputActionType">);
static ZHMTypeInfo ERatingCategory_TypeInfo = ZHMTypeInfo("ERatingCategory", WriteEnumJson<"ERatingCategory">, WriteEnumJsonSimple<"ERatingCategory">);
static ZHMTypeInfo EDebugSpatialInfoVerbosity_TypeInfo = ZHMTypeInfo("EDebugSpatialInfoVerbosity", WriteEnumJson<"EDebugSpatialInfoVerbosity">, WriteEnumJsonSimple<"EDebugSpatialInfoVerbosity">);
static ZHMTypeInfo EPlayMode_TypeInfo = ZHMTypeInfo("EPlayMode", WriteEnumJson<"EPlayMode">, WriteEnumJsonSimple<"EPlayMode">);
static ZHMTypeInfo ZHM5FaceFXSpecificEventConsumer_EEvent_TypeInfo = ZHMTypeInfo("ZHM5FaceFXSpecificEventConsumer.EEvent", WriteEnumJson<"ZHM5FaceFXSpecificEventConsumer.EEvent">, WriteEnumJsonSimple<"ZHM5FaceFXSpecificEventConsumer.EEvent">);
static ZHMTypeInfo EIKEndEffector_TypeInfo = ZHMTypeInfo("EIKEndEffector", WriteEnumJson<"EIKEndEffector">, WriteEnumJsonSimple<"EIKEndEffector">);
static ZHMTypeInfo EHintMessageType_TypeInfo = ZHMTypeInfo("EHintMessageType", WriteEnumJson<"EHintMessageType">, WriteEnumJsonSimple<"EHintMessageType">);
static ZHMTypeInfo EHUDMessageStatus_TypeInfo = ZHMTypeInfo("EHUDMessageStatus", WriteEnumJson<"EHUDMessageStatus">, WriteEnumJsonSimple<"EHUDMessageStatus">);
static ZHMTypeInfo ERequirementId_TypeInfo = ZHMTypeInfo("ERequirementId", WriteEnumJson<"ERequirementId">, WriteEnumJsonSimple<"ERequirementId">);
static ZHMTypeInfo ZSecuritySystemCameraConfiguration_ECameraEscalationSituations_TypeInfo = ZHMTypeInfo("ZSecuritySystemCameraConfiguration.ECameraEscalationSituations", WriteEnumJson<"ZSecuritySystemCameraConfiguration.ECameraEscalationSituations">, WriteEnumJsonSimple<"ZSecuritySystemCameraConfiguration.ECameraEscalationSituations">);
static ZHMTypeInfo EConstraintType_TypeInfo = ZHMTypeInfo("EConstraintType", WriteEnumJson<"EConstraintType">, WriteEnumJsonSimple<"EConstraintType">);
static ZHMTypeInfo EVRIKElementMode_TypeInfo = ZHMTypeInfo("EVRIKElementMode", WriteEnumJson<"EVRIKElementMode">, WriteEnumJsonSimple<"EVRIKElementMode">);
static ZHMTypeInfo EObjectiveType_TypeInfo = ZHMTypeInfo("EObjectiveType", WriteEnumJson<"EObjectiveType">, WriteEnumJsonSimple<"EObjectiveType">);
static ZHMTypeInfo EWeaponUpgradeUse_TypeInfo = ZHMTypeInfo("EWeaponUpgradeUse", WriteEnumJson<"EWeaponUpgradeUse">, WriteEnumJsonSimple<"EWeaponUpgradeUse">);
static ZHMTypeInfo EActorSoundDefs_TypeInfo = ZHMTypeInfo("EActorSoundDefs", WriteEnumJson<"EActorSoundDefs">, WriteEnumJsonSimple<"EActorSoundDefs">);
static ZHMTypeInfo Network_OrderingChannel_TypeInfo = ZHMTypeInfo("Network.OrderingChannel", WriteEnumJson<"Network.OrderingChannel">, WriteEnumJsonSimple<"Network.OrderingChannel">);
static ZHMTypeInfo ZRenderPostfilterParametersEntity_EHDRAdaptationType_TypeInfo = ZHMTypeInfo("ZRenderPostfilterParametersEntity.EHDRAdaptationType", WriteEnumJson<"ZRenderPostfilterParametersEntity.EHDRAdaptationType">, WriteEnumJsonSimple<"ZRenderPostfilterParametersEntity.EHDRAdaptationType">);
static ZHMTypeInfo ECheatGroup_TypeInfo = ZHMTypeInfo("ECheatGroup", WriteEnumJson<"ECheatGroup">, WriteEnumJsonSimple<"ECheatGroup">);
static ZHMTypeInfo EReplicaOperation_TypeInfo = ZHMTypeInfo("EReplicaOperation", WriteEnumJson<"EReplicaOperation">, WriteEnumJsonSimple<"EReplicaOperation">);
static ZHMTypeInfo ECCEmitterEffect_TypeInfo = ZHMTypeInfo("ECCEmitterEffect", WriteEnumJson<"ECCEmitterEffect">, WriteEnumJsonSimple<"ECCEmitterEffect">);
static ZHMTypeInfo ECommunicationBarState_TypeInfo = ZHMTypeInfo("ECommunicationBarState", WriteEnumJson<"ECommunicationBarState">, WriteEnumJsonSimple<"ECommunicationBarState">);
static ZHMTypeInfo EButtonDisplay_TypeInfo = ZHMTypeInfo("EButtonDisplay", WriteEnumJson<"EButtonDisplay">, WriteEnumJsonSimple<"EButtonDisplay">);
static ZHMTypeInfo ZValueBool_OperationRecalc_EEvaluationType_TypeInfo = ZHMTypeInfo("ZValueBool_OperationRecalc.EEvaluationType", WriteEnumJson<"ZValueBool_OperationRecalc.EEvaluationType">, WriteEnumJsonSimple<"ZValueBool_OperationRecalc.EEvaluationType">);
static ZHMTypeInfo EHM5SoundBulletType_TypeInfo = ZHMTypeInfo("EHM5SoundBulletType", WriteEnumJson<"EHM5SoundBulletType">, WriteEnumJsonSimple<"EHM5SoundBulletType">);
static ZHMTypeInfo EContinuity_TypeInfo = ZHMTypeInfo("EContinuity", WriteEnumJson<"EContinuity">, WriteEnumJsonSimple<"EContinuity">);
static ZHMTypeInfo EVRRenderingMode_TypeInfo = ZHMTypeInfo("EVRRenderingMode", WriteEnumJson<"EVRRenderingMode">, WriteEnumJsonSimple<"EVRRenderingMode">);
...
static ZHMTypeInfo ECharacterFullBodyStateType_TypeInfo = ZHMTypeInfo("ECharacterFullBodyStateType", WriteEnumJson<"ECharacterFullBodyStateType">, WriteEnumJsonSimple<"ECharacterFullBodyStateType">);
static ZHMTypeInfo EControllerButton_TypeInfo = ZHMTypeInfo("EControllerButton", WriteEnumJson<"EControllerButton">, WriteEnumJsonSimple<"EControllerButton">);
static ZHMTypeInfo ZCautiousBackupGroup_EGroupState_TypeInfo = ZHMTypeInfo("ZCautiousBackupGroup.EGroupState", WriteEnumJson<"ZCautiousBackupGroup.EGroupState">, WriteEnumJsonSimple<"ZCautiousBackupGroup.EGroupState">);
static ZHMTypeInfo ZHM5HitmanHealthModifier_EHealthDrainType_TypeInfo = ZHMTypeInfo("ZHM5HitmanHealthModifier.EHealthDrainType", WriteEnumJson<"ZHM5HitmanHealthModifier.EHealthDrainType">, WriteEnumJsonSimple<"ZHM5HitmanHealthModifier.EHealthDrainType">);
static ZHMTypeInfo ERayType_TypeInfo = ZHMTypeInfo("ERayType", WriteEnumJson<"ERayType">, WriteEnumJsonSimple<"ERayType">);
static ZHMTypeInfo ZHM5BodyContainer_EBCBodyMode_TypeInfo = ZHMTypeInfo("ZHM5BodyContainer.EBCBodyMode", WriteEnumJson<"ZHM5BodyContainer.EBCBodyMode">, WriteEnumJsonSimple<"ZHM5BodyContainer.EBCBodyMode">);
static ZHMTypeInfo ESoundMaterialType_TypeInfo = ZHMTypeInfo("ESoundMaterialType", WriteEnumJson<"ESoundMaterialType">, WriteEnumJsonSimple<"ESoundMaterialType">);
static ZHMTypeInfo EScreenAnchor_TypeInfo = ZHMTypeInfo("EScreenAnchor", WriteEnumJson<"EScreenAnchor">, WriteEnumJsonSimple<"EScreenAnchor">);
static ZHMTypeInfo eHitmanPermissionReason_TypeInfo = ZHMTypeInfo("eHitmanPermissionReason", WriteEnumJson<"eHitmanPermissionReason">, WriteEnumJsonSimple<"eHitmanPermissionReason">);
static ZHMTypeInfo EActorAnimationOrder_TypeInfo = ZHMTypeInfo("EActorAnimationOrder", WriteEnumJson<"EActorAnimationOrder">, WriteEnumJsonSimple<"EActorAnimationOrder">);
static ZHMTypeInfo ESpeed_TypeInfo = ZHMTypeInfo("ESpeed", WriteEnumJson<"ESpeed">, WriteEnumJsonSimple<"ESpeed">);
static ZHMTypeInfo ESeamFixMode_TypeInfo = ZHMTypeInfo("ESeamFixMode", WriteEnumJson<"ESeamFixMode">, WriteEnumJsonSimple<"ESeamFixMode">);
static ZHMTypeInfo ESyncEvent_TypeInfo = ZHMTypeInfo("ESyncEvent", WriteEnumJson<"ESyncEvent">, WriteEnumJsonSimple<"ESyncEvent">);
static ZHMTypeInfo CrowdUtil_ECrowdDirection_TypeInfo = ZHMTypeInfo("CrowdUtil.ECrowdDirection", WriteEnumJson<"CrowdUtil.ECrowdDirection">, WriteEnumJsonSimple<"CrowdUtil.ECrowdDirection">);
static ZHMTypeInfo ZPreferenceItemEntity_EBoolOptions_TypeInfo = ZHMTypeInfo("ZPreferenceItemEntity.EBoolOptions", WriteEnumJson<"ZPreferenceItemEntity.EBoolOptions">, WriteEnumJsonSimple<"ZPreferenceItemEntity.EBoolOptions">);
static ZHMTypeInfo ZHM5WeaponBasicConfigEntity_EWeaponBasicConfigAudioFamily_TypeInfo = ZHMTypeInfo("ZHM5WeaponBasicConfigEntity.EWeaponBasicConfigAudioFamily", WriteEnumJson<"ZHM5WeaponBasicConfigEntity.EWeaponBasicConfigAudioFamily">, WriteEnumJsonSimple<"ZHM5WeaponBasicConfigEntity.EWeaponBasicConfigAudioFamily">);
static ZHMTypeInfo ZStandOffSituation_EDialogState_TypeInfo = ZHMTypeInfo("ZStandOffSituation.EDialogState", WriteEnumJson<"ZStandOffSituation.EDialogState">, WriteEnumJsonSimple<"ZStandOffSituation.EDialogState">);
static ZHMTypeInfo ZCameraConeTriggerEntity_EAlignment_TypeInfo = ZHMTypeInfo("ZCameraConeTriggerEntity.EAlignment", WriteEnumJson<"ZCameraConeTriggerEntity.EAlignment">, WriteEnumJsonSimple<"ZCameraConeTriggerEntity.EAlignment">);
static ZHMTypeInfo ZHeroInventoryAction_EEvaluationType_TypeInfo = ZHMTypeInfo("ZHeroInventoryAction.EEvaluationType", WriteEnumJson<"ZHeroInventoryAction.EEvaluationType">, WriteEnumJsonSimple<"ZHeroInventoryAction.EEvaluationType">);
static ZHMTypeInfo IContractObjective_Category_TypeInfo = ZHMTypeInfo("IContractObjective.Category", WriteEnumJson<"IContractObjective.Category">, WriteEnumJsonSimple<"IContractObjective.Category">);
static ZHMTypeInfo ZHM5LedgeMount_ELedgeEndState_TypeInfo = ZHMTypeInfo("ZHM5LedgeMount.ELedgeEndState", WriteEnumJson<"ZHM5LedgeMount.ELedgeEndState">, WriteEnumJsonSimple<"ZHM5LedgeMount.ELedgeEndState">);
static ZHMTypeInfo EHUDElement_TypeInfo = ZHMTypeInfo("EHUDElement", WriteEnumJson<"EHUDElement">, WriteEnumJsonSimple<"EHUDElement">);
static ZHMTypeInfo ZHUDCamera3DControllerEntity_EMode_TypeInfo = ZHMTypeInfo("ZHUDCamera3DControllerEntity.EMode", WriteEnumJson<"ZHUDCamera3DControllerEntity.EMode">, WriteEnumJsonSimple<"ZHUDCamera3DControllerEntity.EMode">);
static ZHMTypeInfo ZHUDTimerInstance_ETimeFormatChoice_TypeInfo = ZHMTypeInfo("ZHUDTimerInstance.ETimeFormatChoice", WriteEnumJson<"ZHUDTimerInstance.ETimeFormatChoice">, WriteEnumJsonSimple<"ZHUDTimerInstance.ETimeFormatChoice">);
static ZHMTypeInfo ECollidablesType_TypeInfo = ZHMTypeInfo("ECollidablesType", WriteEnumJson<"ECollidablesType">, WriteEnumJsonSimple<"ECollidablesType">);
static ZHMTypeInfo EParticleModifierImpulseDirections_TypeInfo = ZHMTypeInfo("EParticleModifierImpulseDirections", WriteEnumJson<"EParticleModifierImpulseDirections">, WriteEnumJsonSimple<"EParticleModifierImpulseDirections">);
static ZHMTypeInfo EItemPoisonType_TypeInfo = ZHMTypeInfo("EItemPoisonType", WriteEnumJson<"EItemPoisonType">, WriteEnumJsonSimple<"EItemPoisonType">);
static ZHMTypeInfo EScreenplayTriggerEvent_TypeInfo = ZHMTypeInfo("EScreenplayTriggerEvent", WriteEnumJson<"EScreenplayTriggerEvent">, WriteEnumJsonSimple<"EScreenplayTriggerEvent">);
static ZHMTypeInfo ETakeDownAnim_TypeInfo = ZHMTypeInfo("ETakeDownAnim", WriteEnumJson<"ETakeDownAnim">, WriteEnumJsonSimple<"ETakeDownAnim">);
static ZHMTypeInfo eVRFadeType_TypeInfo = ZHMTypeInfo("eVRFadeType", WriteEnumJson<"eVRFadeType">, WriteEnumJsonSimple<"eVRFadeType">);
static ZHMTypeInfo ZLogicMultipleGate_EGateType_TypeInfo = ZHMTypeInfo("ZLogicMultipleGate.EGateType", WriteEnumJson<"ZLogicMultipleGate.EGateType">, WriteEnumJsonSimple<"ZLogicMultipleGate.EGateType">);
static ZHMTypeInfo ZActBehaviorEntity_EMovementType_TypeInfo = ZHMTypeInfo("ZActBehaviorEntity.EMovementType", WriteEnumJson<"ZActBehaviorEntity.EMovementType">, WriteEnumJsonSimple<"ZActBehaviorEntity.EMovementType">);
static ZHMTypeInfo ZPatrolBehaviorEntity_EMovementType_TypeInfo = ZHMTypeInfo("ZPatrolBehaviorEntity.EMovementType", WriteEnumJson<"ZPatrolBehaviorEntity.EMovementType">, WriteEnumJsonSimple<"ZPatrolBehaviorEntity.EMovementType">);
static ZHMTypeInfo EUIActionGroupIcon_TypeInfo = ZHMTypeInfo("EUIActionGroupIcon", WriteEnumJson<"EUIActionGroupIcon">, WriteEnumJsonSimple<"EUIActionGroupIcon">);
static ZHMTypeInfo ESilenceRating_TypeInfo = ZHMTypeInfo("ESilenceRating", WriteEnumJson<"ESilenceRating">, WriteEnumJsonSimple<"ESilenceRating">);
static ZHMTypeInfo GameLobbyState_TypeInfo = ZHMTypeInfo("GameLobbyState", WriteEnumJson<"GameLobbyState">, WriteEnumJsonSimple<"GameLobbyState">);
static ZHMTypeInfo EVRConfigHeadAnchorMode_TypeInfo = ZHMTypeInfo("EVRConfigHeadAnchorMode", WriteEnumJson<"EVRConfigHeadAnchorMode">, WriteEnumJsonSimple<"EVRConfigHeadAnchorMode">);
static ZHMTypeInfo EFilterMaskBit_TypeInfo = ZHMTypeInfo("EFilterMaskBit", WriteEnumJson<"EFilterMaskBit">, WriteEnumJsonSimple<"EFilterMaskBit">);
static ZHMTypeInfo ECollisionPriority_TypeInfo = ZHMTypeInfo("ECollisionPriority", WriteEnumJson<"ECollisionPriority">, WriteEnumJsonSimple<"ECollisionPriority">);
static ZHMTypeInfo ZActStateCondition_EState_TypeInfo = ZHMTypeInfo("ZActStateCondition.EState", WriteEnumJson<"ZActStateCondition.EState">, WriteEnumJsonSimple<"ZActStateCondition.EState">);
static ZHMTypeInfo ELedgeDismountBehavior_TypeInfo = ZHMTypeInfo("ELedgeDismountBehavior", WriteEnumJson<"ELedgeDismountBehavior">, WriteEnumJsonSimple<"ELedgeDismountBehavior">);
static ZHMTypeInfo IContractObjective_Type_TypeInfo = ZHMTypeInfo("IContractObjective.Type", WriteEnumJson<"IContractObjective.Type">, WriteEnumJsonSimple<"IContractObjective.Type">);
static ZHMTypeInfo ZValueInt_Evaluation_EEvaluationType_TypeInfo = ZHMTypeInfo("ZValueInt_Evaluation.EEvaluationType", WriteEnumJson<"ZValueInt_Evaluation.EEvaluationType">, WriteEnumJsonSimple<"ZValueInt_Evaluation.EEvaluationType">);
static ZHMTypeInfo IScatterContainerEntity_ECanvasSize_TypeInfo = ZHMTypeInfo("IScatterContainerEntity.ECanvasSize", WriteEnumJson<"IScatterContainerEntity.ECanvasSize">, WriteEnumJsonSimple<"IScatterContainerEntity.ECanvasSize">);
static ZHMTypeInfo ZMoveToOrder_EMoveSpeed_TypeInfo = ZHMTypeInfo("ZMoveToOrder.EMoveSpeed", WriteEnumJson<"ZMoveToOrder.EMoveSpeed">, WriteEnumJsonSimple<"ZMoveToOrder.EMoveSpeed">);
static ZHMTypeInfo ECCDecalEffect_TypeInfo = ZHMTypeInfo("ECCDecalEffect", WriteEnumJson<"ECCDecalEffect">, WriteEnumJsonSimple<"ECCDecalEffect">);
static ZHMTypeInfo ZContractObjectiveHudHintEntity_EObjectiveHintIcon_TypeInfo = ZHMTypeInfo("ZContractObjectiveHudHintEntity.EObjectiveHintIcon", WriteEnumJson<"ZContractObjectiveHudHintEntity.EObjectiveHintIcon">, WriteEnumJsonSimple<"ZContractObjectiveHudHintEntity.EObjectiveHintIcon">);
static ZHMTypeInfo IScatterContainerEntity_ECanvasClearMode_TypeInfo = ZHMTypeInfo("IScatterContainerEntity.ECanvasClearMode", WriteEnumJson<"IScatterContainerEntity.ECanvasClearMode">, WriteEnumJsonSimple<"IScatterContainerEntity.ECanvasClearMode">);
static ZHMTypeInfo ESpeechPriority_TypeInfo = ZHMTypeInfo("ESpeechPriority", WriteEnumJson<"ESpeechPriority">, WriteEnumJsonSimple<"ESpeechPriority">);
static ZHMTypeInfo EActorRole_TypeInfo = ZHMTypeInfo("EActorRole", WriteEnumJson<"EActorRole">, WriteEnumJsonSimple<"EActorRole">);
static ZHMTypeInfo ECCWeaponAnimSet_TypeInfo = ZHMTypeInfo("ECCWeaponAnimSet", WriteEnumJson<"ECCWeaponAnimSet">, WriteEnumJsonSimple<"ECCWeaponAnimSet">);
static ZHMTypeInfo ECompiledBehaviorType_TypeInfo = ZHMTypeInfo("ECompiledBehaviorType", WriteEnumJson<"ECompiledBehaviorType">, WriteEnumJsonSimple<"ECompiledBehaviorType">);
static ZHMTypeInfo ZWaveformGeneratorEntity_ECurveType_TypeInfo = ZHMTypeInfo("ZWaveformGeneratorEntity.ECurveType", WriteEnumJson<"ZWaveformGeneratorEntity.ECurveType">, WriteEnumJsonSimple<"ZWaveformGeneratorEntity.ECurveType">);
static ZHMTypeInfo EItemHUDType_TypeInfo = ZHMTypeInfo("EItemHUDType", WriteEnumJson<"EItemHUDType">, WriteEnumJsonSimple<"EItemHUDType">);
static ZHMTypeInfo ZDetectedInPrivateGroup_EInvestigateGroupState_TypeInfo = ZHMTypeInfo("ZDetectedInPrivateGroup.EInvestigateGroupState", WriteEnumJson<"ZDetectedInPrivateGroup.EInvestigateGroupState">, WriteEnumJsonSimple<"ZDetectedInPrivateGroup.EInvestigateGroupState">);
static ZHMTypeInfo ZActorPickerFilterKeyword_EEvaluationType_TypeInfo = ZHMTypeInfo("ZActorPickerFilterKeyword.EEvaluationType", WriteEnumJson<"ZActorPickerFilterKeyword.EEvaluationType">, WriteEnumJsonSimple<"ZActorPickerFilterKeyword.EEvaluationType">);
static ZHMTypeInfo ZConditionListEntity_EEvaluationType_TypeInfo = ZHMTypeInfo("ZConditionListEntity.EEvaluationType", WriteEnumJson<"ZConditionListEntity.EEvaluationType">, WriteEnumJsonSimple<"ZConditionListEntity.EEvaluationType">);
static ZHMTypeInfo ENetworkSystemID_TypeInfo = ZHMTypeInfo("ENetworkSystemID", WriteEnumJson<"ENetworkSystemID">, WriteEnumJsonSimple<"ENetworkSystemID">);
static ZHMTypeInfo ZHM5FaceFXReactionEventConsumer_EEvent_TypeInfo = ZHMTypeInfo("ZHM5FaceFXReactionEventConsumer.EEvent", WriteEnumJson<"ZHM5FaceFXReactionEventConsumer.EEvent">, WriteEnumJsonSimple<"ZHM5FaceFXReactionEventConsumer.EEvent">);
static ZHMTypeInfo ZDebugSpatialEntity_EDrawLayer_TypeInfo = ZHMTypeInfo("ZDebugSpatialEntity.EDrawLayer", WriteEnumJson<"ZDebugSpatialEntity.EDrawLayer">, WriteEnumJsonSimple<"ZDebugSpatialEntity.EDrawLayer">);
static ZHMTypeInfo EIntelTensionLevel_TypeInfo = ZHMTypeInfo("EIntelTensionLevel", WriteEnumJson<"EIntelTensionLevel">, WriteEnumJsonSimple<"EIntelTensionLevel">);
static ZHMTypeInfo CrowdUtil_ECrowdSide_TypeInfo = ZHMTypeInfo("CrowdUtil.ECrowdSide", WriteEnumJson<"CrowdUtil.ECrowdSide">, WriteEnumJsonSimple<"CrowdUtil.ECrowdSide">);
static ZHMTypeInfo ESentryActionPrompt_TypeInfo = ZHMTypeInfo("ESentryActionPrompt", WriteEnumJson<"ESentryActionPrompt">, WriteEnumJsonSimple<"ESentryActionPrompt">);
static ZHMTypeInfo EInventoryConfigCustomRule_TypeInfo = ZHMTypeInfo("EInventoryConfigCustomRule", WriteEnumJson<"EInventoryConfigCustomRule">, WriteEnumJsonSimple<"EInventoryConfigCustomRule">);
static ZHMTypeInfo ZItemSpawner_EPhysicsMode_TypeInfo = ZHMTypeInfo("ZItemSpawner.EPhysicsMode", WriteEnumJson<"ZItemSpawner.EPhysicsMode">, WriteEnumJsonSimple<"ZItemSpawner.EPhysicsMode">);
static ZHMTypeInfo ICameraEntity_EProjectionType_TypeInfo = ZHMTypeInfo("ICameraEntity.EProjectionType", WriteEnumJson<"ICameraEntity.EProjectionType">, WriteEnumJsonSimple<"ICameraEntity.EProjectionType">);
static ZHMTypeInfo EBIEventTypes_TypeInfo = ZHMTypeInfo("EBIEventTypes", WriteEnumJson<"EBIEventTypes">, WriteEnumJsonSimple<"EBIEventTypes">);
static ZHMTypeInfo EInteractionInputType_TypeInfo = ZHMTypeInfo("EInteractionInputType", WriteEnumJson<"EInteractionInputType">, WriteEnumJsonSimple<"EInteractionInputType">);
static ZHMTypeInfo ZDeadBodySituation_ESituationFlavor_TypeInfo = ZHMTypeInfo("ZDeadBodySituation.ESituationFlavor", WriteEnumJson<"ZDeadBodySituation.ESituationFlavor">, WriteEnumJsonSimple<"ZDeadBodySituation.ESituationFlavor">);
static ZHMTypeInfo ZSetVisibleEntity_StartBehavior_TypeInfo = ZHMTypeInfo("ZSetVisibleEntity.StartBehavior", WriteEnumJson<"ZSetVisibleEntity.StartBehavior">, WriteEnumJsonSimple<"ZSetVisibleEntity.StartBehavior">);
static ZHMTypeInfo ZBoxReflectionEntity_EBoundsType_TypeInfo = ZHMTypeInfo("ZBoxReflectionEntity.EBoundsType", WriteEnumJson<"ZBoxReflectionEntity.EBoundsType">, WriteEnumJsonSimple<"ZBoxReflectionEntity.EBoundsType">);
static ZHMTypeInfo ERatingTitleRequirement_TypeInfo = ZHMTypeInfo("ERatingTitleRequirement", WriteEnumJson<"ERatingTitleRequirement">, WriteEnumJsonSimple<"ERatingTitleRequirement">);
static ZHMTypeInfo EVRIKElement_TypeInfo = ZHMTypeInfo("EVRIKElement", WriteEnumJson<"EVRIKElement">, WriteEnumJsonSimple<"EVRIKElement">);
static ZHMTypeInfo STestStruct_ETestEnum_TypeInfo = ZHMTypeInfo("STestStruct.ETestEnum", WriteEnumJson<"STestStruct.ETestEnum">, WriteEnumJsonSimple<"STestStruct.ETestEnum">);
static ZHMTypeInfo ZHM5BodySoundEventConsumer_EAnimSoundBody_TypeInfo = ZHMTypeInfo("ZHM5BodySoundEventConsumer.EAnimSoundBody", WriteEnumJson<"ZHM5BodySoundEventConsumer.EAnimSoundBody">, WriteEnumJsonSimple<"ZHM5BodySoundEventConsumer.EAnimSoundBody">);
static ZHMTypeInfo ECCNodeSubtype_TypeInfo = ZHMTypeInfo("ECCNodeSubtype", WriteEnumJson<"ECCNodeSubtype">, WriteEnumJsonSimple<"ECCNodeSubtype">);
static ZHMTypeInfo ZPIPMessageEntity_EIcon_TypeInfo = ZHMTypeInfo("ZPIPMessageEntity.EIcon", WriteEnumJson<"ZPIPMessageEntity.EIcon">, WriteEnumJsonSimple<"ZPIPMessageEntity.EIcon">);
static ZHMTypeInfo EWaypointRotationAlignment_TypeInfo = ZHMTypeInfo("EWaypointRotationAlignment", WriteEnumJson<"EWaypointRotationAlignment">, WriteEnumJsonSimple<"EWaypointRotationAlignment">);
static ZHMTypeInfo EHintMessageSoundType_TypeInfo = ZHMTypeInfo("EHintMessageSoundType", WriteEnumJson<"EHintMessageSoundType">, WriteEnumJsonSimple<"EHintMessageSoundType">);
static ZHMTypeInfo EAsyncRaycastsGroup_TypeInfo = ZHMTypeInfo("EAsyncRaycastsGroup", WriteEnumJson<"EAsyncRaycastsGroup">, WriteEnumJsonSimple<"EAsyncRaycastsGroup">);
static ZHMTypeInfo EKnownEntityType_TypeInfo = ZHMTypeInfo("EKnownEntityType", WriteEnumJson<"EKnownEntityType">, WriteEnumJsonSimple<"EKnownEntityType">);
static ZHMTypeInfo ZActorAccessoryItemCondition_EConditionTypes_TypeInfo = ZHMTypeInfo("ZActorAccessoryItemCondition.EConditionTypes", WriteEnumJson<"ZActorAccessoryItemCondition.EConditionTypes">, WriteEnumJsonSimple<"ZActorAccessoryItemCondition.EConditionTypes">);
static ZHMTypeInfo ZHM5DynamicRayCastEntity_ECollideType_TypeInfo = ZHMTypeInfo("ZHM5DynamicRayCastEntity.ECollideType", WriteEnumJson<"ZHM5DynamicRayCastEntity.ECollideType">, WriteEnumJsonSimple<"ZHM5DynamicRayCastEntity.ECollideType">);
static ZHMTypeInfo ZCausalNodeEntity_ECauseEvaluationType_TypeInfo = ZHMTypeInfo("ZCausalNodeEntity.ECauseEvaluationType", WriteEnumJson<"ZCausalNodeEntity.ECauseEvaluationType">, WriteEnumJsonSimple<"ZCausalNodeEntity.ECauseEvaluationType">);
static ZHMTypeInfo ESoundGateFlags_TypeInfo = ZHMTypeInfo("ESoundGateFlags", WriteEnumJson<"ESoundGateFlags">, WriteEnumJsonSimple<"ESoundGateFlags">);
static ZHMTypeInfo CrowdUtil_EGenderReq_TypeInfo = ZHMTypeInfo("CrowdUtil.EGenderReq", WriteEnumJson<"CrowdUtil.EGenderReq">, WriteEnumJsonSimple<"CrowdUtil.EGenderReq">);
static ZHMTypeInfo EInteractionIndicatorState_TypeInfo = ZHMTypeInfo("EInteractionIndicatorState", WriteEnumJson<"EInteractionIndicatorState">, WriteEnumJsonSimple<"EInteractionIndicatorState">);
static ZHMTypeInfo EActorLookAtPriority_TypeInfo = ZHMTypeInfo("EActorLookAtPriority", WriteEnumJson<"EActorLookAtPriority">, WriteEnumJsonSimple<"EActorLookAtPriority">);
static ZHMTypeInfo ZCameraPlaneTriggerEntity_EAlignment_TypeInfo = ZHMTypeInfo("ZCameraPlaneTriggerEntity.EAlignment", WriteEnumJson<"ZCameraPlaneTriggerEntity.EAlignment">, WriteEnumJsonSimple<"ZCameraPlaneTriggerEntity.EAlignment">);
static ZHMTypeInfo ECharacterAnimEventState_TypeInfo = ZHMTypeInfo("ECharacterAnimEventState", WriteEnumJson<"ECharacterAnimEventState">, WriteEnumJsonSimple<"ECharacterAnimEventState">);
static ZHMTypeInfo ZFriskSuspectGroup_EHitmanGreetState_TypeInfo = ZHMTypeInfo("ZFriskSuspectGroup.EHitmanGreetState", WriteEnumJson<"ZFriskSuspectGroup.EHitmanGreetState">, WriteEnumJsonSimple<"ZFriskSuspectGroup.EHitmanGreetState">);
static ZHMTypeInfo SDoorSoundDefs_EDefinition_TypeInfo = ZHMTypeInfo("SDoorSoundDefs.EDefinition", WriteEnumJson<"SDoorSoundDefs.EDefinition">, WriteEnumJsonSimple<"SDoorSoundDefs.EDefinition">);
static ZHMTypeInfo ZActorPickerEffectDrama_EEffectPhaseAction_TypeInfo = ZHMTypeInfo("ZActorPickerEffectDrama.EEffectPhaseAction", WriteEnumJson<"ZActorPickerEffectDrama.EEffectPhaseAction">, WriteEnumJsonSimple<"ZActorPickerEffectDrama.EEffectPhaseAction">);
static ZHMTypeInfo ZAudioSequenceTrack_EPlaybackTarget_TypeInfo = ZHMTypeInfo("ZAudioSequenceTrack.EPlaybackTarget", WriteEnumJson<"ZAudioSequenceTrack.EPlaybackTarget">, WriteEnumJsonSimple<"ZAudioSequenceTrack.EPlaybackTarget">);
static ZHMTypeInfo EItemModifierType_TypeInfo = ZHMTypeInfo("EItemModifierType", WriteEnumJson<"EItemModifierType">, WriteEnumJsonSimple<"EItemModifierType">);
static ZHMTypeInfo EAISituation_TypeInfo = ZHMTypeInfo("EAISituation", WriteEnumJson<"EAISituation">, WriteEnumJsonSimple<"EAISituation">);
static ZHMTypeInfo EScreenPlayState_TypeInfo = ZHMTypeInfo("EScreenPlayState", WriteEnumJson<"EScreenPlayState">, WriteEnumJsonSimple<"EScreenPlayState">);
static ZHMTypeInfo EDramaSituationDescriptors_TypeInfo = ZHMTypeInfo("EDramaSituationDescriptors", WriteEnumJson<"EDramaSituationDescriptors">, WriteEnumJsonSimple<"EDramaSituationDescriptors">);
static ZHMTypeInfo ERagdollPart_TypeInfo = ZHMTypeInfo("ERagdollPart", WriteEnumJson<"ERagdollPart">, WriteEnumJsonSimple<"ERagdollPart">);
static ZHMTypeInfo EOpportunityState_TypeInfo = ZHMTypeInfo("EOpportunityState", WriteEnumJson<"EOpportunityState">, WriteEnumJsonSimple<"EOpportunityState">);
static ZHMTypeInfo EOrderCompletionStatus_TypeInfo = ZHMTypeInfo("EOrderCompletionStatus", WriteEnumJson<"EOrderCompletionStatus">, WriteEnumJsonSimple<"EOrderCompletionStatus">);
static ZHMTypeInfo ZHM5ContextActionEntity_EInteraction_TypeInfo = ZHMTypeInfo("ZHM5ContextActionEntity.EInteraction", WriteEnumJson<"ZHM5ContextActionEntity.EInteraction">, WriteEnumJsonSimple<"ZHM5ContextActionEntity.EInteraction">);
static ZHMTypeInfo EOutbreakInfectionStage_TypeInfo = ZHMTypeInfo("EOutbreakInfectionStage", WriteEnumJson<"EOutbreakInfectionStage">, WriteEnumJsonSimple<"EOutbreakInfectionStage">);
static ZHMTypeInfo eActionRewardType_TypeInfo = ZHMTypeInfo("eActionRewardType", WriteEnumJson<"eActionRewardType">, WriteEnumJsonSimple<"eActionRewardType">);
static ZHMTypeInfo ZAT2Controller_EFootstepsMovementType_TypeInfo = ZHMTypeInfo("ZAT2Controller.EFootstepsMovementType", WriteEnumJson<"ZAT2Controller.EFootstepsMovementType">, WriteEnumJsonSimple<"ZAT2Controller.EFootstepsMovementType">);
static ZHMTypeInfo ZMoveToPositionBehaviorEntity_EMovementType_TypeInfo = ZHMTypeInfo("ZMoveToPositionBehaviorEntity.EMovementType", WriteEnumJson<"ZMoveToPositionBehaviorEntity.EMovementType">, WriteEnumJsonSimple<"ZMoveToPositionBehaviorEntity.EMovementType">);
static ZHMTypeInfo ZHM5ForceCover_EFaceDirection_TypeInfo = ZHMTypeInfo("ZHM5ForceCover.EFaceDirection", WriteEnumJson<"ZHM5ForceCover.EFaceDirection">, WriteEnumJsonSimple<"ZHM5ForceCover.EFaceDirection">);
static ZHMTypeInfo AudioCurve_TypeInfo = ZHMTypeInfo("AudioCurve", WriteEnumJson<"AudioCurve">, WriteEnumJsonSimple<"AudioCurve">);
static ZHMTypeInfo EActivationPriority_TypeInfo = ZHMTypeInfo("EActivationPriority", WriteEnumJson<"EActivationPriority">, WriteEnumJsonSimple<"EActivationPriority">);
static ZHMTypeInfo ZMenuSliderNavigationEntity_ESliderInputMode_TypeInfo = ZHMTypeInfo("ZMenuSliderNavigationEntity.ESliderInputMode", WriteEnumJson<"ZMenuSliderNavigationEntity.ESliderInputMode">, WriteEnumJsonSimple<"ZMenuSliderNavigationEntity.ESliderInputMode">);
static ZHMTypeInfo ZActDurationCondition_EState_TypeInfo = ZHMTypeInfo("ZActDurationCondition.EState", WriteEnumJson<"ZActDurationCondition.EState">, WriteEnumJsonSimple<"ZActDurationCondition.EState">);
static ZHMTypeInfo ETextAlignment_TypeInfo = ZHMTypeInfo("ETextAlignment", WriteEnumJson<"ETextAlignment">, WriteEnumJsonSimple<"ETextAlignment">);
static ZHMTypeInfo eItemSize_TypeInfo = ZHMTypeInfo("eItemSize", WriteEnumJson<"eItemSize">, WriteEnumJsonSimple<"eItemSize">);
static ZHMTypeInfo ZEscortSituation2Entity_EEscortState_TypeInfo = ZHMTypeInfo("ZEscortSituation2Entity.EEscortState", WriteEnumJson<"ZEscortSituation2Entity.EEscortState">, WriteEnumJsonSimple<"ZEscortSituation2Entity.EEscortState">);
static ZHMTypeInfo ZLeadEscortSituationEntity_ETargetState_TypeInfo = ZHMTypeInfo("ZLeadEscortSituationEntity.ETargetState", WriteEnumJson<"ZLeadEscortSituationEntity.ETargetState">, WriteEnumJsonSimple<"ZLeadEscortSituationEntity.ETargetState">);
static ZHMTypeInfo ECharacterSubcontrollerType_TypeInfo = ZHMTypeInfo("ECharacterSubcontrollerType", WriteEnumJson<"ECharacterSubcontrollerType">, WriteEnumJsonSimple<"ECharacterSubcontrollerType">);
static ZHMTypeInfo ECrowdFlowCandidates_TypeInfo = ZHMTypeInfo("ECrowdFlowCandidates", WriteEnumJson<"ECrowdFlowCandidates">, WriteEnumJsonSimple<"ECrowdFlowCandidates">);
static ZHMTypeInfo EThrownCollisionSoundLoudness_TypeInfo = ZHMTypeInfo("EThrownCollisionSoundLoudness", WriteEnumJson<"EThrownCollisionSoundLoudness">, WriteEnumJsonSimple<"EThrownCollisionSoundLoudness">);
static ZHMTypeInfo EUIBusyOperationId_TypeInfo = ZHMTypeInfo("EUIBusyOperationId", WriteEnumJson<"EUIBusyOperationId">, WriteEnumJsonSimple<"EUIBusyOperationId">);
static ZHMTypeInfo EAttachLocation_TypeInfo = ZHMTypeInfo("EAttachLocation", WriteEnumJson<"EAttachLocation">, WriteEnumJsonSimple<"EAttachLocation">);
static ZHMTypeInfo EEngineFrameUpdatePriority_TypeInfo = ZHMTypeInfo("EEngineFrameUpdatePriority", WriteEnumJson<"EEngineFrameUpdatePriority">, WriteEnumJsonSimple<"EEngineFrameUpdatePriority">);
static ZHMTypeInfo EInformationBarMessage_TypeInfo = ZHMTypeInfo("EInformationBarMessage", WriteEnumJson<"EInformationBarMessage">, WriteEnumJsonSimple<"EInformationBarMessage">);
static ZHMTypeInfo ESniperScoreMessageType_TypeInfo = ZHMTypeInfo("ESniperScoreMessageType", WriteEnumJson<"ESniperScoreMessageType">, WriteEnumJsonSimple<"ESniperScoreMessageType">);
static ZHMTypeInfo ZHttpUrl_EVerb_TypeInfo = ZHMTypeInfo("ZHttpUrl.EVerb", WriteEnumJson<"ZHttpUrl.EVerb">, WriteEnumJsonSimple<"ZHttpUrl.EVerb">);
static ZHMTypeInfo ESmoothingMode_TypeInfo = ZHMTypeInfo("ESmoothingMode", WriteEnumJson<"ESmoothingMode">, WriteEnumJsonSimple<"ESmoothingMode">);
static ZHMTypeInfo ZActorPickerEffectTemplate_EEffectPhaseAction_TypeInfo = ZHMTypeInfo("ZActorPickerEffectTemplate.EEffectPhaseAction", WriteEnumJson<"ZActorPickerEffectTemplate.EEffectPhaseAction">, WriteEnumJsonSimple<"ZActorPickerEffectTemplate.EEffectPhaseAction">);
static ZHMTypeInfo EActorAIDot_TypeInfo = ZHMTypeInfo("EActorAIDot", WriteEnumJson<"EActorAIDot">, WriteEnumJsonSimple<"EActorAIDot">);
static ZHMTypeInfo ZDecalControllerEntity_EScaleType_TypeInfo = ZHMTypeInfo("ZDecalControllerEntity.EScaleType", WriteEnumJson<"ZDecalControllerEntity.EScaleType">, WriteEnumJsonSimple<"ZDecalControllerEntity.EScaleType">);
static ZHMTypeInfo ZUIControlLayoutLegacyAspect_ELayoutMode_TypeInfo = ZHMTypeInfo("ZUIControlLayoutLegacyAspect.ELayoutMode", WriteEnumJson<"ZUIControlLayoutLegacyAspect.ELayoutMode">, WriteEnumJsonSimple<"ZUIControlLayoutLegacyAspect.ELayoutMode">);
static ZHMTypeInfo ZHM5WeaponBasicConfigEntity_EWeaponBasicConfigAudioClass_TypeInfo = ZHMTypeInfo("ZHM5WeaponBasicConfigEntity.EWeaponBasicConfigAudioClass", WriteEnumJson<"ZHM5WeaponBasicConfigEntity.EWeaponBasicConfigAudioClass">, WriteEnumJsonSimple<"ZHM5WeaponBasicConfigEntity.EWeaponBasicConfigAudioClass">);
static ZHMTypeInfo ZUIControlLayoutLegacyAspect_EAlignmentType_TypeInfo = ZHMTypeInfo("ZUIControlLayoutLegacyAspect.EAlignmentType", WriteEnumJson<"ZUIControlLayoutLegacyAspect.EAlignmentType">, WriteEnumJsonSimple<"ZUIControlLayoutLegacyAspect.EAlignmentType">);
static ZHMTypeInfo ZEscortSituationEntity_EEscortState_TypeInfo = ZHMTypeInfo("ZEscortSituationEntity.EEscortState", WriteEnumJson<"ZEscortSituationEntity.EEscortState">, WriteEnumJsonSimple<"ZEscortSituationEntity.EEscortState">);
static ZHMTypeInfo SniperControllerConditionType_TypeInfo = ZHMTypeInfo("SniperControllerConditionType", WriteEnumJson<"SniperControllerConditionType">, WriteEnumJsonSimple<"SniperControllerConditionType">);
static ZHMTypeInfo ZActorInstanceEntity_EFFXMode_TypeInfo = ZHMTypeInfo("ZActorInstanceEntity.EFFXMode", WriteEnumJson<"ZActorInstanceEntity.EFFXMode">, WriteEnumJsonSimple<"ZActorInstanceEntity.EFFXMode">);
static ZHMTypeInfo EMapType_TypeInfo = ZHMTypeInfo("EMapType", WriteEnumJson<"EMapType">, WriteEnumJsonSimple<"EMapType">);
static ZHMTypeInfo CrowdUtil_ECrowdFacing_TypeInfo = ZHMTypeInfo("CrowdUtil.ECrowdFacing", WriteEnumJson<"CrowdUtil.ECrowdFacing">, WriteEnumJsonSimple<"CrowdUtil.ECrowdFacing">);
static ZHMTypeInfo EActorEmotionState_TypeInfo = ZHMTypeInfo("EActorEmotionState", WriteEnumJson<"EActorEmotionState">, WriteEnumJsonSimple<"EActorEmotionState">);
static ZHMTypeInfo EKeywordSetBehavior_TypeInfo = ZHMTypeInfo("EKeywordSetBehavior", WriteEnumJson<"EKeywordSetBehavior">, WriteEnumJsonSimple<"EKeywordSetBehavior">);
static ZHMTypeInfo eItemRarity_TypeInfo = ZHMTypeInfo("eItemRarity", WriteEnumJson<"eItemRarity">, WriteEnumJsonSimple<"eItemRarity">);
static ZHMTypeInfo eHolsterAbility_TypeInfo = ZHMTypeInfo("eHolsterAbility", WriteEnumJson<"eHolsterAbility">, WriteEnumJsonSimple<"eHolsterAbility">);
static ZHMTypeInfo EMoveEndState_TypeInfo = ZHMTypeInfo("EMoveEndState", WriteEnumJson<"EMoveEndState">, WriteEnumJsonSimple<"EMoveEndState">);
static ZHMTypeInfo EPlaceableType_TypeInfo = ZHMTypeInfo("EPlaceableType", WriteEnumJson<"EPlaceableType">, WriteEnumJsonSimple<"EPlaceableType">);
static ZHMTypeInfo ELastSoundTension_TypeInfo = ZHMTypeInfo("ELastSoundTension", WriteEnumJson<"ELastSoundTension">, WriteEnumJsonSimple<"ELastSoundTension">);
static ZHMTypeInfo ZSequenceEntity_ELetterBoxAspect_TypeInfo = ZHMTypeInfo("ZSequenceEntity.ELetterBoxAspect", WriteEnumJson<"ZSequenceEntity.ELetterBoxAspect">, WriteEnumJsonSimple<"ZSequenceEntity.ELetterBoxAspect">);
static ZHMTypeInfo ZHM5HIKEventConsumer_EEffector_TypeInfo = ZHMTypeInfo("ZHM5HIKEventConsumer.EEffector", WriteEnumJson<"ZHM5HIKEventConsumer.EEffector">, WriteEnumJsonSimple<"ZHM5HIKEventConsumer.EEffector">);
static ZHMTypeInfo ZWaypointEntity_EMovementType_TypeInfo = ZHMTypeInfo("ZWaypointEntity.EMovementType", WriteEnumJson<"ZWaypointEntity.EMovementType">, WriteEnumJsonSimple<"ZWaypointEntity.EMovementType">);
static ZHMTypeInfo EInventoryStorageType_TypeInfo = ZHMTypeInfo("EInventoryStorageType", WriteEnumJson<"EInventoryStorageType">, WriteEnumJsonSimple<"EInventoryStorageType">);
static ZHMTypeInfo EDialogEventEndReason_TypeInfo = ZHMTypeInfo("EDialogEventEndReason", WriteEnumJson<"EDialogEventEndReason">, WriteEnumJsonSimple<"EDialogEventEndReason">);
static ZHMTypeInfo EDefaultCollidableLayer_TypeInfo = ZHMTypeInfo("EDefaultCollidableLayer", WriteEnumJson<"EDefaultCollidableLayer">, WriteEnumJsonSimple<"EDefaultCollidableLayer">);
static ZHMTypeInfo eItemHands_TypeInfo = ZHMTypeInfo("eItemHands", WriteEnumJson<"eItemHands">, WriteEnumJsonSimple<"eItemHands">);
static ZHMTypeInfo ZActorProviderFilterKeyword_EEvaluationType_TypeInfo = ZHMTypeInfo("ZActorProviderFilterKeyword.EEvaluationType", WriteEnumJson<"ZActorProviderFilterKeyword.EEvaluationType">, WriteEnumJsonSimple<"ZActorProviderFilterKeyword.EEvaluationType">);
static ZHMTypeInfo ZHUDUIRoot_EHUDVisibility_TypeInfo = ZHMTypeInfo("ZHUDUIRoot.EHUDVisibility", WriteEnumJson<"ZHUDUIRoot.EHUDVisibility">, WriteEnumJsonSimple<"ZHUDUIRoot.EHUDVisibility">);
static ZHMTypeInfo EKillType_TypeInfo = ZHMTypeInfo("EKillType", WriteEnumJson<"EKillType">, WriteEnumJsonSimple<"EKillType">);
static ZHMTypeInfo EHUDIconType_TypeInfo = ZHMTypeInfo("EHUDIconType", WriteEnumJson<"EHUDIconType">, WriteEnumJsonSimple<"EHUDIconType">);
static ZHMTypeInfo ECharacterActionSyncRequests_TypeInfo = ZHMTypeInfo("ECharacterActionSyncRequests", WriteEnumJson<"ECharacterActionSyncRequests">, WriteEnumJsonSimple<"ECharacterActionSyncRequests">);
static ZHMTypeInfo ZInvestigateCautiousSituation_ESituationState_TypeInfo = ZHMTypeInfo("ZInvestigateCautiousSituation.ESituationState", WriteEnumJson<"ZInvestigateCautiousSituation.ESituationState">, WriteEnumJsonSimple<"ZInvestigateCautiousSituation.ESituationState">);
static ZHMTypeInfo EActBodyType_TypeInfo = ZHMTypeInfo("EActBodyType", WriteEnumJson<"EActBodyType">, WriteEnumJsonSimple<"EActBodyType">);
static ZHMTypeInfo ZHUDOccluderTriggerEntity_EOccluderTestBit_TypeInfo = ZHMTypeInfo("ZHUDOccluderTriggerEntity.EOccluderTestBit", WriteEnumJson<"ZHUDOccluderTriggerEntity.EOccluderTestBit">, WriteEnumJsonSimple<"ZHUDOccluderTriggerEntity.EOccluderTestBit">);
static ZHMTypeInfo EOpportunityRevealState_TypeInfo = ZHMTypeInfo("EOpportunityRevealState", WriteEnumJson<"EOpportunityRevealState">, WriteEnumJsonSimple<"EOpportunityRevealState">);
static ZHMTypeInfo EGSBodyPart_TypeInfo = ZHMTypeInfo("EGSBodyPart", WriteEnumJson<"EGSBodyPart">, WriteEnumJsonSimple<"EGSBodyPart">);
static ZHMTypeInfo EActorSecondaryIconState_TypeInfo = ZHMTypeInfo("EActorSecondaryIconState", WriteEnumJson<"EActorSecondaryIconState">, WriteEnumJsonSimple<"EActorSecondaryIconState">);
static ZHMTypeInfo ZInputListenerAxisEntity_eInputListenerAxes_TypeInfo = ZHMTypeInfo("ZInputListenerAxisEntity.eInputListenerAxes", WriteEnumJson<"ZInputListenerAxisEntity.eInputListenerAxes">, WriteEnumJsonSimple<"ZInputListenerAxisEntity.eInputListenerAxes">);
static ZHMTypeInfo EActorEventTypes_TypeInfo = ZHMTypeInfo("EActorEventTypes", WriteEnumJson<"EActorEventTypes">, WriteEnumJsonSimple<"EActorEventTypes">);
static ZHMTypeInfo EVRConfigCustomEvent_TypeInfo = ZHMTypeInfo("EVRConfigCustomEvent", WriteEnumJson<"EVRConfigCustomEvent">, WriteEnumJsonSimple<"EVRConfigCustomEvent">);
static ZHMTypeInfo EMultiplayerNetworkState_TypeInfo = ZHMTypeInfo("EMultiplayerNetworkState", WriteEnumJson<"EMultiplayerNetworkState">, WriteEnumJsonSimple<"EMultiplayerNetworkState">);
static ZHMTypeInfo EBoolCheckType_TypeInfo = ZHMTypeInfo("EBoolCheckType", WriteEnumJson<"EBoolCheckType">, WriteEnumJsonSimple<"EBoolCheckType">);
static ZHMTypeInfo EActorFaction_TypeInfo = ZHMTypeInfo("EActorFaction", WriteEnumJson<"EActorFaction">, WriteEnumJsonSimple<"EActorFaction">);
static ZHMTypeInfo SoundPlayState_TypeInfo = ZHMTypeInfo("SoundPlayState", WriteEnumJson<"SoundPlayState">, WriteEnumJsonSimple<"SoundPlayState">);
static ZHMTypeInfo ECausalGraphTraversal_TypeInfo = ZHMTypeInfo("ECausalGraphTraversal", WriteEnumJson<"ECausalGraphTraversal">, WriteEnumJsonSimple<"ECausalGraphTraversal">);
static ZHMTypeInfo EPushNotificationType_TypeInfo = ZHMTypeInfo("EPushNotificationType", WriteEnumJson<"EPushNotificationType">, WriteEnumJsonSimple<"EPushNotificationType">);
static ZHMTypeInfo ZCharacterSpeakCondition_EState_TypeInfo = ZHMTypeInfo("ZCharacterSpeakCondition.EState", WriteEnumJson<"ZCharacterSpeakCondition.EState">, WriteEnumJsonSimple<"ZCharacterSpeakCondition.EState">);
static ZHMTypeInfo EVRRenderDeviceType_TypeInfo = ZHMTypeInfo("EVRRenderDeviceType", WriteEnumJson<"EVRRenderDeviceType">, WriteEnumJsonSimple<"EVRRenderDeviceType">);
static ZHMTypeInfo IHM5Door_EOpenDir_TypeInfo = ZHMTypeInfo("IHM5Door.EOpenDir", WriteEnumJson<"IHM5Door.EOpenDir">, WriteEnumJsonSimple<"IHM5Door.EOpenDir">);
static ZHMTypeInfo EDamageResponse_TypeInfo = ZHMTypeInfo("EDamageResponse", WriteEnumJson<"EDamageResponse">, WriteEnumJsonSimple<"EDamageResponse">);
static ZHMTypeInfo EInventoryConfigFormerEquippedItems_TypeInfo = ZHMTypeInfo("EInventoryConfigFormerEquippedItems", WriteEnumJson<"EInventoryConfigFormerEquippedItems">, WriteEnumJsonSimple<"EInventoryConfigFormerEquippedItems">);
static ZHMTypeInfo ESituationJoinReason_TypeInfo = ZHMTypeInfo("ESituationJoinReason", WriteEnumJson<"ESituationJoinReason">, WriteEnumJsonSimple<"ESituationJoinReason">);
static ZHMTypeInfo UIMapLayer_EUIMapLayerID_TypeInfo = ZHMTypeInfo("UIMapLayer.EUIMapLayerID", WriteEnumJson<"UIMapLayer.EUIMapLayerID">, WriteEnumJsonSimple<"UIMapLayer.EUIMapLayerID">);
static ZHMTypeInfo EScreenplayStateFlag_TypeInfo = ZHMTypeInfo("EScreenplayStateFlag", WriteEnumJson<"EScreenplayStateFlag">, WriteEnumJsonSimple<"EScreenplayStateFlag">);
static ZHMTypeInfo ENetPlayerEvent_TypeInfo = ZHMTypeInfo("ENetPlayerEvent", WriteEnumJson<"ENetPlayerEvent">, WriteEnumJsonSimple<"ENetPlayerEvent">);
static ZHMTypeInfo ZCoverPlane_ECoverType_TypeInfo = ZHMTypeInfo("ZCoverPlane.ECoverType", WriteEnumJson<"ZCoverPlane.ECoverType">, WriteEnumJsonSimple<"ZCoverPlane.ECoverType">);
static ZHMTypeInfo ECameraOffset_old_TypeInfo = ZHMTypeInfo("ECameraOffset_old", WriteEnumJson<"ECameraOffset_old">, WriteEnumJsonSimple<"ECameraOffset_old">);
static ZHMTypeInfo EVRConfigCapsuleGridSize_TypeInfo = ZHMTypeInfo("EVRConfigCapsuleGridSize", WriteEnumJson<"EVRConfigCapsuleGridSize">, WriteEnumJsonSimple<"EVRConfigCapsuleGridSize">);
static ZHMTypeInfo ECompiledConditionType_TypeInfo = ZHMTypeInfo("ECompiledConditionType", WriteEnumJson<"ECompiledConditionType">, WriteEnumJsonSimple<"ECompiledConditionType">);
static ZHMTypeInfo EItemGripType_TypeInfo = ZHMTypeInfo("EItemGripType", WriteEnumJson<"EItemGripType">, WriteEnumJsonSimple<"EItemGripType">);
static ZHMTypeInfo EUIBusyState_TypeInfo = ZHMTypeInfo("EUIBusyState", WriteEnumJson<"EUIBusyState">, WriteEnumJsonSimple<"EUIBusyState">);
static ZHMTypeInfo EBulletType_TypeInfo = ZHMTypeInfo("EBulletType", WriteEnumJson<"EBulletType">, WriteEnumJsonSimple<"EBulletType">);
static ZHMTypeInfo EPathFinderBoxType_TypeInfo = ZHMTypeInfo("EPathFinderBoxType", WriteEnumJson<"EPathFinderBoxType">, WriteEnumJsonSimple<"EPathFinderBoxType">);
static ZHMTypeInfo ZVRHUDWristAlignmentController_EAxis_TypeInfo = ZHMTypeInfo("ZVRHUDWristAlignmentController.EAxis", WriteEnumJson<"ZVRHUDWristAlignmentController.EAxis">, WriteEnumJsonSimple<"ZVRHUDWristAlignmentController.EAxis">);
static ZHMTypeInfo EMotionType_TypeInfo = ZHMTypeInfo("EMotionType", WriteEnumJson<"EMotionType">, WriteEnumJsonSimple<"EMotionType">);
static ZHMTypeInfo ECharacterStateTags_TypeInfo = ZHMTypeInfo("ECharacterStateTags", WriteEnumJson<"ECharacterStateTags">, WriteEnumJsonSimple<"ECharacterStateTags">);
static ZHMTypeInfo ECCDUsage_TypeInfo = ZHMTypeInfo("ECCDUsage", WriteEnumJson<"ECCDUsage">, WriteEnumJsonSimple<"ECCDUsage">);
static ZHMTypeInfo ZUIControlEntity_EAlignment_TypeInfo = ZHMTypeInfo("ZUIControlEntity.EAlignment", WriteEnumJson<"ZUIControlEntity.EAlignment">, WriteEnumJsonSimple<"ZUIControlEntity.EAlignment">);
static ZHMTypeInfo EAmmoBehaviourConfigType_TypeInfo = ZHMTypeInfo("EAmmoBehaviourConfigType", WriteEnumJson<"EAmmoBehaviourConfigType">, WriteEnumJsonSimple<"EAmmoBehaviourConfigType">);
static ZHMTypeInfo ZHM5BodyContainer_eBCCloseMode_TypeInfo = ZHMTypeInfo("ZHM5BodyContainer.eBCCloseMode", WriteEnumJson<"ZHM5BodyContainer.eBCCloseMode">, WriteEnumJsonSimple<"ZHM5BodyContainer.eBCCloseMode">);
static ZHMTypeInfo EFSMStateStatus_TypeInfo = ZHMTypeInfo("EFSMStateStatus", WriteEnumJson<"EFSMStateStatus">, WriteEnumJsonSimple<"EFSMStateStatus">);
static ZHMTypeInfo EHM5SoundFootstepEvent_TypeInfo = ZHMTypeInfo("EHM5SoundFootstepEvent", WriteEnumJson<"EHM5SoundFootstepEvent">, WriteEnumJsonSimple<"EHM5SoundFootstepEvent">);
static ZHMTypeInfo ZHM5ValueEntity_bool_EForwardRule_TypeInfo = ZHMTypeInfo("ZHM5ValueEntity_bool.EForwardRule", WriteEnumJson<"ZHM5ValueEntity_bool.EForwardRule">, WriteEnumJsonSimple<"ZHM5ValueEntity_bool.EForwardRule">);
static ZHMTypeInfo Network_PacketReliability_TypeInfo = ZHMTypeInfo("Network.PacketReliability", WriteEnumJson<"Network.PacketReliability">, WriteEnumJsonSimple<"Network.PacketReliability">);
static ZHMTypeInfo IContractObjective_State_TypeInfo = ZHMTypeInfo("IContractObjective.State", WriteEnumJson<"IContractObjective.State">, WriteEnumJsonSimple<"IContractObjective.State">);
static ZHMTypeInfo ZActorDebugEntity_EActorDebugColor_TypeInfo = ZHMTypeInfo("ZActorDebugEntity.EActorDebugColor", WriteEnumJson<"ZActorDebugEntity.EActorDebugColor">, WriteEnumJsonSimple<"ZActorDebugEntity.EActorDebugColor">);
static ZHMTypeInfo ERenderVRTrackingID_TypeInfo = ZHMTypeInfo("ERenderVRTrackingID", WriteEnumJson<"ERenderVRTrackingID">, WriteEnumJsonSimple<"ERenderVRTrackingID">);
static ZHMTypeInfo EMoveSpeed_TypeInfo = ZHMTypeInfo("EMoveSpeed", WriteEnumJson<"EMoveSpeed">, WriteEnumJsonSimple<"EMoveSpeed">);
static ZHMTypeInfo EDeathContext_TypeInfo = ZHMTypeInfo("EDeathContext", WriteEnumJson<"EDeathContext">, WriteEnumJsonSimple<"EDeathContext">);
static ZHMTypeInfo ECoordinateSpace_TypeInfo = ZHMTypeInfo("ECoordinateSpace", WriteEnumJson<"ECoordinateSpace">, WriteEnumJsonSimple<"ECoordinateSpace">);
static ZHMTypeInfo ECameraAssistanceMode_TypeInfo = ZHMTypeInfo("ECameraAssistanceMode", WriteEnumJson<"ECameraAssistanceMode">, WriteEnumJsonSimple<"ECameraAssistanceMode">);
static ZHMTypeInfo ZUIListNavigationEntity_ENavigationInputMode_TypeInfo = ZHMTypeInfo("ZUIListNavigationEntity.ENavigationInputMode", WriteEnumJson<"ZUIListNavigationEntity.ENavigationInputMode">, WriteEnumJsonSimple<"ZUIListNavigationEntity.ENavigationInputMode">);
static ZHMTypeInfo EExtendedPropertyType_TypeInfo = ZHMTypeInfo("EExtendedPropertyType", WriteEnumJson<"EExtendedPropertyType">, WriteEnumJsonSimple<"EExtendedPropertyType">);
static ZHMTypeInfo ERegistrationState_TypeInfo = ZHMTypeInfo("ERegistrationState", WriteEnumJson<"ERegistrationState">, WriteEnumJsonSimple<"ERegistrationState">);
static ZHMTypeInfo EDisconnectReason_TypeInfo = ZHMTypeInfo("EDisconnectReason", WriteEnumJson<"EDisconnectReason">, WriteEnumJsonSimple<"EDisconnectReason">);
static ZHMTypeInfo EIntelStage_TypeInfo = ZHMTypeInfo("EIntelStage", WriteEnumJson<"EIntelStage">, WriteEnumJsonSimple<"EIntelStage">);
static ZHMTypeInfo EActorVoiceVariation_TypeInfo = ZHMTypeInfo("EActorVoiceVariation", WriteEnumJson<"EActorVoiceVariation">, WriteEnumJsonSimple<"EActorVoiceVariation">);
static ZHMTypeInfo ECharacterAnimChildNetworkSlot_TypeInfo = ZHMTypeInfo("ECharacterAnimChildNetworkSlot", WriteEnumJson<"ECharacterAnimChildNetworkSlot">, WriteEnumJsonSimple<"ECharacterAnimChildNetworkSlot">);
static ZHMTypeInfo EStealthSituation_TypeInfo = ZHMTypeInfo("EStealthSituation", WriteEnumJson<"EStealthSituation">, WriteEnumJsonSimple<"EStealthSituation">);
static ZHMTypeInfo ZHeroKeywordCondition_EEvaluationType_TypeInfo = ZHMTypeInfo("ZHeroKeywordCondition.EEvaluationType", WriteEnumJson<"ZHeroKeywordCondition.EEvaluationType">, WriteEnumJsonSimple<"ZHeroKeywordCondition.EEvaluationType">);
static ZHMTypeInfo EAudioVolumetricMixingMode_TypeInfo = ZHMTypeInfo("EAudioVolumetricMixingMode", WriteEnumJson<"EAudioVolumetricMixingMode">, WriteEnumJsonSimple<"EAudioVolumetricMixingMode">);
static ZHMTypeInfo ZActorBoneAttachEntity_EResetMode_TypeInfo = ZHMTypeInfo("ZActorBoneAttachEntity.EResetMode", WriteEnumJson<"ZActorBoneAttachEntity.EResetMode">, WriteEnumJsonSimple<"ZActorBoneAttachEntity.EResetMode">);
static ZHMTypeInfo IHM5Door_ECPDoorLockType_TypeInfo = ZHMTypeInfo("IHM5Door.ECPDoorLockType", WriteEnumJson<"IHM5Door.ECPDoorLockType">, WriteEnumJsonSimple<"IHM5Door.ECPDoorLockType">);
static ZHMTypeInfo EActorRank_TypeInfo = ZHMTypeInfo("EActorRank", WriteEnumJson<"EActorRank">, WriteEnumJsonSimple<"EActorRank">);
static ZHMTypeInfo EPersistentBoolDataSyncType_TypeInfo = ZHMTypeInfo("EPersistentBoolDataSyncType", WriteEnumJson<"EPersistentBoolDataSyncType">, WriteEnumJsonSimple<"EPersistentBoolDataSyncType">);
static ZHMTypeInfo ESaveLoadStatus_TypeInfo = ZHMTypeInfo("ESaveLoadStatus", WriteEnumJson<"ESaveLoadStatus">, WriteEnumJsonSimple<"ESaveLoadStatus">);
static ZHMTypeInfo ESituationAvailability_TypeInfo = ZHMTypeInfo("ESituationAvailability", WriteEnumJson<"ESituationAvailability">, WriteEnumJsonSimple<"ESituationAvailability">);
static ZHMTypeInfo EEntityOrdering_TypeInfo = ZHMTypeInfo("EEntityOrdering", WriteEnumJson<"EEntityOrdering">, WriteEnumJsonSimple<"EEntityOrdering">);
static ZHMTypeInfo EAccidentDeathContext_TypeInfo = ZHMTypeInfo("EAccidentDeathContext", WriteEnumJson<"EAccidentDeathContext">, WriteEnumJsonSimple<"EAccidentDeathContext">);
static ZHMTypeInfo EActorType_TypeInfo = ZHMTypeInfo("EActorType", WriteEnumJson<"EActorType">, WriteEnumJsonSimple<"EActorType">);
static ZHMTypeInfo EDialogEventItemType_TypeInfo = ZHMTypeInfo("EDialogEventItemType", WriteEnumJson<"EDialogEventItemType">, WriteEnumJsonSimple<"EDialogEventItemType">);
static ZHMTypeInfo ZAT2Controller_EFoot_TypeInfo = ZHMTypeInfo("ZAT2Controller.EFoot", WriteEnumJson<"ZAT2Controller.EFoot">, WriteEnumJsonSimple<"ZAT2Controller.EFoot">);
static ZHMTypeInfo ECharacterUpperBodyStateType_TypeInfo = ZHMTypeInfo("ECharacterUpperBodyStateType", WriteEnumJson<"ECharacterUpperBodyStateType">, WriteEnumJsonSimple<"ECharacterUpperBodyStateType">);
static ZHMTypeInfo ZDecalControllerEntity_ERotationType_TypeInfo = ZHMTypeInfo("ZDecalControllerEntity.ERotationType", WriteEnumJson<"ZDecalControllerEntity.ERotationType">, WriteEnumJsonSimple<"ZDecalControllerEntity.ERotationType">);
static ZHMTypeInfo IScatterContainerEntity_EBrushType_TypeInfo = ZHMTypeInfo("IScatterContainerEntity.EBrushType", WriteEnumJson<"IScatterContainerEntity.EBrushType">, WriteEnumJsonSimple<"IScatterContainerEntity.EBrushType">);
static ZHMTypeInfo EBaseMovementType_TypeInfo = ZHMTypeInfo("EBaseMovementType", WriteEnumJson<"EBaseMovementType">, WriteEnumJsonSimple<"EBaseMovementType">);
static ZHMTypeInfo ZHM5LedgeMount_EFaceDirection_TypeInfo = ZHMTypeInfo("ZHM5LedgeMount.EFaceDirection", WriteEnumJson<"ZHM5LedgeMount.EFaceDirection">, WriteEnumJsonSimple<"ZHM5LedgeMount.EFaceDirection">);
static ZHMTypeInfo ZMoveToPositionBehaviorEntity_EApproachAlignment_TypeInfo = ZHMTypeInfo("ZMoveToPositionBehaviorEntity.EApproachAlignment", WriteEnumJson<"ZMoveToPositionBehaviorEntity.EApproachAlignment">, WriteEnumJsonSimple<"ZMoveToPositionBehaviorEntity.EApproachAlignment">);
static ZHMTypeInfo EClothBendConstrainType_TypeInfo = ZHMTypeInfo("EClothBendConstrainType", WriteEnumJson<"EClothBendConstrainType">, WriteEnumJsonSimple<"EClothBendConstrainType">);
static ZHMTypeInfo ERoleEvent_TypeInfo = ZHMTypeInfo("ERoleEvent", WriteEnumJson<"ERoleEvent">, WriteEnumJsonSimple<"ERoleEvent">);
static ZHMTypeInfo ZWorldUIElementInstanceBase_EVisibility_TypeInfo = ZHMTypeInfo("ZWorldUIElementInstanceBase.EVisibility", WriteEnumJson<"ZWorldUIElementInstanceBase.EVisibility">, WriteEnumJsonSimple<"ZWorldUIElementInstanceBase.EVisibility">);
static ZHMTypeInfo EHUDIconFlags_TypeInfo = ZHMTypeInfo("EHUDIconFlags", WriteEnumJson<"EHUDIconFlags">, WriteEnumJsonSimple<"EHUDIconFlags">);
static ZHMTypeInfo EDeathAnimationType_TypeInfo = ZHMTypeInfo("EDeathAnimationType", WriteEnumJson<"EDeathAnimationType">, WriteEnumJsonSimple<"EDeathAnimationType">);
static ZHMTypeInfo ZCautiousInvestigateGroup_EAssistantState_TypeInfo = ZHMTypeInfo("ZCautiousInvestigateGroup.EAssistantState", WriteEnumJson<"ZCautiousInvestigateGroup.EAssistantState">, WriteEnumJsonSimple<"ZCautiousInvestigateGroup.EAssistantState">);
static ZHMTypeInfo ZHM5Animator_EBoneAnimator_TypeInfo = ZHMTypeInfo("ZHM5Animator.EBoneAnimator", WriteEnumJson<"ZHM5Animator.EBoneAnimator">, WriteEnumJsonSimple<"ZHM5Animator.EBoneAnimator">);
static ZHMTypeInfo ERestitutionCombineMode_TypeInfo = ZHMTypeInfo("ERestitutionCombineMode", WriteEnumJson<"ERestitutionCombineMode">, WriteEnumJsonSimple<"ERestitutionCombineMode">);
static ZHMTypeInfo ECharacterIdlePriority_TypeInfo = ZHMTypeInfo("ECharacterIdlePriority", WriteEnumJson<"ECharacterIdlePriority">, WriteEnumJsonSimple<"ECharacterIdlePriority">);
static ZHMTypeInfo ZSequenceEntity_ECommand_TypeInfo = ZHMTypeInfo("ZSequenceEntity.ECommand", WriteEnumJson<"ZSequenceEntity.ECommand">, WriteEnumJsonSimple<"ZSequenceEntity.ECommand">);
static ZHMTypeInfo ZVRCameraEntity_EEye_TypeInfo = ZHMTypeInfo("ZVRCameraEntity.EEye", WriteEnumJson<"ZVRCameraEntity.EEye">, WriteEnumJsonSimple<"ZVRCameraEntity.EEye">);
static ZHMTypeInfo EDisposalType_TypeInfo = ZHMTypeInfo("EDisposalType", WriteEnumJson<"EDisposalType">, WriteEnumJsonSimple<"EDisposalType">);
static ZHMTypeInfo EDynamicVariableType_TypeInfo = ZHMTypeInfo("EDynamicVariableType", WriteEnumJson<"EDynamicVariableType">, WriteEnumJsonSimple<"EDynamicVariableType">);
static ZHMTypeInfo EButtonState_TypeInfo = ZHMTypeInfo("EButtonState", WriteEnumJson<"EButtonState">, WriteEnumJsonSimple<"EButtonState">);
static ZHMTypeInfo ZHM5AgilityEventConsumer_EEvent_TypeInfo = ZHMTypeInfo("ZHM5AgilityEventConsumer.EEvent", WriteEnumJson<"ZHM5AgilityEventConsumer.EEvent">, WriteEnumJsonSimple<"ZHM5AgilityEventConsumer.EEvent">);
static ZHMTypeInfo ZHM5BodyContainer_EBCState_TypeInfo = ZHMTypeInfo("ZHM5BodyContainer.EBCState", WriteEnumJson<"ZHM5BodyContainer.EBCState">, WriteEnumJsonSimple<"ZHM5BodyContainer.EBCState">);
static ZHMTypeInfo ZHM5Item_EKeywordEvaluationType_TypeInfo = ZHMTypeInfo("ZHM5Item.EKeywordEvaluationType", WriteEnumJson<"ZHM5Item.EKeywordEvaluationType">, WriteEnumJsonSimple<"ZHM5Item.EKeywordEvaluationType">);
static ZHMTypeInfo InputControlNamesp_eHM5InputActionID_TypeInfo = ZHMTypeInfo("InputControlNamesp.eHM5InputActionID", WriteEnumJson<"InputControlNamesp.eHM5InputActionID">, WriteEnumJsonSimple<"InputControlNamesp.eHM5InputActionID">);
static ZHMTypeInfo JSONTemplate_ETemplateType_TypeInfo = ZHMTypeInfo("JSONTemplate.ETemplateType", WriteEnumJson<"JSONTemplate.ETemplateType">, WriteEnumJsonSimple<"JSONTemplate.ETemplateType">);
static ZHMTypeInfo ZMirrorEntity_EMirrorQuality_TypeInfo = ZHMTypeInfo("ZMirrorEntity.EMirrorQuality", WriteEnumJson<"ZMirrorEntity.EMirrorQuality">, WriteEnumJsonSimple<"ZMirrorEntity.EMirrorQuality">);
static ZHMTypeInfo EWeaponAnimationCategory_TypeInfo = ZHMTypeInfo("EWeaponAnimationCategory", WriteEnumJson<"EWeaponAnimationCategory">, WriteEnumJsonSimple<"EWeaponAnimationCategory">);
static ZHMTypeInfo EAILegalType_TypeInfo = ZHMTypeInfo("EAILegalType", WriteEnumJson<"EAILegalType">, WriteEnumJsonSimple<"EAILegalType">);
static ZHMTypeInfo ZActorPickerFilterGroup_EEvaluationType_TypeInfo = ZHMTypeInfo("ZActorPickerFilterGroup.EEvaluationType", WriteEnumJson<"ZActorPickerFilterGroup.EEvaluationType">, WriteEnumJsonSimple<"ZActorPickerFilterGroup.EEvaluationType">);
static ZHMTypeInfo ZHM5HitmanHealthModifier_EHealthValue_TypeInfo = ZHMTypeInfo("ZHM5HitmanHealthModifier.EHealthValue", WriteEnumJson<"ZHM5HitmanHealthModifier.EHealthValue">, WriteEnumJsonSimple<"ZHM5HitmanHealthModifier.EHealthValue">);
static ZHMTypeInfo EConversationID_TypeInfo = ZHMTypeInfo("EConversationID", WriteEnumJson<"EConversationID">, WriteEnumJsonSimple<"EConversationID">);
static ZHMTypeInfo ZDebugTextEntity_EHorizontalAlignment_TypeInfo = ZHMTypeInfo("ZDebugTextEntity.EHorizontalAlignment", WriteEnumJson<"ZDebugTextEntity.EHorizontalAlignment">, WriteEnumJsonSimple<"ZDebugTextEntity.EHorizontalAlignment">);
static ZHMTypeInfo EClipSpawnAxis_TypeInfo = ZHMTypeInfo("EClipSpawnAxis", WriteEnumJson<"EClipSpawnAxis">, WriteEnumJsonSimple<"EClipSpawnAxis">);
static ZHMTypeInfo EMeBarState_TypeInfo = ZHMTypeInfo("EMeBarState", WriteEnumJson<"EMeBarState">, WriteEnumJsonSimple<"EMeBarState">);
static ZHMTypeInfo ECameraCollisionMode_TypeInfo = ZHMTypeInfo("ECameraCollisionMode", WriteEnumJson<"ECameraCollisionMode">, WriteEnumJsonSimple<"ECameraCollisionMode">);
static ZHMTypeInfo EClothStretchConstrainType_TypeInfo = ZHMTypeInfo("EClothStretchConstrainType", WriteEnumJson<"EClothStretchConstrainType">, WriteEnumJsonSimple<"EClothStretchConstrainType">);
static ZHMTypeInfo ENamedGameEvents_TypeInfo = ZHMTypeInfo("ENamedGameEvents", WriteEnumJson<"ENamedGameEvents">, WriteEnumJsonSimple<"ENamedGameEvents">);
static ZHMTypeInfo ZDebugTextEntity_EVerticalAlignment_TypeInfo = ZHMTypeInfo("ZDebugTextEntity.EVerticalAlignment", WriteEnumJson<"ZDebugTextEntity.EVerticalAlignment">, WriteEnumJsonSimple<"ZDebugTextEntity.EVerticalAlignment">);
static ZHMTypeInfo ZSetUIControlDisplayInfoEntity_EProjectionOp_TypeInfo = ZHMTypeInfo("ZSetUIControlDisplayInfoEntity.EProjectionOp", WriteEnumJson<"ZSetUIControlDisplayInfoEntity.EProjectionOp">, WriteEnumJsonSimple<"ZSetUIControlDisplayInfoEntity.EProjectionOp">);
static ZHMTypeInfo ZDistanceCondition_EObjectType_TypeInfo = ZHMTypeInfo("ZDistanceCondition.EObjectType", WriteEnumJson<"ZDistanceCondition.EObjectType">, WriteEnumJsonSimple<"ZDistanceCondition.EObjectType">);
static ZHMTypeInfo EHM5SoundFootstepEmitterTarget_TypeInfo = ZHMTypeInfo("EHM5SoundFootstepEmitterTarget", WriteEnumJson<"EHM5SoundFootstepEmitterTarget">, WriteEnumJsonSimple<"EHM5SoundFootstepEmitterTarget">);
static ZHMTypeInfo EGuardPointType_TypeInfo = ZHMTypeInfo("EGuardPointType", WriteEnumJson<"EGuardPointType">, WriteEnumJsonSimple<"EGuardPointType">);
static ZHMTypeInfo ECharacterEvent_TypeInfo = ZHMTypeInfo("ECharacterEvent", WriteEnumJson<"ECharacterEvent">, WriteEnumJsonSimple<"ECharacterEvent">);
static ZHMTypeInfo ECharacterIdleHandlerUpperBodyType_TypeInfo = ZHMTypeInfo("ECharacterIdleHandlerUpperBodyType", WriteEnumJson<"ECharacterIdleHandlerUpperBodyType">, WriteEnumJsonSimple<"ECharacterIdleHandlerUpperBodyType">);
static ZHMTypeInfo ECharacterBodyType_TypeInfo = ZHMTypeInfo("ECharacterBodyType", WriteEnumJson<"ECharacterBodyType">, WriteEnumJsonSimple<"ECharacterBodyType">);
static ZHMTypeInfo EAimAssistActivationState_TypeInfo = ZHMTypeInfo("EAimAssistActivationState", WriteEnumJson<"EAimAssistActivationState">, WriteEnumJsonSimple<"EAimAssistActivationState">);
static ZHMTypeInfo ZHM5BodyContainer_EBCAnimSet_TypeInfo = ZHMTypeInfo("ZHM5BodyContainer.EBCAnimSet", WriteEnumJson<"ZHM5BodyContainer.EBCAnimSet">, WriteEnumJsonSimple<"ZHM5BodyContainer.EBCAnimSet">);
static ZHMTypeInfo ELedgeDismountDirection_TypeInfo = ZHMTypeInfo("ELedgeDismountDirection", WriteEnumJson<"ELedgeDismountDirection">, WriteEnumJsonSimple<"ELedgeDismountDirection">);
static ZHMTypeInfo ETargetPrintDestination_TypeInfo = ZHMTypeInfo("ETargetPrintDestination", WriteEnumJson<"ETargetPrintDestination">, WriteEnumJsonSimple<"ETargetPrintDestination">);
static ZHMTypeInfo ZHUDWorldSpatialAttachEntity_EOrientation_TypeInfo = ZHMTypeInfo("ZHUDWorldSpatialAttachEntity.EOrientation", WriteEnumJson<"ZHUDWorldSpatialAttachEntity.EOrientation">, WriteEnumJsonSimple<"ZHUDWorldSpatialAttachEntity.EOrientation">);
static ZHMTypeInfo eParticleEmitterBoxEntity_SpawnModes_TypeInfo = ZHMTypeInfo("eParticleEmitterBoxEntity_SpawnModes", WriteEnumJson<"eParticleEmitterBoxEntity_SpawnModes">, WriteEnumJsonSimple<"eParticleEmitterBoxEntity_SpawnModes">);
static ZHMTypeInfo EDeathType_TypeInfo = ZHMTypeInfo("EDeathType", WriteEnumJson<"EDeathType">, WriteEnumJsonSimple<"EDeathType">);
static ZHMTypeInfo ECommunicationBarMessage_TypeInfo = ZHMTypeInfo("ECommunicationBarMessage", WriteEnumJson<"ECommunicationBarMessage">, WriteEnumJsonSimple<"ECommunicationBarMessage">);
static ZHMTypeInfo ZHUDCamera3DControllerEntity_EType_TypeInfo = ZHMTypeInfo("ZHUDCamera3DControllerEntity.EType", WriteEnumJson<"ZHUDCamera3DControllerEntity.EType">, WriteEnumJsonSimple<"ZHUDCamera3DControllerEntity.EType">);
static ZHMTypeInfo EThrowType_TypeInfo = ZHMTypeInfo("EThrowType", WriteEnumJson<"EThrowType">, WriteEnumJsonSimple<"EThrowType">);
static ZHMTypeInfo EDetectedNatType_TypeInfo = ZHMTypeInfo("EDetectedNatType", WriteEnumJson<"EDetectedNatType">, WriteEnumJsonSimple<"EDetectedNatType">);
static ZHMTypeInfo ILightEntity_ERoomLightFlow_TypeInfo = ZHMTypeInfo("ILightEntity.ERoomLightFlow", WriteEnumJson<"ILightEntity.ERoomLightFlow">, WriteEnumJsonSimple<"ILightEntity.ERoomLightFlow">);
static ZHMTypeInfo ECrossHairType_TypeInfo = ZHMTypeInfo("ECrossHairType", WriteEnumJson<"ECrossHairType">, WriteEnumJsonSimple<"ECrossHairType">);
static ZHMTypeInfo EMarkerClipAlgorithm_TypeInfo = ZHMTypeInfo("EMarkerClipAlgorithm", WriteEnumJson<"EMarkerClipAlgorithm">, WriteEnumJsonSimple<"EMarkerClipAlgorithm">);
static ZHMTypeInfo ZHeroBoneAttachEntity_EResetMode_TypeInfo = ZHMTypeInfo("ZHeroBoneAttachEntity.EResetMode", WriteEnumJson<"ZHeroBoneAttachEntity.EResetMode">, WriteEnumJsonSimple<"ZHeroBoneAttachEntity.EResetMode">);
static ZHMTypeInfo eBurstPatternType_TypeInfo = ZHMTypeInfo("eBurstPatternType", WriteEnumJson<"eBurstPatternType">, WriteEnumJsonSimple<"eBurstPatternType">);
static ZHMTypeInfo EQueryMaskType_TypeInfo = ZHMTypeInfo("EQueryMaskType", WriteEnumJson<"EQueryMaskType">, WriteEnumJsonSimple<"EQueryMaskType">);
static ZHMTypeInfo ZPointOfInterestEntity_EPOIType_TypeInfo = ZHMTypeInfo("ZPointOfInterestEntity.EPOIType", WriteEnumJson<"ZPointOfInterestEntity.EPOIType">, WriteEnumJsonSimple<"ZPointOfInterestEntity.EPOIType">);
static ZHMTypeInfo EGait_TypeInfo = ZHMTypeInfo("EGait", WriteEnumJson<"EGait">, WriteEnumJsonSimple<"EGait">);
static ZHMTypeInfo EAIGoal_TypeInfo = ZHMTypeInfo("EAIGoal", WriteEnumJson<"EAIGoal">, WriteEnumJsonSimple<"EAIGoal">);
static ZHMTypeInfo ECharacterResourceType_TypeInfo = ZHMTypeInfo("ECharacterResourceType", WriteEnumJson<"ECharacterResourceType">, WriteEnumJsonSimple<"ECharacterResourceType">);
...
static ZHMTypeInfo EDisturbanceType_TypeInfo = ZHMTypeInfo("EDisturbanceType", WriteEnumJson<"EDisturbanceType">, WriteEnumJsonSimple<"EDisturbanceType">);
static ZHMTypeInfo IRenderMaterialEntity_EModifierOperation_TypeInfo = ZHMTypeInfo("IRenderMaterialEntity.EModifierOperation", WriteEnumJson<"IRenderMaterialEntity.EModifierOperation">, WriteEnumJsonSimple<"IRenderMaterialEntity.EModifierOperation">);
static ZHMTypeInfo ZBoxReflectionEntity_EType_TypeInfo = ZHMTypeInfo("ZBoxReflectionEntity.EType", WriteEnumJson<"ZBoxReflectionEntity.EType">, WriteEnumJsonSimple<"ZBoxReflectionEntity.EType">);
static ZHMTypeInfo ZGetHelpGroup_EInvestigateGroupState_TypeInfo = ZHMTypeInfo("ZGetHelpGroup.EInvestigateGroupState", WriteEnumJson<"ZGetHelpGroup.EInvestigateGroupState">, WriteEnumJsonSimple<"ZGetHelpGroup.EInvestigateGroupState">);
static ZHMTypeInfo ECollisionNotifyGroup_TypeInfo = ZHMTypeInfo("ECollisionNotifyGroup", WriteEnumJson<"ECollisionNotifyGroup">, WriteEnumJsonSimple<"ECollisionNotifyGroup">);
static ZHMTypeInfo ECharSetCharacterType_TypeInfo = ZHMTypeInfo("ECharSetCharacterType", WriteEnumJson<"ECharSetCharacterType">, WriteEnumJsonSimple<"ECharSetCharacterType">);
static ZHMTypeInfo EActorGroup_TypeInfo = ZHMTypeInfo("EActorGroup", WriteEnumJson<"EActorGroup">, WriteEnumJsonSimple<"EActorGroup">);
static ZHMTypeInfo InputControlNamesp_eHM5InputAction_TypeInfo = ZHMTypeInfo("InputControlNamesp.eHM5InputAction", WriteEnumJson<"InputControlNamesp.eHM5InputAction">, WriteEnumJsonSimple<"InputControlNamesp.eHM5InputAction">);
static ZHMTypeInfo EAISharedEventType_TypeInfo = ZHMTypeInfo("EAISharedEventType", WriteEnumJson<"EAISharedEventType">, WriteEnumJsonSimple<"EAISharedEventType">);
static ZHMTypeInfo ZPathfinderDebugEntity_EDebugTestType_TypeInfo = ZHMTypeInfo("ZPathfinderDebugEntity.EDebugTestType", WriteEnumJson<"ZPathfinderDebugEntity.EDebugTestType">, WriteEnumJsonSimple<"ZPathfinderDebugEntity.EDebugTestType">);
static ZHMTypeInfo ECombatZoneState_TypeInfo = ZHMTypeInfo("ECombatZoneState", WriteEnumJson<"ECombatZoneState">, WriteEnumJsonSimple<"ECombatZoneState">);
static ZHMTypeInfo ELocale_TypeInfo = ZHMTypeInfo("ELocale", WriteEnumJson<"ELocale">, WriteEnumJsonSimple<"ELocale">);
static ZHMTypeInfo EGameUIMenu_TypeInfo = ZHMTypeInfo("EGameUIMenu", WriteEnumJson<"EGameUIMenu">, WriteEnumJsonSimple<"EGameUIMenu">);
static ZHMTypeInfo EAutoScanMode_TypeInfo = ZHMTypeInfo("EAutoScanMode", WriteEnumJson<"EAutoScanMode">, WriteEnumJsonSimple<"EAutoScanMode">);
static ZHMTypeInfo ENetRole_TypeInfo = ZHMTypeInfo("ENetRole", WriteEnumJson<"ENetRole">, WriteEnumJsonSimple<"ENetRole">);
static ZHMTypeInfo EActorCCPreset_TypeInfo = ZHMTypeInfo("EActorCCPreset", WriteEnumJson<"EActorCCPreset">, WriteEnumJsonSimple<"EActorCCPreset">);
static ZHMTypeInfo EItemRequirement_TypeInfo = ZHMTypeInfo("EItemRequirement", WriteEnumJson<"EItemRequirement">, WriteEnumJsonSimple<"EItemRequirement">);
static ZHMTypeInfo EClothColliderFilter_TypeInfo = ZHMTypeInfo("EClothColliderFilter", WriteEnumJson<"EClothColliderFilter">, WriteEnumJsonSimple<"EClothColliderFilter">);
static ZHMTypeInfo EVsGenericEvent_TypeInfo = ZHMTypeInfo("EVsGenericEvent", WriteEnumJson<"EVsGenericEvent">, WriteEnumJsonSimple<"EVsGenericEvent">);
static ZHMTypeInfo ESmartBehaviorOrder_TypeInfo = ZHMTypeInfo("ESmartBehaviorOrder", WriteEnumJson<"ESmartBehaviorOrder">, WriteEnumJsonSimple<"ESmartBehaviorOrder">);
static ZHMTypeInfo ZRagdollAttacherEntity_EResetMode_TypeInfo = ZHMTypeInfo("ZRagdollAttacherEntity.EResetMode", WriteEnumJson<"ZRagdollAttacherEntity.EResetMode">, WriteEnumJsonSimple<"ZRagdollAttacherEntity.EResetMode">);
