/*
	5/10/2021 - [REDACTED] Manually added classes : AI.SFirePattern01, AI.SFirePattern02 for 00EE8145B2B6DB36.TEMP and maybe others because the ZHMModSDK CodeGen mod currently doesn't work due to the recent H3 update.
	5/19/2021 - [REDACTED] Manually added class : STemplateEntityFactoryH2 and STemplateFactorySubEntityH2 for H2 STemplateEntityFactory (TEMP) file support
	5/20/2021 - [REDACTED] Manually added subEntities counts into the STemplateEntityFactory/STemplateEntityFactoryH2 (TEMP) and STemplateEntityBlueprint (TBLU) files to not only mimic IOI's TEMP and TBLU files, but help RPKG with version checking
*/
/*
...
// 0x0000000142AAEBD0 (Size: 0x4)
enum class SActorSoundDefs_EDefinition
{
	_NoSound = 0,
};

// 0x0000000142AB21F8 (Size: 0x4)
...
// (Size: 0x58)
class alignas(8) STemplateFactorySubEntityH2
{
public:
	static ZHMTypeInfo TypeInfo;
	static void WriteJson(void* p_Object, std::ostream& p_Stream);
...
// 0x0000000142AFC7E8 (Size: 0x58)
class alignas(8) STemplateEntityFactoryH2
{
public:
	static ZHMTypeInfo TypeInfo;
	static void WriteJson(void* p_Object, std::ostream& p_Stream);
	...
	int32 blueprintIndexInResourceHeader; // 0x4
	int32 rootEntityIndex; // 0x8
	TArray<STemplateFactorySubEntityH2> subEntities; // 0x10
	TArray<SEntityTemplatePropertyOverride> propertyOverrides; // 0x28
	TArray<int32> externalSceneTypeIndicesInResourceHeader; // 0x40
};

// 0x0000000142A94320 (Size: 0x4)
