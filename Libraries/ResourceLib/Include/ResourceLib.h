...
#define RL_TARGET_FUNC_FINAL(X, Y) HM ## X ## _ ## Y
#define RL_TARGET_FUNC_EVAL(X, Y) RL_TARGET_FUNC_FINAL(X, Y)
#define RL_TARGET_FUNC(FunctionName) RL_TARGET_FUNC_EVAL(RL_PREFIX, FunctionName)
...
extern "C"
{
	 ...
	 */
	EMSCRIPTEN_KEEPALIVE RESOURCELIB_API ResourceConverter* RL_TARGET_FUNC(GetConverterForResource)(const char* p_ResourceType);
	 ...
	 */
	EMSCRIPTEN_KEEPALIVE RESOURCELIB_API ResourceGenerator* RL_TARGET_FUNC(GetGeneratorForResource)(const char* p_ResourceType);
	 ...
	 */
	EMSCRIPTEN_KEEPALIVE RESOURCELIB_API ResourceTypesArray* RL_TARGET_FUNC(GetSupportedResourceTypes)();
	 ...
	 */
	EMSCRIPTEN_KEEPALIVE RESOURCELIB_API void RL_TARGET_FUNC(FreeSupportedResourceTypes)(ResourceTypesArray* p_Array);
	 ...
	 */
	EMSCRIPTEN_KEEPALIVE RESOURCELIB_API bool RL_TARGET_FUNC(IsResourceTypeSupported)(const char* p_ResourceType);
	 ...
	 */
	EMSCRIPTEN_KEEPALIVE RESOURCELIB_API JsonString* RL_TARGET_FUNC(GameStructToJson)(const char* p_StructureType, const void* p_Structure, size_t p_Size);
	 ...
	 */
	EMSCRIPTEN_KEEPALIVE RESOURCELIB_API bool RL_TARGET_FUNC(JsonToGameStruct)(const char* p_StructureType, const char* p_JsonStr, size_t p_JsonStrLength, void* p_TargetMemory, size_t p_TargetMemorySize);
	 ...
	 */
	EMSCRIPTEN_KEEPALIVE RESOURCELIB_API void RL_TARGET_FUNC(FreeJsonString)(JsonString* p_JsonString);
	 ...
	 */
	EMSCRIPTEN_KEEPALIVE RESOURCELIB_API StringView RL_TARGET_FUNC(GetPropertyName)(uint32_t p_PropertyId);

	/**
	 * Get the current allocator.
	 */
	EMSCRIPTEN_KEEPALIVE RESOURCELIB_API Allocator* RL_TARGET_FUNC(GetAllocator)();

	/**
	 * Set the allocator to use.
	 * Pass [nullptr] to reset to the default allocator.
	 */
	EMSCRIPTEN_KEEPALIVE RESOURCELIB_API void RL_TARGET_FUNC(SetAllocator)(Allocator* p_Allocator);
