...
void ZHMEnums::RegisterEnums()
{
	...
	(*g_Enums)["JSONTemplate.ETemplateType"] = {
		...
		{ 55, "ETT_UI_OPTION_AVAILABLE" },
		{ 56, "ETT_UI_OPTION_AVAILABLE_DISPLAY_RESOLUTIONS" },
		{ 57, "ETT_UI_OPTION_AVAILABLE_DISPLAY_FULLSCREEN" },
		{ 58, "ETT_UI_OPTION_AVAILABLE_MOTION_BLUR" },
		{ 59, "ETT_UI_OPTION_AVAILABLE_TEXTURE_QUALITY" },
		{ 60, "ETT_UI_OPTION_AVAILABLE_SHADOW_QUALITY" },
		{ 61, "ETT_UI_OPTION_AVAILABLE_SUPERSAMPLING" },
		{ 62, "ETT_UI_OPTION_AVAILABLE_DOUBLEFRAMERATE" },
		{ 63, "ETT_UI_OPTION_AVAILABLE_VRS" },
		{ 64, "ETT_UI_OPTION_CAN_CHANGE_DISPLAY_RESOLUTION" },
		{ 65, "ETT_CURRENT_CONTRACT_CONTEXT" },
		{ 66, "ETT_CURRENT_CONTRACT_OBJECTIVES" },
		{ 67, "ETT_CURRENT_CONTRACT_SESSIONID" },
		{ 68, "ETT_CURRENT_CONTRACT_CHARACTER_INFO" },
		{ 69, "ETT_CURRENT_CONTRACT_TRACKED_OPPORTUNITY" },
		{ 70, "ETT_CURRENT_DIFFICULTY" },
		{ 71, "ETT_CURRENT_ENGINE_MODE" },
		{ 72, "ETT_CURRENT_GAME_MODE" },
		{ 73, "ETT_CAN_SAVE" },
		{ 74, "ETT_IS_SAVELIMIT_EXCEEDED" },
		{ 75, "ETT_IS_ALLOWED_TO_RESTART" },
		{ 76, "ETT_ACTIVE_CHALLENGES" },
		{ 77, "ETT_USER" },
		{ 78, "ETT_ISUSER" },
		{ 79, "ETT_DLCCOUNT" },
		{ 80, "ETT_PROFILEID" },
		{ 81, "ETT_HDRGAMMAVALUERANGEMIN" },
		{ 82, "ETT_HDRGAMMAVALUERANGEMAX" },
		{ 83, "ETT_HDRGAMMAVALUESTEP" },
		{ 84, "ETT_ISDLSSAVAILABLE" },
		{ 85, "ETT_ISXESSAVAILABLE" },
		{ 86, "ETT_ISXESSINSTALLED" },
		{ 87, "ETT_ISHDRAVAILABLE" },
		{ 88, "ETT_ISHDRRENDERING" },
		{ 89, "ETT_ISRAYTRACINGAVAILABLE" },
		{ 90, "ETT_VARIABLERATESHADINGTIER" },
		{ 91, "ETT_ITEM" },
		{ 92, "ETT_REPOSITORY" },
		{ 93, "ETT_ISONLINE" },
		{ 94, "ETT_ISINGAME" },
		{ 95, "ETT_ISINEDITOR" },
		{ 96, "ETT_ISUGCRESTRICTED" },
		{ 97, "ETT_ISPACKAGEOWNED" },
		{ 98, "ETT_ISININVENTORY" },
		{ 99, "ETT_ISPLATFORMENTITLEMENTOWNED" },
		{ 100, "ETT_MULTIPLAYERLOBBYSTATE" },
		{ 101, "ETT_MULTIPLAYERLOCALID" },
		{ 102, "ETT_MULTIPLAYERJOINEDIDS" },
		{ 103, "ETT_MULTIPLAYERISPLAYERREADY" },
		{ 104, "ETT_MULTIPLAYERINFO" },
		{ 105, "ETT_MULTIPLAYERMATCHMAKINGTIME" },
		{ 106, "ETT_MULTIPLAYERNATTYPE" },
		{ 107, "ETT_LOADOUT" },
		{ 108, "ETT_LOADOUT_SLOT" },
		{ 109, "ETT_LOADOUT_AGENCY_PICKUP" },
		{ 110, "ETT_LOADOUT_SELECTED_ENTRANCE" },
		{ 111, "ETT_PERSISTENTMENUDATA" },
		{ 112, "ETT_GAMEPERSISTENTDATA" },
		{ 113, "ETT_ENDGAME_PAGETRANSITION_OVERRIDE" },
		{ 114, "ETT_VERSUSINFO" },
		{ 115, "ETT_SNIPERINFO" },
		{ 116, "ETT_GAMEMODE" },
		{ 117, "ETT_CACHEDUSERCENTRICCONTRACT" },
		{ 118, "ETT_SAVEGAMES" },
		{ 119, "ETT_AVAILABILITY_OF_RESOURCES" },
		{ 120, "ETT_AVAILABILITY_OF_CONTRACT" },
		{ 121, "ETT_AVAILABILITY_OF_USER_CENTRIC_CONTRACT" },
		{ 122, "ETT_AS3DATE" },
		{ 123, "ETT_IOIACCOUNT_STATUS" },
		{ 124, "ETT_ISCONTRACT_IN_PLAYLIST" },
		{ 125, "ETT_ISCONTRACT_IN_PLAYLIST_MARKED_FOR_DELETION" },
		{ 126, "ETT_VIDEOMEMORYINFO_IS_SUPPORTED" },
		{ 127, "ETT_VIDEOMEMORYINFO" },
		{ 128, "ETT_DISPLAY_SIZE" },
		{ 129, "ETT_IS_VIDEO_VALID" },
		{ 130, "ETT_INTEL_IDS" },
		{ 131, "ETT_INTEL_DETAILS" },
		{ 132, "ETT_MENU_CONFIGURATION" },
		{ 133, "ETT_HERO_INVENTORY" },
		{ 134, "ETT_MAP_TRACKERINFO" },
		{ 135, "ETT_WAS_EXITGATE_TRIGGERED" },
		{ 136, "ETT_ARE_OPPORTUNITIES_ENABLED" },
		{ 137, "ETT_CHARACTERS" },
		{ 138, "ETT_CHARACTERINFO" },
		{ 139, "ETT_DATABINDING" },
		{ 140, "ETT_DATABINDING_ROOT" },
		{ 141, "ETT_ALLOWED_UNLOCKABLES" },
		{ 142, "ETT_HAS_FRAMERATE_OPTION" },
		{ 143, "ETT_MENU_DATAPROVIDER" },
		{ 144, "ETT_INTERACTIONINDICATOR" },
		{ 145, "ETT_NVIDIAHIGHLIGHTSAVAILABLE" },
		{ 146, "ETT_NVIDIAHIGHLIGHTSHASHIGHLIGHTS" },
		{ 147, "ETT_DEBUG_ALLHITMANSUITS" },
	};
