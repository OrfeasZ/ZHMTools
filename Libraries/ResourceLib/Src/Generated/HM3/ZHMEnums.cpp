...
void ZHMEnums::RegisterEnums()
{
	...
	(*g_Enums)["ERequirementId"] = {
		...
		{ 21, "EREQUIREMENT_LOCATION_COASTALTOWN" },
		{ 22, "EREQUIREMENT_LOCATION_GOLDEN" },
		{ 23, "EREQUIREMENT_LOCATION_ANCESTRAL" },
		{ 24, "EREQUIREMENT_LOCATION_EDGY" },
		{ 25, "EREQUIREMENT_LOCATION_WET" },
		{ 26, "EREQUIREMENT_LOCATION_ELEGANT" },
		{ 27, "EREQUIREMENT_LOCATION_TRAPPED" },
		{ 28, "EREQUIREMENT_PLATFORM_ORBIS" },
		{ 29, "EREQUIREMENT_PLATFORM_PS5" },
		{ 30, "EREQUIREMENT_PLATFORM_GDK" },
		{ 31, "EREQUIREMENT_PLATFORM_EPIC" },
		{ 32, "EREQUIREMENT_PLATFORM_STEAM" },
		{ 33, "EREQUIREMENT_PLATFORM_GGP" },
		{ 34, "EREQUIREMENT_H3_PREORDER" },
		{ 35, "EREQUIREMENT_PLATFORM_IZUMO" },
		{ 36, "EREQUIREMENT_H3_DEADLYSINS_GREED" },
		{ 37, "EREQUIREMENT_H3_DEADLYSINS_PRIDE" },
		{ 38, "EREQUIREMENT_H3_DEADLYSINS_SLOTH" },
		{ 39, "EREQUIREMENT_H3_DEADLYSINS_LUST" },
		{ 40, "EREQUIREMENT_H3_DEADLYSINS_GLUTTONY" },
		{ 41, "EREQUIREMENT_H3_DEADLYSINS_WRATH" },
		{ 42, "EREQUIREMENT_H3_DEADLYSINS_ENVY" },
		{ 43, "EREQUIREMENT_LOCATION_ROCKY" },
		{ 44, "EREQUIREMENT_H3_VANITY_CONCRETEART" },
		{ 45, "EREQUIREMENT_H3_VANITY_MAKESHIFTSCRAP" },
		{ 46, "EREQUIREMENT_H3_SARAJEVO_SIX" },
		{ 47, "EREQUIREMENT_H3_ET_SAMBUCA" },
	...
	(*g_Enums)["JSONTemplate.ETemplateType"] = {
		...
		{ 46, "ETT_IS_NEO_VR_PLATFORM" },
		{ 47, "ETT_IS_VR_DEVICE_AVAILABLE" },
		{ 48, "ETT_IS_VR_DEVICE_ACTIVE" },
		{ 49, "ETT_IS_VR_ACTIVE" },
		{ 50, "ETT_VR_MODE" },
		{ 51, "ETT_ONLINE_RESOURCE" },
		{ 52, "ETT_INCLUDE" },
		{ 53, "ETT_UI_OPTION_VALUE" },
		{ 54, "ETT_UI_OPTION_DEFAULT_VALUE" },
		{ 55, "ETT_UI_OPTION_DEBUG_VALUE" },
		{ 56, "ETT_UI_OPTION_AVAILABLE" },
		{ 57, "ETT_UI_OPTION_AVAILABLE_DISPLAY_RESOLUTIONS" },
		{ 58, "ETT_UI_OPTION_AVAILABLE_DISPLAY_FULLSCREEN" },
		{ 59, "ETT_UI_OPTION_AVAILABLE_MOTION_BLUR" },
		{ 60, "ETT_UI_OPTION_AVAILABLE_TEXTURE_QUALITY" },
		{ 61, "ETT_UI_OPTION_AVAILABLE_SHADOW_QUALITY" },
		{ 62, "ETT_UI_OPTION_AVAILABLE_SUPERSAMPLING" },
		{ 63, "ETT_UI_OPTION_AVAILABLE_DOUBLEFRAMERATE" },
		{ 64, "ETT_UI_OPTION_AVAILABLE_VRS" },
		{ 65, "ETT_UI_OPTION_CAN_CHANGE_DISPLAY_RESOLUTION" },
		{ 66, "ETT_CURRENT_CONTRACT_CONTEXT" },
		{ 67, "ETT_CURRENT_CONTRACT_OBJECTIVES" },
		{ 68, "ETT_CURRENT_CONTRACT_SESSIONID" },
		{ 69, "ETT_CURRENT_CONTRACT_CHARACTER_INFO" },
		{ 70, "ETT_CURRENT_CONTRACT_TRACKED_OPPORTUNITY" },
		{ 71, "ETT_CURRENT_DIFFICULTY" },
		{ 72, "ETT_CURRENT_ENGINE_MODE" },
		{ 73, "ETT_CURRENT_GAME_MODE" },
		{ 74, "ETT_CAN_SAVE" },
		{ 75, "ETT_IS_SAVELIMIT_EXCEEDED" },
		{ 76, "ETT_IS_ALLOWED_TO_RESTART" },
		{ 77, "ETT_IS_LUDEO_CLOUD" },
		{ 78, "ETT_ACTIVE_CHALLENGES" },
		{ 79, "ETT_USER" },
		{ 80, "ETT_ISUSER" },
		{ 81, "ETT_DLCCOUNT" },
		{ 82, "ETT_PROFILEID" },
		{ 83, "ETT_HDRGAMMAVALUERANGEMIN" },
		{ 84, "ETT_HDRGAMMAVALUERANGEMAX" },
		{ 85, "ETT_HDRGAMMAVALUESTEP" },
		{ 86, "ETT_ISDLSSAVAILABLE" },
		{ 87, "ETT_ISXESSAVAILABLE" },
		{ 88, "ETT_ISXESSINSTALLED" },
		{ 89, "ETT_ISHDRAVAILABLE" },
		{ 90, "ETT_ISHDRRENDERING" },
		{ 91, "ETT_ISRAYTRACINGAVAILABLE" },
		{ 92, "ETT_VARIABLERATESHADINGTIER" },
		{ 93, "ETT_ITEM" },
		{ 94, "ETT_REPOSITORY" },
		{ 95, "ETT_ISONLINE" },
		{ 96, "ETT_ISINGAME" },
		{ 97, "ETT_ISINEDITOR" },
		{ 98, "ETT_ISUGCRESTRICTED" },
		{ 99, "ETT_ISPACKAGEOWNED" },
		{ 100, "ETT_ISININVENTORY" },
		{ 101, "ETT_ISINLOADOUT" },
		{ 102, "ETT_ISPLATFORMENTITLEMENTOWNED" },
		{ 103, "ETT_MULTIPLAYERLOBBYSTATE" },
		{ 104, "ETT_MULTIPLAYERLOCALID" },
		{ 105, "ETT_MULTIPLAYERJOINEDIDS" },
		{ 106, "ETT_MULTIPLAYERISPLAYERREADY" },
		{ 107, "ETT_MULTIPLAYERINFO" },
		{ 108, "ETT_MULTIPLAYERMATCHMAKINGTIME" },
		{ 109, "ETT_MULTIPLAYERNATTYPE" },
		{ 110, "ETT_LOADOUT" },
		{ 111, "ETT_LOADOUT_SLOT" },
		{ 112, "ETT_LOADOUT_AGENCY_PICKUP" },
		{ 113, "ETT_LOADOUT_SELECTED_ENTRANCE" },
		{ 114, "ETT_PERSISTENTMENUDATA" },
		{ 115, "ETT_GAMEPERSISTENTDATA" },
		{ 116, "ETT_ENDGAME_PAGETRANSITION_OVERRIDE" },
		{ 117, "ETT_VERSUSINFO" },
		{ 118, "ETT_SNIPERINFO" },
		{ 119, "ETT_GAMEMODE" },
		{ 120, "ETT_CACHEDUSERCENTRICCONTRACT" },
		{ 121, "ETT_SAVEGAMES" },
		{ 122, "ETT_AVAILABILITY_OF_RESOURCES" },
		{ 123, "ETT_AVAILABILITY_OF_CONTRACT" },
		{ 124, "ETT_AVAILABILITY_OF_USER_CENTRIC_CONTRACT" },
		{ 125, "ETT_AS3DATE" },
		{ 126, "ETT_IOIACCOUNT_STATUS" },
		{ 127, "ETT_ISCONTRACT_IN_PLAYLIST" },
		{ 128, "ETT_ISCONTRACT_IN_PLAYLIST_MARKED_FOR_DELETION" },
		{ 129, "ETT_IS_VR_SUPPORTED_IN_CONTRACT" },
		{ 130, "ETT_VIDEOMEMORYINFO_IS_SUPPORTED" },
		{ 131, "ETT_VIDEOMEMORYINFO" },
		{ 132, "ETT_DISPLAY_SIZE" },
		{ 133, "ETT_IS_VIDEO_VALID" },
		{ 134, "ETT_INTEL_IDS" },
		{ 135, "ETT_INTEL_DETAILS" },
		{ 136, "ETT_MENU_CONFIGURATION" },
		{ 137, "ETT_HERO_INVENTORY" },
		{ 138, "ETT_MAP_TRACKERINFO" },
		{ 139, "ETT_WAS_EXITGATE_TRIGGERED" },
		{ 140, "ETT_ARE_OPPORTUNITIES_ENABLED" },
		{ 141, "ETT_CHARACTERS" },
		{ 142, "ETT_CHARACTERINFO" },
		{ 143, "ETT_DATABINDING" },
		{ 144, "ETT_DATABINDING_ROOT" },
		{ 145, "ETT_ALLOWED_UNLOCKABLES" },
		{ 146, "ETT_HAS_FRAMERATE_OPTION" },
		{ 147, "ETT_MENU_DATAPROVIDER" },
		{ 148, "ETT_INTERACTIONINDICATOR" },
		{ 149, "ETT_NVIDIAHIGHLIGHTSAVAILABLE" },
		{ 150, "ETT_NVIDIAHIGHLIGHTSHASHIGHLIGHTS" },
		{ 151, "ETT_DEBUG_ALLHITMANSUITS" },
	};
