...
void ZHMEnums::RegisterEnums()
{
	...
	(*g_Enums)["EUIIconLibrary"] = {
		...
		{ 87, "evergreen_kill_method_drown" },
		{ 88, "evergreen_kill_method_electric" },
		{ 89, "evergreen_kill_method_explosive" },
		{ 90, "evergreen_kill_method_fiber_wire" },
		{ 91, "evergreen_kill_method_headshots_only" },
		{ 92, "evergreen_kill_method_melee" },
		{ 93, "evergreen_kill_method_oil_puddle" },
		{ 94, "evergreen_kill_method_pistol" },
		{ 95, "evergreen_kill_method_pistol_silenced" },
		{ 96, "evergreen_kill_method_poison" },
		{ 97, "evergreen_kill_method_push" },
		{ 98, "evergreen_kill_method_shotgun" },
		{ 99, "evergreen_kill_method_smg" },
		{ 100, "evergreen_kill_method_sniper" },
		{ 101, "evergreen_kill_method_throw" },
		{ 102, "evergreen_kill_method_unarmed" },
		{ 103, "evergreen_kill_method_wallbang" },
		{ 104, "evergreen_kill_method_water_puddle" },
		{ 105, "evergreen_merces" },
		{ 106, "evergreen_mules" },
		{ 107, "evergreen_no_bodies_found" },
		{ 108, "evergreen_no_compromised_disguises" },
		{ 109, "evergreen_no_disguise_change" },
		{ 110, "evergreen_no_lockpick" },
		{ 111, "evergreen_no_missed_shots" },
		{ 112, "evergreen_only_kill_targets" },
		{ 113, "evergreen_optin_killmethod" },
		{ 114, "evergreen_optin_showdown" },
		{ 115, "evergreen_optin_silentassassin" },
		{ 116, "evergreen_optin_speedrun" },
		{ 117, "evergreen_pacify_raremelee" },
		{ 118, "evergreen_safe" },
		{ 119, "evergreen_safehouse_cosmetic" },
		{ 120, "evergreen_safehouse_unlock" },
		{ 121, "evergreen_search_locate" },
		{ 122, "evergreen_showdown_mission" },
		{ 123, "evergreen_suppliers" },
		{ 124, "evergreen_tags" },
		{ 125, "evergreen_target" },
		{ 126, "exit" },
		{ 127, "explosive" },
		{ 128, "explosives" },
		{ 129, "extendedmag" },
		...
		{ 193, "onemanarmy" },
		{ 194, "online" },
		{ 195, "opportunitycompleted" },
		{ 196, "opportunitydisabled" },
		{ 197, "opportunitydiscovered" },
		{ 198, "opportunityfailed" },
		{ 199, "opportunitysearch" },
		{ 200, "opportunitytracked" },
		{ 201, "opportunityundiscovered" },
		{ 202, "outbreak" },
		{ 203, "piercing" },
		{ 204, "pistol" },
		{ 205, "planning" },
		...
		{ 265, "variable" },
		{ 266, "versatilescope" },
		{ 267, "versatilescope_1" },
		{ 268, "versatilescope_2" },
		{ 269, "versatilescope_3" },
		{ 270, "versatilescope_4" },
		{ 271, "versatilescopeextended" },
		{ 272, "versus" },
		{ 273, "vr" },
		{ 274, "warning" },
		{ 275, "weapon" },
	...
	(*g_Enums)["JSONTemplate.ETemplateType"] = {
		...
		{ 55, "ETT_UI_OPTION_AVAILABLE_MOTION_BLUR" },
		{ 56, "ETT_UI_OPTION_AVAILABLE_TEXTURE_QUALITY" },
		{ 57, "ETT_UI_OPTION_AVAILABLE_SHADOW_QUALITY" },
		{ 58, "ETT_UI_OPTION_AVAILABLE_SUPERSAMPLING" },
		{ 59, "ETT_UI_OPTION_AVAILABLE_DOUBLEFRAMERATE" },
		{ 60, "ETT_UI_OPTION_AVAILABLE_VRS" },
		{ 61, "ETT_UI_OPTION_CAN_CHANGE_DISPLAY_RESOLUTION" },
		{ 62, "ETT_CURRENT_CONTRACT_CONTEXT" },
		{ 63, "ETT_CURRENT_CONTRACT_OBJECTIVES" },
		{ 64, "ETT_CURRENT_CONTRACT_SESSIONID" },
		{ 65, "ETT_CURRENT_CONTRACT_CHARACTER_INFO" },
		{ 66, "ETT_CURRENT_CONTRACT_TRACKED_OPPORTUNITY" },
		{ 67, "ETT_CURRENT_DIFFICULTY" },
		{ 68, "ETT_CURRENT_ENGINE_MODE" },
		{ 69, "ETT_CURRENT_GAME_MODE" },
		{ 70, "ETT_CAN_SAVE" },
		{ 71, "ETT_IS_SAVELIMIT_EXCEEDED" },
		{ 72, "ETT_IS_ALLOWED_TO_RESTART" },
		{ 73, "ETT_ACTIVE_CHALLENGES" },
		{ 74, "ETT_USER" },
		{ 75, "ETT_ISUSER" },
		{ 76, "ETT_DLCCOUNT" },
		{ 77, "ETT_PROFILEID" },
		{ 78, "ETT_HDRGAMMAVALUERANGEMIN" },
		{ 79, "ETT_HDRGAMMAVALUERANGEMAX" },
		{ 80, "ETT_HDRGAMMAVALUESTEP" },
		{ 81, "ETT_ISDLSSAVAILABLE" },
		{ 82, "ETT_ISXESSAVAILABLE" },
		{ 83, "ETT_ISHDRAVAILABLE" },
		{ 84, "ETT_ISHDRRENDERING" },
		{ 85, "ETT_ISRAYTRACINGAVAILABLE" },
		{ 86, "ETT_VARIABLERATESHADINGTIER" },
		{ 87, "ETT_ITEM" },
		{ 88, "ETT_REPOSITORY" },
		{ 89, "ETT_ISONLINE" },
		{ 90, "ETT_ISINGAME" },
		{ 91, "ETT_ISINEDITOR" },
		{ 92, "ETT_ISUGCRESTRICTED" },
		{ 93, "ETT_ISPACKAGEOWNED" },
		{ 94, "ETT_ISININVENTORY" },
		{ 95, "ETT_ISPLATFORMENTITLEMENTOWNED" },
		{ 96, "ETT_MULTIPLAYERLOBBYSTATE" },
		{ 97, "ETT_MULTIPLAYERLOCALID" },
		{ 98, "ETT_MULTIPLAYERJOINEDIDS" },
		{ 99, "ETT_MULTIPLAYERISPLAYERREADY" },
		{ 100, "ETT_MULTIPLAYERINFO" },
		{ 101, "ETT_MULTIPLAYERMATCHMAKINGTIME" },
		{ 102, "ETT_MULTIPLAYERNATTYPE" },
		{ 103, "ETT_LOADOUT" },
		{ 104, "ETT_LOADOUT_SLOT" },
		{ 105, "ETT_LOADOUT_AGENCY_PICKUP" },
		{ 106, "ETT_LOADOUT_SELECTED_ENTRANCE" },
		{ 107, "ETT_PERSISTENTMENUDATA" },
		{ 108, "ETT_GAMEPERSISTENTDATA" },
		{ 109, "ETT_ENDGAME_PAGETRANSITION_OVERRIDE" },
		{ 110, "ETT_VERSUSINFO" },
		{ 111, "ETT_SNIPERINFO" },
		{ 112, "ETT_GAMEMODE" },
		{ 113, "ETT_CACHEDUSERCENTRICCONTRACT" },
		{ 114, "ETT_SAVEGAMES" },
		{ 115, "ETT_AVAILABILITY_OF_RESOURCES" },
		{ 116, "ETT_AVAILABILITY_OF_CONTRACT" },
		{ 117, "ETT_AVAILABILITY_OF_USER_CENTRIC_CONTRACT" },
		{ 118, "ETT_AS3DATE" },
		{ 119, "ETT_IOIACCOUNT_STATUS" },
		{ 120, "ETT_ISCONTRACT_IN_PLAYLIST" },
		{ 121, "ETT_ISCONTRACT_IN_PLAYLIST_MARKED_FOR_DELETION" },
		{ 122, "ETT_VIDEOMEMORYINFO_IS_SUPPORTED" },
		{ 123, "ETT_VIDEOMEMORYINFO" },
		{ 124, "ETT_DISPLAY_SIZE" },
		{ 125, "ETT_IS_VIDEO_VALID" },
		{ 126, "ETT_INTEL_IDS" },
		{ 127, "ETT_INTEL_DETAILS" },
		{ 128, "ETT_MENU_CONFIGURATION" },
		{ 129, "ETT_HERO_INVENTORY" },
		{ 130, "ETT_MAP_TRACKERINFO" },
		{ 131, "ETT_WAS_EXITGATE_TRIGGERED" },
		{ 132, "ETT_ARE_OPPORTUNITIES_ENABLED" },
		{ 133, "ETT_CHARACTERS" },
		{ 134, "ETT_CHARACTERINFO" },
		{ 135, "ETT_DATABINDING" },
		{ 136, "ETT_DATABINDING_ROOT" },
		{ 137, "ETT_ALLOWED_UNLOCKABLES" },
		{ 138, "ETT_HAS_FRAMERATE_OPTION" },
		{ 139, "ETT_MENU_DATAPROVIDER" },
		{ 140, "ETT_NVIDIAHIGHLIGHTSAVAILABLE" },
		{ 141, "ETT_NVIDIAHIGHLIGHTSHASHIGHLIGHTS" },
		{ 142, "ETT_DEBUG_ALLHITMANSUITS" },
	};
