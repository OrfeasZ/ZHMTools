...
void ZHMEnums::RegisterEnums()
{
	...
	(*g_Enums)["JSONTemplate.ETemplateType"] = {
		...
		{ 48, "ETT_IS_VR_DEVICE_AVAILABLE" },
		{ 49, "ETT_IS_VR_DEVICE_ACTIVE" },
		{ 50, "ETT_IS_VR_ACTIVE" },
		{ 51, "ETT_VR_MODE" },
		{ 52, "ETT_ONLINE_RESOURCE" },
		{ 53, "ETT_INCLUDE" },
		{ 54, "ETT_UI_OPTION_VALUE" },
		{ 55, "ETT_UI_OPTION_DEFAULT_VALUE" },
		{ 56, "ETT_UI_OPTION_DEBUG_VALUE" },
		{ 57, "ETT_UI_OPTION_AVAILABLE" },
		{ 58, "ETT_UI_OPTION_AVAILABLE_DISPLAY_RESOLUTIONS" },
		{ 59, "ETT_UI_OPTION_AVAILABLE_DISPLAY_FULLSCREEN" },
		{ 60, "ETT_UI_OPTION_AVAILABLE_MOTION_BLUR" },
		{ 61, "ETT_UI_OPTION_AVAILABLE_TEXTURE_QUALITY" },
		{ 62, "ETT_UI_OPTION_AVAILABLE_SHADOW_QUALITY" },
		{ 63, "ETT_UI_OPTION_AVAILABLE_SUPERSAMPLING" },
		{ 64, "ETT_UI_OPTION_AVAILABLE_DOUBLEFRAMERATE" },
		{ 65, "ETT_UI_OPTION_AVAILABLE_VRS" },
		{ 66, "ETT_UI_OPTION_CAN_CHANGE_DISPLAY_RESOLUTION" },
		{ 67, "ETT_CURRENT_CONTRACT_CONTEXT" },
		{ 68, "ETT_CURRENT_CONTRACT_OBJECTIVES" },
		{ 69, "ETT_CURRENT_CONTRACT_SESSIONID" },
		{ 70, "ETT_CURRENT_CONTRACT_CHARACTER_INFO" },
		{ 71, "ETT_CURRENT_CONTRACT_TRACKED_OPPORTUNITY" },
		{ 72, "ETT_CURRENT_DIFFICULTY" },
		{ 73, "ETT_CURRENT_ENGINE_MODE" },
		{ 74, "ETT_CURRENT_GAME_MODE" },
		{ 75, "ETT_CAN_SAVE" },
		{ 76, "ETT_IS_SAVELIMIT_EXCEEDED" },
		{ 77, "ETT_IS_ALLOWED_TO_RESTART" },
		{ 78, "ETT_IS_LUDEO_CLOUD" },
		{ 79, "ETT_ACTIVE_CHALLENGES" },
		{ 80, "ETT_USER" },
		{ 81, "ETT_ISUSER" },
		{ 82, "ETT_DLCCOUNT" },
		{ 83, "ETT_PROFILEID" },
		{ 84, "ETT_HDRGAMMAVALUERANGEMIN" },
		{ 85, "ETT_HDRGAMMAVALUERANGEMAX" },
		{ 86, "ETT_HDRGAMMAVALUESTEP" },
		{ 87, "ETT_ISDLSSAVAILABLE" },
		{ 88, "ETT_ISXESSAVAILABLE" },
		{ 89, "ETT_ISXESSINSTALLED" },
		{ 90, "ETT_ISHDRAVAILABLE" },
		{ 91, "ETT_ISHDRRENDERING" },
		{ 92, "ETT_ISRAYTRACINGAVAILABLE" },
		{ 93, "ETT_VARIABLERATESHADINGTIER" },
		{ 94, "ETT_ITEM" },
		{ 95, "ETT_REPOSITORY" },
		{ 96, "ETT_ISONLINE" },
		{ 97, "ETT_ISINGAME" },
		{ 98, "ETT_ISINEDITOR" },
		{ 99, "ETT_ISUGCRESTRICTED" },
		{ 100, "ETT_ISPACKAGEOWNED" },
		{ 101, "ETT_ISININVENTORY" },
		{ 102, "ETT_ISINLOADOUT" },
		{ 103, "ETT_ISPLATFORMENTITLEMENTOWNED" },
		{ 104, "ETT_MULTIPLAYERLOBBYSTATE" },
		{ 105, "ETT_MULTIPLAYERLOCALID" },
		{ 106, "ETT_MULTIPLAYERJOINEDIDS" },
		{ 107, "ETT_MULTIPLAYERISPLAYERREADY" },
		{ 108, "ETT_MULTIPLAYERINFO" },
		{ 109, "ETT_MULTIPLAYERMATCHMAKINGTIME" },
		{ 110, "ETT_MULTIPLAYERNATTYPE" },
		{ 111, "ETT_LOADOUT" },
		{ 112, "ETT_LOADOUT_SLOT" },
		{ 113, "ETT_LOADOUT_AGENCY_PICKUP" },
		{ 114, "ETT_LOADOUT_SELECTED_ENTRANCE" },
		{ 115, "ETT_PERSISTENTMENUDATA" },
		{ 116, "ETT_GAMEPERSISTENTDATA" },
		{ 117, "ETT_ENDGAME_PAGETRANSITION_OVERRIDE" },
		{ 118, "ETT_VERSUSINFO" },
		{ 119, "ETT_SNIPERINFO" },
		{ 120, "ETT_GAMEMODE" },
		{ 121, "ETT_CACHEDUSERCENTRICCONTRACT" },
		{ 122, "ETT_SAVEGAMES" },
		{ 123, "ETT_AVAILABILITY_OF_RESOURCES" },
		{ 124, "ETT_AVAILABILITY_OF_CONTRACT" },
		{ 125, "ETT_AVAILABILITY_OF_USER_CENTRIC_CONTRACT" },
		{ 126, "ETT_AS3DATE" },
		{ 127, "ETT_IOIACCOUNT_STATUS" },
		{ 128, "ETT_ISCONTRACT_IN_PLAYLIST" },
		{ 129, "ETT_ISCONTRACT_IN_PLAYLIST_MARKED_FOR_DELETION" },
		{ 130, "ETT_IS_VR_SUPPORTED_IN_CONTRACT" },
		{ 131, "ETT_VIDEOMEMORYINFO_IS_SUPPORTED" },
		{ 132, "ETT_VIDEOMEMORYINFO" },
		{ 133, "ETT_DISPLAY_SIZE" },
		{ 134, "ETT_IS_VIDEO_VALID" },
		{ 135, "ETT_INTEL_IDS" },
		{ 136, "ETT_INTEL_DETAILS" },
		{ 137, "ETT_MENU_CONFIGURATION" },
		{ 138, "ETT_HERO_INVENTORY" },
		{ 139, "ETT_MAP_TRACKERINFO" },
		{ 140, "ETT_WAS_EXITGATE_TRIGGERED" },
		{ 141, "ETT_ARE_OPPORTUNITIES_ENABLED" },
		{ 142, "ETT_CHARACTERS" },
		{ 143, "ETT_CHARACTERINFO" },
		{ 144, "ETT_DATABINDING" },
		{ 145, "ETT_DATABINDING_ROOT" },
		{ 146, "ETT_ALLOWED_UNLOCKABLES" },
		{ 147, "ETT_HAS_FRAMERATE_OPTION" },
		{ 148, "ETT_MENU_DATAPROVIDER" },
		{ 149, "ETT_INTERACTIONINDICATOR" },
		{ 150, "ETT_NVIDIAHIGHLIGHTSAVAILABLE" },
		{ 151, "ETT_NVIDIAHIGHLIGHTSHASHIGHLIGHTS" },
		{ 152, "ETT_DEBUG_ALLHITMANSUITS" },
	};
