...
void ZHMEnums::RegisterEnums()
{
	...
	(*g_Enums)["JSONTemplate.ETemplateType"] = {
		...
		{ 88, "ETT_ISINGAME" },
		{ 89, "ETT_ISINEDITOR" },
		{ 90, "ETT_ISUGCRESTRICTED" },
		{ 91, "ETT_ISPACKAGEOWNED" },
		{ 92, "ETT_ISININVENTORY" },
		{ 93, "ETT_ISPLATFORMENTITLEMENTOWNED" },
		{ 94, "ETT_MULTIPLAYERLOBBYSTATE" },
		{ 95, "ETT_MULTIPLAYERLOCALID" },
		{ 96, "ETT_MULTIPLAYERJOINEDIDS" },
		{ 97, "ETT_MULTIPLAYERISPLAYERREADY" },
		{ 98, "ETT_MULTIPLAYERINFO" },
		{ 99, "ETT_MULTIPLAYERMATCHMAKINGTIME" },
		{ 100, "ETT_MULTIPLAYERNATTYPE" },
		{ 101, "ETT_LOADOUT" },
		{ 102, "ETT_LOADOUT_SLOT" },
		{ 103, "ETT_LOADOUT_AGENCY_PICKUP" },
		{ 104, "ETT_LOADOUT_SELECTED_ENTRANCE" },
		{ 105, "ETT_PERSISTENTMENUDATA" },
		{ 106, "ETT_GAMEPERSISTENTDATA" },
		{ 107, "ETT_ENDGAME_PAGETRANSITION_OVERRIDE" },
		{ 108, "ETT_VERSUSINFO" },
		{ 109, "ETT_SNIPERINFO" },
		{ 110, "ETT_GAMEMODE" },
		{ 111, "ETT_CACHEDUSERCENTRICCONTRACT" },
		{ 112, "ETT_SAVEGAMES" },
		{ 113, "ETT_AVAILABILITY_OF_RESOURCES" },
		{ 114, "ETT_AVAILABILITY_OF_CONTRACT" },
		{ 115, "ETT_AS3DATE" },
		{ 116, "ETT_IOIACCOUNT_STATUS" },
		{ 117, "ETT_ISCONTRACT_IN_PLAYLIST" },
		{ 118, "ETT_ISCONTRACT_IN_PLAYLIST_MARKED_FOR_DELETION" },
		{ 119, "ETT_VIDEOMEMORYINFO_IS_SUPPORTED" },
		{ 120, "ETT_VIDEOMEMORYINFO" },
		{ 121, "ETT_DISPLAY_SIZE" },
		{ 122, "ETT_IS_VIDEO_VALID" },
		{ 123, "ETT_INTEL_IDS" },
		{ 124, "ETT_INTEL_DETAILS" },
		{ 125, "ETT_MENU_CONFIGURATION" },
		{ 126, "ETT_HERO_INVENTORY" },
		{ 127, "ETT_MAP_TRACKERINFO" },
		{ 128, "ETT_WAS_EXITGATE_TRIGGERED" },
		{ 129, "ETT_ARE_OPPORTUNITIES_ENABLED" },
		{ 130, "ETT_CHARACTERS" },
		{ 131, "ETT_CHARACTERINFO" },
		{ 132, "ETT_DATABINDING" },
		{ 133, "ETT_DATABINDING_ROOT" },
		{ 134, "ETT_ALLOWED_UNLOCKABLES" },
		{ 135, "ETT_HAS_FRAMERATE_OPTION" },
		{ 136, "ETT_NVIDIAHIGHLIGHTSAVAILABLE" },
		{ 137, "ETT_NVIDIAHIGHLIGHTSHASHIGHLIGHTS" },
		{ 138, "ETT_DEBUG_ALLHITMANSUITS" },
	};
